...
const AES = struct {
    ...
    KEY_0: *volatile AES_KEY_0,
    /// Key material key_1 configure register
    KEY_1: *volatile AES_KEY_1,
    /// Key material key_2 configure register
    KEY_2: *volatile AES_KEY_2,
    /// Key material key_3 configure register
    KEY_3: *volatile AES_KEY_3,
    /// Key material key_4 configure register
    KEY_4: *volatile AES_KEY_4,
    /// Key material key_5 configure register
    KEY_5: *volatile AES_KEY_5,
    /// Key material key_6 configure register
    KEY_6: *volatile AES_KEY_6,
    /// Key material key_7 configure register
    KEY_7: *volatile AES_KEY_7,
    /// source text material text_in_0 configure register
    TEXT_IN_0: *volatile AES_TEXT_IN_0,
    /// source text material text_in_1 configure register
    TEXT_IN_1: *volatile AES_TEXT_IN_1,
    /// source text material text_in_2 configure register
    TEXT_IN_2: *volatile AES_TEXT_IN_2,
    /// source text material text_in_3 configure register
    TEXT_IN_3: *volatile AES_TEXT_IN_3,
    /// result text material text_out_0 configure register
    TEXT_OUT_0: *volatile AES_TEXT_OUT_0,
    /// result text material text_out_1 configure register
    TEXT_OUT_1: *volatile AES_TEXT_OUT_1,
    /// result text material text_out_2 configure register
    TEXT_OUT_2: *volatile AES_TEXT_OUT_2,
    /// result text material text_out_3 configure register
    TEXT_OUT_3: *volatile AES_TEXT_OUT_3,
    /// AES Mode register
    MODE: *volatile AES_MODE,
    /// AES Endian configure register
    ENDIAN: *volatile AES_ENDIAN,
    /// AES trigger register
    TRIGGER: *volatile AES_TRIGGER,
    /// AES state register
    STATE: *volatile AES_STATE,
    /// The memory that stores initialization vector
    IV_MEM0: *volatile AES_IV_MEMN,
    /// The memory that stores initialization vector
    IV_MEM1: *volatile AES_IV_MEMN,
    /// The memory that stores initialization vector
    IV_MEM2: *volatile AES_IV_MEMN,
    /// The memory that stores initialization vector
    IV_MEM3: *volatile AES_IV_MEMN,
    /// The memory that stores GCM hash subkey
    H_MEM0: *volatile AES_H_MEMN,
    /// The memory that stores GCM hash subkey
    H_MEM1: *volatile AES_H_MEMN,
    /// The memory that stores GCM hash subkey
    H_MEM2: *volatile AES_H_MEMN,
    /// The memory that stores GCM hash subkey
    H_MEM3: *volatile AES_H_MEMN,
    /// The memory that stores J0
    J0_MEM0: *volatile AES_J0_MEMN,
    /// The memory that stores J0
    J0_MEM1: *volatile AES_J0_MEMN,
    /// The memory that stores J0
    J0_MEM2: *volatile AES_J0_MEMN,
    /// The memory that stores J0
    J0_MEM3: *volatile AES_J0_MEMN,
    /// The memory that stores T0
    T0_MEM0: *volatile AES_T0_MEMN,
    /// The memory that stores T0
    T0_MEM1: *volatile AES_T0_MEMN,
    /// The memory that stores T0
    T0_MEM2: *volatile AES_T0_MEMN,
    /// The memory that stores T0
    T0_MEM3: *volatile AES_T0_MEMN,
    /// DMA-AES working mode register
    DMA_ENABLE: *volatile AES_DMA_ENABLE,
    /// AES cipher block mode register
    BLOCK_MODE: *volatile AES_BLOCK_MODE,
    /// AES block number register
    BLOCK_NUM: *volatile AES_BLOCK_NUM,
    /// Standard incrementing function configure register
    INC_SEL: *volatile AES_INC_SEL,
    /// Additional Authential Data block number register
    AAD_BLOCK_NUM: *volatile AES_AAD_BLOCK_NUM,
    /// AES remainder bit number register
    REMAINDER_BIT_NUM: *volatile AES_REMAINDER_BIT_NUM,
    /// AES continue register
    CONTINUE: *volatile AES_CONTINUE,
    /// AES Interrupt clear register
    INT_CLEAR: *volatile AES_INT_CLEAR,
    /// AES Interrupt enable register
    INT_ENA: *volatile AES_INT_ENA,
    /// AES version control register
    DATE: *volatile AES_DATE,
    /// AES-DMA exit config
    DMA_EXIT: *volatile AES_DMA_EXIT,
};
...
const AES_instance = AES{
    ...
    .IV_MEM1 = @ptrFromInt(0x6003a054),
    .IV_MEM2 = @ptrFromInt(0x6003a058),
    .IV_MEM3 = @ptrFromInt(0x6003a05c),
    .H_MEM0 = @ptrFromInt(0x6003a060),
    .H_MEM1 = @ptrFromInt(0x6003a064),
    .H_MEM2 = @ptrFromInt(0x6003a068),
    .H_MEM3 = @ptrFromInt(0x6003a06c),
    .J0_MEM0 = @ptrFromInt(0x6003a070),
    .J0_MEM1 = @ptrFromInt(0x6003a074),
    .J0_MEM2 = @ptrFromInt(0x6003a078),
    .J0_MEM3 = @ptrFromInt(0x6003a07c),
    .T0_MEM0 = @ptrFromInt(0x6003a080),
    .T0_MEM1 = @ptrFromInt(0x6003a084),
    .T0_MEM2 = @ptrFromInt(0x6003a088),
    .T0_MEM3 = @ptrFromInt(0x6003a08c),
...
const APB_CTRL = struct {
    ...
    SYSCLK_CONF: *volatile APB_CTRL_SYSCLK_CONF,
    /// APB_CTRL_TICK_CONF_REG
    TICK_CONF: *volatile APB_CTRL_TICK_CONF,
    /// APB_CTRL_CLK_OUT_EN_REG
    CLK_OUT_EN: *volatile APB_CTRL_CLK_OUT_EN,
    /// APB_CTRL_WIFI_BB_CFG_REG
    WIFI_BB_CFG: *volatile APB_CTRL_WIFI_BB_CFG,
    /// APB_CTRL_WIFI_BB_CFG_2_REG
    WIFI_BB_CFG_2: *volatile APB_CTRL_WIFI_BB_CFG_2,
    /// APB_CTRL_WIFI_CLK_EN_REG
    WIFI_CLK_EN: *volatile APB_CTRL_WIFI_CLK_EN,
    /// APB_CTRL_WIFI_RST_EN_REG
    WIFI_RST_EN: *volatile APB_CTRL_WIFI_RST_EN,
    /// APB_CTRL_HOST_INF_SEL_REG
    HOST_INF_SEL: *volatile APB_CTRL_HOST_INF_SEL,
    /// APB_CTRL_EXT_MEM_PMS_LOCK_REG
    EXT_MEM_PMS_LOCK: *volatile APB_CTRL_EXT_MEM_PMS_LOCK,
    /// APB_CTRL_FLASH_ACE0_ATTR_REG
    FLASH_ACE0_ATTR: *volatile APB_CTRL_FLASH_ACE0_ATTR,
    /// APB_CTRL_FLASH_ACE1_ATTR_REG
    FLASH_ACE1_ATTR: *volatile APB_CTRL_FLASH_ACE1_ATTR,
    /// APB_CTRL_FLASH_ACE2_ATTR_REG
    FLASH_ACE2_ATTR: *volatile APB_CTRL_FLASH_ACE2_ATTR,
    /// APB_CTRL_FLASH_ACE3_ATTR_REG
    FLASH_ACE3_ATTR: *volatile APB_CTRL_FLASH_ACE3_ATTR,
    /// APB_CTRL_FLASH_ACE0_ADDR_REG
    FLASH_ACE0_ADDR: *volatile APB_CTRL_FLASH_ACE0_ADDR,
    /// APB_CTRL_FLASH_ACE1_ADDR_REG
    FLASH_ACE1_ADDR: *volatile APB_CTRL_FLASH_ACE1_ADDR,
    /// APB_CTRL_FLASH_ACE2_ADDR_REG
    FLASH_ACE2_ADDR: *volatile APB_CTRL_FLASH_ACE2_ADDR,
    /// APB_CTRL_FLASH_ACE3_ADDR_REG
    FLASH_ACE3_ADDR: *volatile APB_CTRL_FLASH_ACE3_ADDR,
    /// APB_CTRL_FLASH_ACE0_SIZE_REG
    FLASH_ACE0_SIZE: *volatile APB_CTRL_FLASH_ACE0_SIZE,
    /// APB_CTRL_FLASH_ACE1_SIZE_REG
    FLASH_ACE1_SIZE: *volatile APB_CTRL_FLASH_ACE1_SIZE,
    /// APB_CTRL_FLASH_ACE2_SIZE_REG
    FLASH_ACE2_SIZE: *volatile APB_CTRL_FLASH_ACE2_SIZE,
    /// APB_CTRL_FLASH_ACE3_SIZE_REG
    FLASH_ACE3_SIZE: *volatile APB_CTRL_FLASH_ACE3_SIZE,
    /// APB_CTRL_SPI_MEM_PMS_CTRL_REG
    SPI_MEM_PMS_CTRL: *volatile APB_CTRL_SPI_MEM_PMS_CTRL,
    /// APB_CTRL_SPI_MEM_REJECT_ADDR_REG
    SPI_MEM_REJECT_ADDR: *volatile APB_CTRL_SPI_MEM_REJECT_ADDR,
    /// APB_CTRL_SDIO_CTRL_REG
    SDIO_CTRL: *volatile APB_CTRL_SDIO_CTRL,
    /// APB_CTRL_REDCY_SIG0_REG_REG
    REDCY_SIG0: *volatile APB_CTRL_REDCY_SIG0,
    /// APB_CTRL_REDCY_SIG1_REG_REG
    REDCY_SIG1: *volatile APB_CTRL_REDCY_SIG1,
    /// APB_CTRL_FRONT_END_MEM_PD_REG
    FRONT_END_MEM_PD: *volatile APB_CTRL_FRONT_END_MEM_PD,
    /// APB_CTRL_RETENTION_CTRL_REG
    RETENTION_CTRL: *volatile APB_CTRL_RETENTION_CTRL,
    /// APB_CTRL_CLKGATE_FORCE_ON_REG
    CLKGATE_FORCE_ON: *volatile APB_CTRL_CLKGATE_FORCE_ON,
    /// APB_CTRL_MEM_POWER_DOWN_REG
    MEM_POWER_DOWN: *volatile APB_CTRL_MEM_POWER_DOWN,
    /// APB_CTRL_MEM_POWER_UP_REG
    MEM_POWER_UP: *volatile APB_CTRL_MEM_POWER_UP,
    /// APB_CTRL_RND_DATA_REG
    RND_DATA: *volatile APB_CTRL_RND_DATA,
    /// APB_CTRL_PERI_BACKUP_CONFIG_REG_REG
    PERI_BACKUP_CONFIG: *volatile APB_CTRL_PERI_BACKUP_CONFIG,
    /// APB_CTRL_PERI_BACKUP_APB_ADDR_REG_REG
    PERI_BACKUP_APB_ADDR: *volatile APB_CTRL_PERI_BACKUP_APB_ADDR,
    /// APB_CTRL_PERI_BACKUP_MEM_ADDR_REG_REG
    PERI_BACKUP_MEM_ADDR: *volatile APB_CTRL_PERI_BACKUP_MEM_ADDR,
    /// APB_CTRL_PERI_BACKUP_INT_RAW_REG
    PERI_BACKUP_INT_RAW: *volatile APB_CTRL_PERI_BACKUP_INT_RAW,
    /// APB_CTRL_PERI_BACKUP_INT_ST_REG
    PERI_BACKUP_INT_ST: *volatile APB_CTRL_PERI_BACKUP_INT_ST,
    /// APB_CTRL_PERI_BACKUP_INT_ENA_REG
    PERI_BACKUP_INT_ENA: *volatile APB_CTRL_PERI_BACKUP_INT_ENA,
    /// APB_CTRL_PERI_BACKUP_INT_CLR_REG
    PERI_BACKUP_INT_CLR: *volatile APB_CTRL_PERI_BACKUP_INT_CLR,
    /// APB_CTRL_DATE_REG
    DATE: *volatile APB_CTRL_DATE,
};
...
const APB_SARADC = struct {
    ...
    CTRL: *volatile APB_SARADC_CTRL,
    /// digital saradc configure register
    CTRL2: *volatile APB_SARADC_CTRL2,
    /// digital saradc configure register
    FILTER_CTRL1: *volatile APB_SARADC_FILTER_CTRL1,
    /// digital saradc configure register
    FSM_WAIT: *volatile APB_SARADC_FSM_WAIT,
    /// digital saradc configure register
    SAR1_STATUS: *volatile APB_SARADC_SAR1_STATUS,
    /// digital saradc configure register
    SAR2_STATUS: *volatile APB_SARADC_SAR2_STATUS,
    /// digital saradc configure register
    SAR_PATT_TAB1: *volatile APB_SARADC_SAR_PATT_TAB1,
    /// digital saradc configure register
    SAR_PATT_TAB2: *volatile APB_SARADC_SAR_PATT_TAB2,
    /// digital saradc configure register
    ONETIME_SAMPLE: *volatile APB_SARADC_ONETIME_SAMPLE,
    /// digital saradc configure register
    ARB_CTRL: *volatile APB_SARADC_ARB_CTRL,
    /// digital saradc configure register
    FILTER_CTRL0: *volatile APB_SARADC_FILTER_CTRL0,
    /// digital saradc configure register
    SAR1DATA_STATUS: *volatile APB_SARADC_SAR1DATA_STATUS,
    /// digital saradc configure register
    SAR2DATA_STATUS: *volatile APB_SARADC_SAR2DATA_STATUS,
    /// digital saradc configure register
    THRES0_CTRL: *volatile APB_SARADC_THRES0_CTRL,
    /// digital saradc configure register
    THRES1_CTRL: *volatile APB_SARADC_THRES1_CTRL,
    /// digital saradc configure register
    THRES_CTRL: *volatile APB_SARADC_THRES_CTRL,
    /// digital saradc int register
    INT_ENA: *volatile APB_SARADC_INT_ENA,
    /// digital saradc int register
    INT_RAW: *volatile APB_SARADC_INT_RAW,
    /// digital saradc int register
    INT_ST: *volatile APB_SARADC_INT_ST,
    /// digital saradc int register
    INT_CLR: *volatile APB_SARADC_INT_CLR,
    /// digital saradc configure register
    DMA_CONF: *volatile APB_SARADC_DMA_CONF,
    /// digital saradc configure register
    CLKM_CONF: *volatile APB_SARADC_CLKM_CONF,
    /// digital tsens configure register
    APB_TSENS_CTRL: *volatile APB_SARADC_APB_TSENS_CTRL,
    /// digital tsens configure register
    TSENS_CTRL2: *volatile APB_SARADC_TSENS_CTRL2,
    /// digital saradc configure register
    CALI: *volatile APB_SARADC_CALI,
    /// version
    CTRL_DATE: *volatile APB_SARADC_CTRL_DATE,
};
...
const ASSIST_DEBUG = struct {
    ...
    CORE_0_MONTR_ENA: *volatile ASSIST_DEBUG_CORE_0_MONTR_ENA,
    /// ASSIST_DEBUG_CORE_0_INTR_RAW_REG
    CORE_0_INTR_RAW: *volatile ASSIST_DEBUG_CORE_0_INTR_RAW,
    /// ASSIST_DEBUG_CORE_0_INTR_ENA_REG
    CORE_0_INTR_ENA: *volatile ASSIST_DEBUG_CORE_0_INTR_ENA,
    /// ASSIST_DEBUG_CORE_0_INTR_CLR_REG
    CORE_0_INTR_CLR: *volatile ASSIST_DEBUG_CORE_0_INTR_CLR,
    /// ASSIST_DEBUG_CORE_0_AREA_DRAM0_0_MIN_REG
    CORE_0_AREA_DRAM0_0_MIN: *volatile ASSIST_DEBUG_CORE_0_AREA_DRAM0_0_MIN,
    /// ASSIST_DEBUG_CORE_0_AREA_DRAM0_0_MAX_REG
    CORE_0_AREA_DRAM0_0_MAX: *volatile ASSIST_DEBUG_CORE_0_AREA_DRAM0_0_MAX,
    /// ASSIST_DEBUG_CORE_0_AREA_DRAM0_1_MIN_REG
    CORE_0_AREA_DRAM0_1_MIN: *volatile ASSIST_DEBUG_CORE_0_AREA_DRAM0_1_MIN,
    /// ASSIST_DEBUG_CORE_0_AREA_DRAM0_1_MAX_REG
    CORE_0_AREA_DRAM0_1_MAX: *volatile ASSIST_DEBUG_CORE_0_AREA_DRAM0_1_MAX,
    /// ASSIST_DEBUG_CORE_0_AREA_PIF_0_MIN_REG
    CORE_0_AREA_PIF_0_MIN: *volatile ASSIST_DEBUG_CORE_0_AREA_PIF_0_MIN,
    /// ASSIST_DEBUG_CORE_0_AREA_PIF_0_MAX_REG
    CORE_0_AREA_PIF_0_MAX: *volatile ASSIST_DEBUG_CORE_0_AREA_PIF_0_MAX,
    /// ASSIST_DEBUG_CORE_0_AREA_PIF_1_MIN_REG
    CORE_0_AREA_PIF_1_MIN: *volatile ASSIST_DEBUG_CORE_0_AREA_PIF_1_MIN,
    /// ASSIST_DEBUG_CORE_0_AREA_PIF_1_MAX_REG
    CORE_0_AREA_PIF_1_MAX: *volatile ASSIST_DEBUG_CORE_0_AREA_PIF_1_MAX,
    /// ASSIST_DEBUG_CORE_0_AREA_PC_REG
    CORE_0_AREA_PC: *volatile ASSIST_DEBUG_CORE_0_AREA_PC,
    /// ASSIST_DEBUG_CORE_0_AREA_SP_REG
    CORE_0_AREA_SP: *volatile ASSIST_DEBUG_CORE_0_AREA_SP,
    /// ASSIST_DEBUG_CORE_0_SP_MIN_REG
    CORE_0_SP_MIN: *volatile ASSIST_DEBUG_CORE_0_SP_MIN,
    /// ASSIST_DEBUG_CORE_0_SP_MAX_REG
    CORE_0_SP_MAX: *volatile ASSIST_DEBUG_CORE_0_SP_MAX,
    /// ASSIST_DEBUG_CORE_0_SP_PC_REG
    CORE_0_SP_PC: *volatile ASSIST_DEBUG_CORE_0_SP_PC,
    /// ASSIST_DEBUG_CORE_0_RCD_EN_REG
    CORE_0_RCD_EN: *volatile ASSIST_DEBUG_CORE_0_RCD_EN,
    /// ASSIST_DEBUG_CORE_0_RCD_PDEBUGPC_REG
    CORE_0_RCD_PDEBUGPC: *volatile ASSIST_DEBUG_CORE_0_RCD_PDEBUGPC,
    /// ASSIST_DEBUG_CORE_0_RCD_PDEBUGSP_REG
    CORE_0_RCD_PDEBUGSP: *volatile ASSIST_DEBUG_CORE_0_RCD_PDEBUGSP,
    /// ASSIST_DEBUG_CORE_0_RCD_PDEBUGSP_REG
    CORE_0_IRAM0_EXCEPTION_MONITOR_0: *volatile ASSIST_DEBUG_CORE_0_IRAM0_EXCEPTION_MONITOR_0,
    /// ASSIST_DEBUG_CORE_0_IRAM0_EXCEPTION_MONITOR_1_REG
    CORE_0_IRAM0_EXCEPTION_MONITOR_1: *volatile ASSIST_DEBUG_CORE_0_IRAM0_EXCEPTION_MONITOR_1,
    /// ASSIST_DEBUG_CORE_0_DRAM0_EXCEPTION_MONITOR_0_REG
    CORE_0_DRAM0_EXCEPTION_MONITOR_0: *volatile ASSIST_DEBUG_CORE_0_DRAM0_EXCEPTION_MONITOR_0,
    /// ASSIST_DEBUG_CORE_0_DRAM0_EXCEPTION_MONITOR_1_REG
    CORE_0_DRAM0_EXCEPTION_MONITOR_1: *volatile ASSIST_DEBUG_CORE_0_DRAM0_EXCEPTION_MONITOR_1,
    /// ASSIST_DEBUG_CORE_0_DRAM0_EXCEPTION_MONITOR_1_REG
    CORE_0_DRAM0_EXCEPTION_MONITOR_2: *volatile ASSIST_DEBUG_CORE_0_DRAM0_EXCEPTION_MONITOR_2,
    /// ASSIST_DEBUG_CORE_0_DRAM0_EXCEPTION_MONITOR_3_REG
    CORE_0_DRAM0_EXCEPTION_MONITOR_3: *volatile ASSIST_DEBUG_CORE_0_DRAM0_EXCEPTION_MONITOR_3,
    /// ASSIST_DEBUG_CORE_X_IRAM0_DRAM0_EXCEPTION_MONITOR_0_REG
    CORE_X_IRAM0_DRAM0_EXCEPTION_MONITOR_0: *volatile ASSIST_DEBUG_CORE_X_IRAM0_DRAM0_EXCEPTION_MONITOR_0,
    /// ASSIST_DEBUG_CORE_X_IRAM0_DRAM0_EXCEPTION_MONITOR_1_REG
    CORE_X_IRAM0_DRAM0_EXCEPTION_MONITOR_1: *volatile ASSIST_DEBUG_CORE_X_IRAM0_DRAM0_EXCEPTION_MONITOR_1,
    /// ASSIST_DEBUG_LOG_SETTING
    LOG_SETTING: *volatile ASSIST_DEBUG_LOG_SETTING,
    /// ASSIST_DEBUG_LOG_DATA_0_REG
    LOG_DATA_0: *volatile ASSIST_DEBUG_LOG_DATA_0,
    /// ASSIST_DEBUG_LOG_DATA_MASK_REG
    LOG_DATA_MASK: *volatile ASSIST_DEBUG_LOG_DATA_MASK,
    /// ASSIST_DEBUG_LOG_MIN_REG
    LOG_MIN: *volatile ASSIST_DEBUG_LOG_MIN,
    /// ASSIST_DEBUG_LOG_MAX_REG
    LOG_MAX: *volatile ASSIST_DEBUG_LOG_MAX,
    /// ASSIST_DEBUG_LOG_MEM_START_REG
    LOG_MEM_START: *volatile ASSIST_DEBUG_LOG_MEM_START,
    /// ASSIST_DEBUG_LOG_MEM_END_REG
    LOG_MEM_END: *volatile ASSIST_DEBUG_LOG_MEM_END,
    /// ASSIST_DEBUG_LOG_MEM_WRITING_ADDR_REG
    LOG_MEM_WRITING_ADDR: *volatile ASSIST_DEBUG_LOG_MEM_WRITING_ADDR,
    /// ASSIST_DEBUG_LOG_MEM_FULL_FLAG_REG
    LOG_MEM_FULL_FLAG: *volatile ASSIST_DEBUG_LOG_MEM_FULL_FLAG,
    /// ASSIST_DEBUG_C0RE_0_LASTPC_BEFORE_EXCEPTION
    C0RE_0_LASTPC_BEFORE_EXCEPTION: *volatile ASSIST_DEBUG_C0RE_0_LASTPC_BEFORE_EXCEPTION,
    /// ASSIST_DEBUG_C0RE_0_DEBUG_MODE
    C0RE_0_DEBUG_MODE: *volatile ASSIST_DEBUG_C0RE_0_DEBUG_MODE,
    /// ASSIST_DEBUG_DATE_REG
    DATE: *volatile ASSIST_DEBUG_DATE,
};
...
const BB = struct {
    ...
    BBPD_CTRL: *volatile BB_BBPD_CTRL,
};
...
const DMA = struct {
    /// DMA_INT_RAW_CH0_REG.
    INT_RAW_CH0: *volatile DMA_INT_RAW_CHN,
    /// DMA_INT_RAW_CH1_REG.
    INT_RAW_CH1: *volatile DMA_INT_RAW_CHN,
    /// DMA_INT_RAW_CH2_REG.
    INT_RAW_CH2: *volatile DMA_INT_RAW_CHN,
    /// DMA_INT_ST_CH0_REG.
    INT_ST_CH0: *volatile DMA_INT_ST_CH0,
    /// DMA_INT_ENA_CH0_REG.
    INT_ENA_CH0: *volatile DMA_INT_ENA_CHN,
    /// DMA_INT_ENA_CH1_REG.
    INT_ENA_CH1: *volatile DMA_INT_ENA_CHN,
    /// DMA_INT_ENA_CH2_REG.
    INT_ENA_CH2: *volatile DMA_INT_ENA_CHN,
    /// DMA_INT_CLR_CH0_REG.
    INT_CLR_CH0: *volatile DMA_INT_CLR_CHN,
    /// DMA_INT_CLR_CH1_REG.
    INT_CLR_CH1: *volatile DMA_INT_CLR_CHN,
    /// DMA_INT_CLR_CH2_REG.
    INT_CLR_CH2: *volatile DMA_INT_CLR_CHN,
    /// DMA_INT_ST_CH1_REG.
    INT_ST_CH1: *volatile DMA_INT_ST_CH1,
    /// DMA_INT_ST_CH2_REG.
    INT_ST_CH2: *volatile DMA_INT_ST_CH2,
    /// DMA_AHB_TEST_REG.
    AHB_TEST: *volatile DMA_AHB_TEST,
    /// DMA_MISC_CONF_REG.
    MISC_CONF: *volatile DMA_MISC_CONF,
    /// DMA_DATE_REG.
    DATE: *volatile DMA_DATE,
    /// DMA_IN_CONF0_CH0_REG.
    IN_CONF0_CH0: *volatile DMA_IN_CONF0_CHN,
    /// DMA_IN_CONF1_CH1_REG.
    IN_CONF0_CH1: *volatile DMA_IN_CONF0_CHN,
    /// DMA_IN_CONF2_CH2_REG.
    IN_CONF0_CH2: *volatile DMA_IN_CONF0_CHN,
    /// DMA_IN_CONF1_CH0_REG.
    IN_CONF1_CH0: *volatile DMA_IN_CONF1_CH0,
    /// DMA_INFIFO_STATUS_CH0_REG.
    INFIFO_STATUS_CH0: *volatile DMA_INFIFO_STATUS_CH0,
    /// DMA_IN_POP_CH0_REG.
    IN_POP_CH0: *volatile DMA_IN_POP_CH0,
    /// DMA_IN_LINK_CH0_REG.
    IN_LINK_CH0: *volatile DMA_IN_LINK_CHN,
    /// DMA_IN_LINK_CH1_REG.
    IN_LINK_CH1: *volatile DMA_IN_LINK_CHN,
    /// DMA_IN_LINK_CH2_REG.
    IN_LINK_CH2: *volatile DMA_IN_LINK_CHN,
    /// DMA_IN_STATE_CH0_REG.
    IN_STATE_CH0: *volatile DMA_IN_STATE_CH0,
    /// DMA_IN_SUC_EOF_DES_ADDR_CH0_REG.
    IN_SUC_EOF_DES_ADDR_CH0: *volatile DMA_IN_SUC_EOF_DES_ADDR_CH0,
    /// DMA_IN_ERR_EOF_DES_ADDR_CH0_REG.
    IN_ERR_EOF_DES_ADDR_CH0: *volatile DMA_IN_ERR_EOF_DES_ADDR_CH0,
    /// DMA_IN_DSCR_CH0_REG.
    IN_DSCR_CH0: *volatile DMA_IN_DSCR_CH0,
    /// DMA_IN_DSCR_BF0_CH0_REG.
    IN_DSCR_BF0_CH0: *volatile DMA_IN_DSCR_BF0_CHN,
    /// DMA_IN_DSCR_BF1_CH1_REG.
    IN_DSCR_BF0_CH1: *volatile DMA_IN_DSCR_BF0_CHN,
    /// DMA_IN_DSCR_BF2_CH2_REG.
    IN_DSCR_BF0_CH2: *volatile DMA_IN_DSCR_BF0_CHN,
    /// DMA_IN_DSCR_BF1_CH0_REG.
    IN_DSCR_BF1_CH0: *volatile DMA_IN_DSCR_BF1_CH0,
    /// DMA_IN_PRI_CH0_REG.
    IN_PRI_CH0: *volatile DMA_IN_PRI_CHN,
    /// DMA_IN_PRI_CH1_REG.
    IN_PRI_CH1: *volatile DMA_IN_PRI_CHN,
    /// DMA_IN_PRI_CH2_REG.
    IN_PRI_CH2: *volatile DMA_IN_PRI_CHN,
    /// DMA_IN_PERI_SEL_CH0_REG.
    IN_PERI_SEL_CH0: *volatile DMA_IN_PERI_SEL_CHN,
    /// DMA_IN_PERI_SEL_CH1_REG.
    IN_PERI_SEL_CH1: *volatile DMA_IN_PERI_SEL_CHN,
    /// DMA_IN_PERI_SEL_CH2_REG.
    IN_PERI_SEL_CH2: *volatile DMA_IN_PERI_SEL_CHN,
    /// DMA_OUT_CONF0_CH0_REG.
    OUT_CONF0_CH0: *volatile DMA_OUT_CONF0_CHN,
    /// DMA_OUT_CONF1_CH1_REG.
    OUT_CONF0_CH1: *volatile DMA_OUT_CONF0_CHN,
    /// DMA_OUT_CONF2_CH2_REG.
    OUT_CONF0_CH2: *volatile DMA_OUT_CONF0_CHN,
    /// DMA_OUT_CONF1_CH0_REG.
    OUT_CONF1_CH0: *volatile DMA_OUT_CONF1_CHN,
    /// DMA_OUT_CONF1_CH1_REG.
    OUT_CONF1_CH1: *volatile DMA_OUT_CONF1_CHN,
    /// DMA_OUT_CONF1_CH2_REG.
    OUT_CONF1_CH2: *volatile DMA_OUT_CONF1_CHN,
    /// DMA_OUTFIFO_STATUS_CH0_REG.
    OUTFIFO_STATUS_CH0: *volatile DMA_OUTFIFO_STATUS_CH0,
    /// DMA_OUT_PUSH_CH0_REG.
    OUT_PUSH_CH0: *volatile DMA_OUT_PUSH_CH0,
    /// DMA_OUT_LINK_CH0_REG.
    OUT_LINK_CH0: *volatile DMA_OUT_LINK_CHN,
    /// DMA_OUT_LINK_CH1_REG.
    OUT_LINK_CH1: *volatile DMA_OUT_LINK_CHN,
    /// DMA_OUT_LINK_CH2_REG.
    OUT_LINK_CH2: *volatile DMA_OUT_LINK_CHN,
    /// DMA_OUT_STATE_CH0_REG.
    OUT_STATE_CH0: *volatile DMA_OUT_STATE_CH0,
    /// DMA_OUT_EOF_DES_ADDR_CH0_REG.
    OUT_EOF_DES_ADDR_CH0: *volatile DMA_OUT_EOF_DES_ADDR_CHN,
    /// DMA_OUT_EOF_DES_ADDR_CH1_REG.
    OUT_EOF_DES_ADDR_CH1: *volatile DMA_OUT_EOF_DES_ADDR_CHN,
    /// DMA_OUT_EOF_DES_ADDR_CH2_REG.
    OUT_EOF_DES_ADDR_CH2: *volatile DMA_OUT_EOF_DES_ADDR_CHN,
    /// DMA_OUT_EOF_BFR_DES_ADDR_CH0_REG.
    OUT_EOF_BFR_DES_ADDR_CH0: *volatile DMA_OUT_EOF_BFR_DES_ADDR_CH0,
    /// DMA_OUT_DSCR_CH0_REG.
    OUT_DSCR_CH0: *volatile DMA_OUT_DSCR_CH0,
    /// DMA_OUT_DSCR_BF0_CH0_REG.
    OUT_DSCR_BF0_CH0: *volatile DMA_OUT_DSCR_BF0_CH0,
    /// DMA_OUT_DSCR_BF1_CH0_REG.
    OUT_DSCR_BF1_CH0: *volatile DMA_OUT_DSCR_BF1_CH0,
    /// DMA_OUT_PRI_CH0_REG.
    OUT_PRI_CH0: *volatile DMA_OUT_PRI_CHN,
    /// DMA_OUT_PRI_CH1_REG.
    OUT_PRI_CH1: *volatile DMA_OUT_PRI_CHN,
    /// DMA_OUT_PRI_CH2_REG.
    OUT_PRI_CH2: *volatile DMA_OUT_PRI_CHN,
    /// DMA_OUT_PERI_SEL_CH0_REG.
    OUT_PERI_SEL_CH0: *volatile DMA_OUT_PERI_SEL_CHN,
    /// DMA_OUT_PERI_SEL_CH1_REG.
    OUT_PERI_SEL_CH1: *volatile DMA_OUT_PERI_SEL_CHN,
    /// DMA_OUT_PERI_SEL_CH2_REG.
    OUT_PERI_SEL_CH2: *volatile DMA_OUT_PERI_SEL_CHN,
    /// DMA_IN_CONF1_CH1_REG.
    IN_CONF1_CH1: *volatile DMA_IN_CONF1_CH1,
    /// DMA_INFIFO_STATUS_CH1_REG.
    INFIFO_STATUS_CH1: *volatile DMA_INFIFO_STATUS_CH1,
    /// DMA_IN_POP_CH1_REG.
    IN_POP_CH1: *volatile DMA_IN_POP_CH1,
    /// DMA_IN_STATE_CH1_REG.
    IN_STATE_CH1: *volatile DMA_IN_STATE_CH1,
    /// DMA_IN_SUC_EOF_DES_ADDR_CH1_REG.
    IN_SUC_EOF_DES_ADDR_CH1: *volatile DMA_IN_SUC_EOF_DES_ADDR_CH1,
    /// DMA_IN_ERR_EOF_DES_ADDR_CH1_REG.
    IN_ERR_EOF_DES_ADDR_CH1: *volatile DMA_IN_ERR_EOF_DES_ADDR_CH1,
    /// DMA_IN_DSCR_CH1_REG.
    IN_DSCR_CH1: *volatile DMA_IN_DSCR_CH1,
    /// DMA_IN_DSCR_BF1_CH1_REG.
    IN_DSCR_BF1_CH1: *volatile DMA_IN_DSCR_BF1_CH1,
    /// DMA_OUTFIFO_STATUS_CH1_REG.
    OUTFIFO_STATUS_CH1: *volatile DMA_OUTFIFO_STATUS_CH1,
    /// DMA_OUT_PUSH_CH1_REG.
    OUT_PUSH_CH1: *volatile DMA_OUT_PUSH_CH1,
    /// DMA_OUT_STATE_CH1_REG.
    OUT_STATE_CH1: *volatile DMA_OUT_STATE_CH1,
    /// DMA_OUT_EOF_BFR_DES_ADDR_CH1_REG.
    OUT_EOF_BFR_DES_ADDR_CH1: *volatile DMA_OUT_EOF_BFR_DES_ADDR_CH1,
    /// DMA_OUT_DSCR_CH1_REG.
    OUT_DSCR_CH1: *volatile DMA_OUT_DSCR_CH1,
    /// DMA_OUT_DSCR_BF0_CH1_REG.
    OUT_DSCR_BF0_CH1: *volatile DMA_OUT_DSCR_BF0_CH1,
    /// DMA_OUT_DSCR_BF1_CH1_REG.
    OUT_DSCR_BF1_CH1: *volatile DMA_OUT_DSCR_BF1_CH1,
    /// DMA_IN_CONF1_CH2_REG.
    IN_CONF1_CH2: *volatile DMA_IN_CONF1_CH2,
    /// DMA_INFIFO_STATUS_CH2_REG.
    INFIFO_STATUS_CH2: *volatile DMA_INFIFO_STATUS_CH2,
    /// DMA_IN_POP_CH2_REG.
    IN_POP_CH2: *volatile DMA_IN_POP_CH2,
    /// DMA_IN_STATE_CH2_REG.
    IN_STATE_CH2: *volatile DMA_IN_STATE_CH2,
    /// DMA_IN_SUC_EOF_DES_ADDR_CH2_REG.
    IN_SUC_EOF_DES_ADDR_CH2: *volatile DMA_IN_SUC_EOF_DES_ADDR_CH2,
    /// DMA_IN_ERR_EOF_DES_ADDR_CH2_REG.
    IN_ERR_EOF_DES_ADDR_CH2: *volatile DMA_IN_ERR_EOF_DES_ADDR_CH2,
    /// DMA_IN_DSCR_CH2_REG.
    IN_DSCR_CH2: *volatile DMA_IN_DSCR_CH2,
    /// DMA_IN_DSCR_BF1_CH2_REG.
    IN_DSCR_BF1_CH2: *volatile DMA_IN_DSCR_BF1_CH2,
    /// DMA_OUTFIFO_STATUS_CH2_REG.
    OUTFIFO_STATUS_CH2: *volatile DMA_OUTFIFO_STATUS_CH2,
    /// DMA_OUT_PUSH_CH2_REG.
    OUT_PUSH_CH2: *volatile DMA_OUT_PUSH_CH2,
    /// DMA_OUT_STATE_CH2_REG.
    OUT_STATE_CH2: *volatile DMA_OUT_STATE_CH2,
    /// DMA_OUT_EOF_BFR_DES_ADDR_CH2_REG.
    OUT_EOF_BFR_DES_ADDR_CH2: *volatile DMA_OUT_EOF_BFR_DES_ADDR_CH2,
    /// DMA_OUT_DSCR_CH2_REG.
    OUT_DSCR_CH2: *volatile DMA_OUT_DSCR_CH2,
    /// DMA_OUT_DSCR_BF0_CH2_REG.
    OUT_DSCR_BF0_CH2: *volatile DMA_OUT_DSCR_BF0_CH2,
    /// DMA_OUT_DSCR_BF1_CH2_REG.
    OUT_DSCR_BF1_CH2: *volatile DMA_OUT_DSCR_BF1_CH2,
};

const DMA_instance = DMA{
    .INT_RAW_CH0 = @ptrFromInt(0x6003f000),
    .INT_RAW_CH1 = @ptrFromInt(0x6003f010),
    .INT_RAW_CH2 = @ptrFromInt(0x6003f020),
    .INT_ST_CH0 = @ptrFromInt(0x6003f004),
    .INT_ENA_CH0 = @ptrFromInt(0x6003f008),
    .INT_ENA_CH1 = @ptrFromInt(0x6003f018),
    .INT_ENA_CH2 = @ptrFromInt(0x6003f028),
    .INT_CLR_CH0 = @ptrFromInt(0x6003f00c),
    .INT_CLR_CH1 = @ptrFromInt(0x6003f01c),
    .INT_CLR_CH2 = @ptrFromInt(0x6003f02c),
    ...
    .IN_CONF0_CH1 = @ptrFromInt(0x6003f130),
    .IN_CONF0_CH2 = @ptrFromInt(0x6003f1f0),
    ...
    .IN_LINK_CH1 = @ptrFromInt(0x6003f140),
    .IN_LINK_CH2 = @ptrFromInt(0x6003f200),
    ...
    .IN_DSCR_BF0_CH1 = @ptrFromInt(0x6003f154),
    .IN_DSCR_BF0_CH2 = @ptrFromInt(0x6003f214),
    .IN_DSCR_BF1_CH0 = @ptrFromInt(0x6003f098),
    .IN_PRI_CH0 = @ptrFromInt(0x6003f09c),
    .IN_PRI_CH1 = @ptrFromInt(0x6003f15c),
    .IN_PRI_CH2 = @ptrFromInt(0x6003f21c),
    .IN_PERI_SEL_CH0 = @ptrFromInt(0x6003f0a0),
    .IN_PERI_SEL_CH1 = @ptrFromInt(0x6003f160),
    .IN_PERI_SEL_CH2 = @ptrFromInt(0x6003f220),
    .OUT_CONF0_CH0 = @ptrFromInt(0x6003f0d0),
    .OUT_CONF0_CH1 = @ptrFromInt(0x6003f190),
    .OUT_CONF0_CH2 = @ptrFromInt(0x6003f250),
    .OUT_CONF1_CH0 = @ptrFromInt(0x6003f0d4),
    .OUT_CONF1_CH1 = @ptrFromInt(0x6003f194),
    .OUT_CONF1_CH2 = @ptrFromInt(0x6003f254),
    .OUTFIFO_STATUS_CH0 = @ptrFromInt(0x6003f0d8),
    .OUT_PUSH_CH0 = @ptrFromInt(0x6003f0dc),
    .OUT_LINK_CH0 = @ptrFromInt(0x6003f0e0),
    .OUT_LINK_CH1 = @ptrFromInt(0x6003f1a0),
    .OUT_LINK_CH2 = @ptrFromInt(0x6003f260),
    .OUT_STATE_CH0 = @ptrFromInt(0x6003f0e4),
    .OUT_EOF_DES_ADDR_CH0 = @ptrFromInt(0x6003f0e8),
    .OUT_EOF_DES_ADDR_CH1 = @ptrFromInt(0x6003f1a8),
    .OUT_EOF_DES_ADDR_CH2 = @ptrFromInt(0x6003f268),
    ...
    .OUT_PRI_CH1 = @ptrFromInt(0x6003f1bc),
    .OUT_PRI_CH2 = @ptrFromInt(0x6003f27c),
    .OUT_PERI_SEL_CH0 = @ptrFromInt(0x6003f100),
    .OUT_PERI_SEL_CH1 = @ptrFromInt(0x6003f1c0),
    .OUT_PERI_SEL_CH2 = @ptrFromInt(0x6003f280),
...
const DS = struct {
    ...
    Y_MEM0: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM1: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM2: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM3: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM4: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM5: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM6: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM7: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM8: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM9: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM10: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM11: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM12: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM13: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM14: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM15: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM16: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM17: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM18: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM19: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM20: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM21: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM22: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM23: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM24: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM25: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM26: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM27: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM28: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM29: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM30: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM31: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM32: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM33: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM34: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM35: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM36: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM37: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM38: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM39: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM40: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM41: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM42: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM43: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM44: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM45: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM46: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM47: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM48: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM49: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM50: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM51: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM52: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM53: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM54: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM55: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM56: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM57: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM58: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM59: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM60: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM61: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM62: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM63: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM64: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM65: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM66: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM67: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM68: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM69: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM70: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM71: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM72: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM73: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM74: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM75: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM76: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM77: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM78: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM79: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM80: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM81: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM82: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM83: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM84: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM85: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM86: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM87: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM88: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM89: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM90: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM91: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM92: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM93: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM94: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM95: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM96: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM97: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM98: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM99: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM100: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM101: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM102: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM103: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM104: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM105: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM106: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM107: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM108: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM109: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM110: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM111: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM112: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM113: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM114: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM115: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM116: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM117: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM118: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM119: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM120: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM121: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM122: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM123: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM124: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM125: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM126: *volatile DS_Y_MEMN,
    /// memory that stores Y
    Y_MEM127: *volatile DS_Y_MEMN,
    /// memory that stores M
    M_MEM0: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM1: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM2: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM3: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM4: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM5: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM6: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM7: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM8: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM9: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM10: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM11: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM12: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM13: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM14: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM15: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM16: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM17: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM18: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM19: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM20: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM21: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM22: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM23: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM24: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM25: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM26: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM27: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM28: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM29: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM30: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM31: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM32: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM33: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM34: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM35: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM36: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM37: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM38: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM39: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM40: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM41: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM42: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM43: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM44: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM45: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM46: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM47: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM48: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM49: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM50: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM51: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM52: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM53: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM54: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM55: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM56: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM57: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM58: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM59: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM60: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM61: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM62: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM63: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM64: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM65: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM66: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM67: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM68: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM69: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM70: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM71: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM72: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM73: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM74: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM75: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM76: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM77: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM78: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM79: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM80: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM81: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM82: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM83: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM84: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM85: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM86: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM87: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM88: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM89: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM90: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM91: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM92: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM93: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM94: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM95: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM96: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM97: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM98: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM99: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM100: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM101: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM102: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM103: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM104: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM105: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM106: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM107: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM108: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM109: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM110: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM111: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM112: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM113: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM114: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM115: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM116: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM117: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM118: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM119: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM120: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM121: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM122: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM123: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM124: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM125: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM126: *volatile DS_M_MEMN,
    /// memory that stores M
    M_MEM127: *volatile DS_M_MEMN,
    /// memory that stores Rb
    RB_MEM0: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM1: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM2: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM3: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM4: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM5: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM6: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM7: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM8: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM9: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM10: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM11: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM12: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM13: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM14: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM15: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM16: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM17: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM18: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM19: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM20: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM21: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM22: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM23: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM24: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM25: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM26: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM27: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM28: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM29: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM30: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM31: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM32: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM33: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM34: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM35: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM36: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM37: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM38: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM39: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM40: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM41: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM42: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM43: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM44: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM45: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM46: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM47: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM48: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM49: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM50: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM51: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM52: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM53: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM54: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM55: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM56: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM57: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM58: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM59: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM60: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM61: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM62: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM63: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM64: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM65: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM66: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM67: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM68: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM69: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM70: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM71: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM72: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM73: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM74: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM75: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM76: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM77: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM78: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM79: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM80: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM81: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM82: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM83: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM84: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM85: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM86: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM87: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM88: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM89: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM90: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM91: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM92: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM93: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM94: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM95: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM96: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM97: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM98: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM99: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM100: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM101: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM102: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM103: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM104: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM105: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM106: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM107: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM108: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM109: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM110: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM111: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM112: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM113: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM114: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM115: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM116: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM117: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM118: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM119: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM120: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM121: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM122: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM123: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM124: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM125: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM126: *volatile DS_RB_MEMN,
    /// memory that stores Rb
    RB_MEM127: *volatile DS_RB_MEMN,
    /// memory that stores BOX
    BOX_MEM0: *volatile DS_BOX_MEMN,
    /// memory that stores BOX
    BOX_MEM1: *volatile DS_BOX_MEMN,
    /// memory that stores BOX
    BOX_MEM2: *volatile DS_BOX_MEMN,
    /// memory that stores BOX
    BOX_MEM3: *volatile DS_BOX_MEMN,
    /// memory that stores BOX
    BOX_MEM4: *volatile DS_BOX_MEMN,
    /// memory that stores BOX
    BOX_MEM5: *volatile DS_BOX_MEMN,
    /// memory that stores BOX
    BOX_MEM6: *volatile DS_BOX_MEMN,
    /// memory that stores BOX
    BOX_MEM7: *volatile DS_BOX_MEMN,
    /// memory that stores BOX
    BOX_MEM8: *volatile DS_BOX_MEMN,
    /// memory that stores BOX
    BOX_MEM9: *volatile DS_BOX_MEMN,
    /// memory that stores BOX
    BOX_MEM10: *volatile DS_BOX_MEMN,
    /// memory that stores BOX
    BOX_MEM11: *volatile DS_BOX_MEMN,
    /// memory that stores X
    X_MEM0: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM1: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM2: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM3: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM4: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM5: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM6: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM7: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM8: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM9: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM10: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM11: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM12: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM13: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM14: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM15: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM16: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM17: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM18: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM19: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM20: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM21: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM22: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM23: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM24: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM25: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM26: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM27: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM28: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM29: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM30: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM31: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM32: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM33: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM34: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM35: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM36: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM37: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM38: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM39: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM40: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM41: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM42: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM43: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM44: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM45: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM46: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM47: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM48: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM49: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM50: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM51: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM52: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM53: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM54: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM55: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM56: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM57: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM58: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM59: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM60: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM61: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM62: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM63: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM64: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM65: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM66: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM67: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM68: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM69: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM70: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM71: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM72: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM73: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM74: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM75: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM76: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM77: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM78: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM79: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM80: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM81: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM82: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM83: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM84: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM85: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM86: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM87: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM88: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM89: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM90: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM91: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM92: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM93: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM94: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM95: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM96: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM97: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM98: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM99: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM100: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM101: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM102: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM103: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM104: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM105: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM106: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM107: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM108: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM109: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM110: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM111: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM112: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM113: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM114: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM115: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM116: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM117: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM118: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM119: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM120: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM121: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM122: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM123: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM124: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM125: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM126: *volatile DS_X_MEMN,
    /// memory that stores X
    X_MEM127: *volatile DS_X_MEMN,
    /// memory that stores Z
    Z_MEM0: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM1: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM2: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM3: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM4: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM5: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM6: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM7: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM8: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM9: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM10: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM11: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM12: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM13: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM14: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM15: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM16: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM17: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM18: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM19: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM20: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM21: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM22: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM23: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM24: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM25: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM26: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM27: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM28: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM29: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM30: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM31: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM32: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM33: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM34: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM35: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM36: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM37: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM38: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM39: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM40: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM41: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM42: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM43: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM44: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM45: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM46: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM47: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM48: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM49: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM50: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM51: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM52: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM53: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM54: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM55: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM56: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM57: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM58: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM59: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM60: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM61: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM62: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM63: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM64: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM65: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM66: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM67: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM68: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM69: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM70: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM71: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM72: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM73: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM74: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM75: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM76: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM77: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM78: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM79: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM80: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM81: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM82: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM83: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM84: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM85: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM86: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM87: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM88: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM89: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM90: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM91: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM92: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM93: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM94: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM95: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM96: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM97: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM98: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM99: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM100: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM101: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM102: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM103: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM104: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM105: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM106: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM107: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM108: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM109: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM110: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM111: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM112: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM113: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM114: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM115: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM116: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM117: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM118: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM119: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM120: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM121: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM122: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM123: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM124: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM125: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM126: *volatile DS_Z_MEMN,
    /// memory that stores Z
    Z_MEM127: *volatile DS_Z_MEMN,
    /// DS start control register
    SET_START: *volatile DS_SET_START,
    /// DS continue control register
    SET_CONTINUE: *volatile DS_SET_CONTINUE,
    /// DS finish control register
    SET_FINISH: *volatile DS_SET_FINISH,
    /// DS query busy register
    QUERY_BUSY: *volatile DS_QUERY_BUSY,
    /// DS query key-wrong counter register
    QUERY_KEY_WRONG: *volatile DS_QUERY_KEY_WRONG,
    /// DS query check result register
    QUERY_CHECK: *volatile DS_QUERY_CHECK,
    /// DS version control register
    DATE: *volatile DS_DATE,
};

const DS_instance = DS{
    .Y_MEM0 = @ptrFromInt(0x6003d000),
    .Y_MEM1 = @ptrFromInt(0x6003d004),
    .Y_MEM2 = @ptrFromInt(0x6003d008),
    .Y_MEM3 = @ptrFromInt(0x6003d00c),
    .Y_MEM4 = @ptrFromInt(0x6003d010),
    .Y_MEM5 = @ptrFromInt(0x6003d014),
    .Y_MEM6 = @ptrFromInt(0x6003d018),
    .Y_MEM7 = @ptrFromInt(0x6003d01c),
    .Y_MEM8 = @ptrFromInt(0x6003d020),
    .Y_MEM9 = @ptrFromInt(0x6003d024),
    .Y_MEM10 = @ptrFromInt(0x6003d028),
    .Y_MEM11 = @ptrFromInt(0x6003d02c),
    .Y_MEM12 = @ptrFromInt(0x6003d030),
    .Y_MEM13 = @ptrFromInt(0x6003d034),
    .Y_MEM14 = @ptrFromInt(0x6003d038),
    .Y_MEM15 = @ptrFromInt(0x6003d03c),
    .Y_MEM16 = @ptrFromInt(0x6003d040),
    .Y_MEM17 = @ptrFromInt(0x6003d044),
    .Y_MEM18 = @ptrFromInt(0x6003d048),
    .Y_MEM19 = @ptrFromInt(0x6003d04c),
    .Y_MEM20 = @ptrFromInt(0x6003d050),
    .Y_MEM21 = @ptrFromInt(0x6003d054),
    .Y_MEM22 = @ptrFromInt(0x6003d058),
    .Y_MEM23 = @ptrFromInt(0x6003d05c),
    .Y_MEM24 = @ptrFromInt(0x6003d060),
    .Y_MEM25 = @ptrFromInt(0x6003d064),
    .Y_MEM26 = @ptrFromInt(0x6003d068),
    .Y_MEM27 = @ptrFromInt(0x6003d06c),
    .Y_MEM28 = @ptrFromInt(0x6003d070),
    .Y_MEM29 = @ptrFromInt(0x6003d074),
    .Y_MEM30 = @ptrFromInt(0x6003d078),
    .Y_MEM31 = @ptrFromInt(0x6003d07c),
    .Y_MEM32 = @ptrFromInt(0x6003d080),
    .Y_MEM33 = @ptrFromInt(0x6003d084),
    .Y_MEM34 = @ptrFromInt(0x6003d088),
    .Y_MEM35 = @ptrFromInt(0x6003d08c),
    .Y_MEM36 = @ptrFromInt(0x6003d090),
    .Y_MEM37 = @ptrFromInt(0x6003d094),
    .Y_MEM38 = @ptrFromInt(0x6003d098),
    .Y_MEM39 = @ptrFromInt(0x6003d09c),
    .Y_MEM40 = @ptrFromInt(0x6003d0a0),
    .Y_MEM41 = @ptrFromInt(0x6003d0a4),
    .Y_MEM42 = @ptrFromInt(0x6003d0a8),
    .Y_MEM43 = @ptrFromInt(0x6003d0ac),
    .Y_MEM44 = @ptrFromInt(0x6003d0b0),
    .Y_MEM45 = @ptrFromInt(0x6003d0b4),
    .Y_MEM46 = @ptrFromInt(0x6003d0b8),
    .Y_MEM47 = @ptrFromInt(0x6003d0bc),
    .Y_MEM48 = @ptrFromInt(0x6003d0c0),
    .Y_MEM49 = @ptrFromInt(0x6003d0c4),
    .Y_MEM50 = @ptrFromInt(0x6003d0c8),
    .Y_MEM51 = @ptrFromInt(0x6003d0cc),
    .Y_MEM52 = @ptrFromInt(0x6003d0d0),
    .Y_MEM53 = @ptrFromInt(0x6003d0d4),
    .Y_MEM54 = @ptrFromInt(0x6003d0d8),
    .Y_MEM55 = @ptrFromInt(0x6003d0dc),
    .Y_MEM56 = @ptrFromInt(0x6003d0e0),
    .Y_MEM57 = @ptrFromInt(0x6003d0e4),
    .Y_MEM58 = @ptrFromInt(0x6003d0e8),
    .Y_MEM59 = @ptrFromInt(0x6003d0ec),
    .Y_MEM60 = @ptrFromInt(0x6003d0f0),
    .Y_MEM61 = @ptrFromInt(0x6003d0f4),
    .Y_MEM62 = @ptrFromInt(0x6003d0f8),
    .Y_MEM63 = @ptrFromInt(0x6003d0fc),
    .Y_MEM64 = @ptrFromInt(0x6003d100),
    .Y_MEM65 = @ptrFromInt(0x6003d104),
    .Y_MEM66 = @ptrFromInt(0x6003d108),
    .Y_MEM67 = @ptrFromInt(0x6003d10c),
    .Y_MEM68 = @ptrFromInt(0x6003d110),
    .Y_MEM69 = @ptrFromInt(0x6003d114),
    .Y_MEM70 = @ptrFromInt(0x6003d118),
    .Y_MEM71 = @ptrFromInt(0x6003d11c),
    .Y_MEM72 = @ptrFromInt(0x6003d120),
    .Y_MEM73 = @ptrFromInt(0x6003d124),
    .Y_MEM74 = @ptrFromInt(0x6003d128),
    .Y_MEM75 = @ptrFromInt(0x6003d12c),
    .Y_MEM76 = @ptrFromInt(0x6003d130),
    .Y_MEM77 = @ptrFromInt(0x6003d134),
    .Y_MEM78 = @ptrFromInt(0x6003d138),
    .Y_MEM79 = @ptrFromInt(0x6003d13c),
    .Y_MEM80 = @ptrFromInt(0x6003d140),
    .Y_MEM81 = @ptrFromInt(0x6003d144),
    .Y_MEM82 = @ptrFromInt(0x6003d148),
    .Y_MEM83 = @ptrFromInt(0x6003d14c),
    .Y_MEM84 = @ptrFromInt(0x6003d150),
    .Y_MEM85 = @ptrFromInt(0x6003d154),
    .Y_MEM86 = @ptrFromInt(0x6003d158),
    .Y_MEM87 = @ptrFromInt(0x6003d15c),
    .Y_MEM88 = @ptrFromInt(0x6003d160),
    .Y_MEM89 = @ptrFromInt(0x6003d164),
    .Y_MEM90 = @ptrFromInt(0x6003d168),
    .Y_MEM91 = @ptrFromInt(0x6003d16c),
    .Y_MEM92 = @ptrFromInt(0x6003d170),
    .Y_MEM93 = @ptrFromInt(0x6003d174),
    .Y_MEM94 = @ptrFromInt(0x6003d178),
    .Y_MEM95 = @ptrFromInt(0x6003d17c),
    .Y_MEM96 = @ptrFromInt(0x6003d180),
    .Y_MEM97 = @ptrFromInt(0x6003d184),
    .Y_MEM98 = @ptrFromInt(0x6003d188),
    .Y_MEM99 = @ptrFromInt(0x6003d18c),
    .Y_MEM100 = @ptrFromInt(0x6003d190),
    .Y_MEM101 = @ptrFromInt(0x6003d194),
    .Y_MEM102 = @ptrFromInt(0x6003d198),
    .Y_MEM103 = @ptrFromInt(0x6003d19c),
    .Y_MEM104 = @ptrFromInt(0x6003d1a0),
    .Y_MEM105 = @ptrFromInt(0x6003d1a4),
    .Y_MEM106 = @ptrFromInt(0x6003d1a8),
    .Y_MEM107 = @ptrFromInt(0x6003d1ac),
    .Y_MEM108 = @ptrFromInt(0x6003d1b0),
    .Y_MEM109 = @ptrFromInt(0x6003d1b4),
    .Y_MEM110 = @ptrFromInt(0x6003d1b8),
    .Y_MEM111 = @ptrFromInt(0x6003d1bc),
    .Y_MEM112 = @ptrFromInt(0x6003d1c0),
    .Y_MEM113 = @ptrFromInt(0x6003d1c4),
    .Y_MEM114 = @ptrFromInt(0x6003d1c8),
    .Y_MEM115 = @ptrFromInt(0x6003d1cc),
    .Y_MEM116 = @ptrFromInt(0x6003d1d0),
    .Y_MEM117 = @ptrFromInt(0x6003d1d4),
    .Y_MEM118 = @ptrFromInt(0x6003d1d8),
    .Y_MEM119 = @ptrFromInt(0x6003d1dc),
    .Y_MEM120 = @ptrFromInt(0x6003d1e0),
    .Y_MEM121 = @ptrFromInt(0x6003d1e4),
    .Y_MEM122 = @ptrFromInt(0x6003d1e8),
    .Y_MEM123 = @ptrFromInt(0x6003d1ec),
    .Y_MEM124 = @ptrFromInt(0x6003d1f0),
    .Y_MEM125 = @ptrFromInt(0x6003d1f4),
    .Y_MEM126 = @ptrFromInt(0x6003d1f8),
    .Y_MEM127 = @ptrFromInt(0x6003d1fc),
    .M_MEM0 = @ptrFromInt(0x6003d200),
    .M_MEM1 = @ptrFromInt(0x6003d204),
    .M_MEM2 = @ptrFromInt(0x6003d208),
    .M_MEM3 = @ptrFromInt(0x6003d20c),
    .M_MEM4 = @ptrFromInt(0x6003d210),
    .M_MEM5 = @ptrFromInt(0x6003d214),
    .M_MEM6 = @ptrFromInt(0x6003d218),
    .M_MEM7 = @ptrFromInt(0x6003d21c),
    .M_MEM8 = @ptrFromInt(0x6003d220),
    .M_MEM9 = @ptrFromInt(0x6003d224),
    .M_MEM10 = @ptrFromInt(0x6003d228),
    .M_MEM11 = @ptrFromInt(0x6003d22c),
    .M_MEM12 = @ptrFromInt(0x6003d230),
    .M_MEM13 = @ptrFromInt(0x6003d234),
    .M_MEM14 = @ptrFromInt(0x6003d238),
    .M_MEM15 = @ptrFromInt(0x6003d23c),
    .M_MEM16 = @ptrFromInt(0x6003d240),
    .M_MEM17 = @ptrFromInt(0x6003d244),
    .M_MEM18 = @ptrFromInt(0x6003d248),
    .M_MEM19 = @ptrFromInt(0x6003d24c),
    .M_MEM20 = @ptrFromInt(0x6003d250),
    .M_MEM21 = @ptrFromInt(0x6003d254),
    .M_MEM22 = @ptrFromInt(0x6003d258),
    .M_MEM23 = @ptrFromInt(0x6003d25c),
    .M_MEM24 = @ptrFromInt(0x6003d260),
    .M_MEM25 = @ptrFromInt(0x6003d264),
    .M_MEM26 = @ptrFromInt(0x6003d268),
    .M_MEM27 = @ptrFromInt(0x6003d26c),
    .M_MEM28 = @ptrFromInt(0x6003d270),
    .M_MEM29 = @ptrFromInt(0x6003d274),
    .M_MEM30 = @ptrFromInt(0x6003d278),
    .M_MEM31 = @ptrFromInt(0x6003d27c),
    .M_MEM32 = @ptrFromInt(0x6003d280),
    .M_MEM33 = @ptrFromInt(0x6003d284),
    .M_MEM34 = @ptrFromInt(0x6003d288),
    .M_MEM35 = @ptrFromInt(0x6003d28c),
    .M_MEM36 = @ptrFromInt(0x6003d290),
    .M_MEM37 = @ptrFromInt(0x6003d294),
    .M_MEM38 = @ptrFromInt(0x6003d298),
    .M_MEM39 = @ptrFromInt(0x6003d29c),
    .M_MEM40 = @ptrFromInt(0x6003d2a0),
    .M_MEM41 = @ptrFromInt(0x6003d2a4),
    .M_MEM42 = @ptrFromInt(0x6003d2a8),
    .M_MEM43 = @ptrFromInt(0x6003d2ac),
    .M_MEM44 = @ptrFromInt(0x6003d2b0),
    .M_MEM45 = @ptrFromInt(0x6003d2b4),
    .M_MEM46 = @ptrFromInt(0x6003d2b8),
    .M_MEM47 = @ptrFromInt(0x6003d2bc),
    .M_MEM48 = @ptrFromInt(0x6003d2c0),
    .M_MEM49 = @ptrFromInt(0x6003d2c4),
    .M_MEM50 = @ptrFromInt(0x6003d2c8),
    .M_MEM51 = @ptrFromInt(0x6003d2cc),
    .M_MEM52 = @ptrFromInt(0x6003d2d0),
    .M_MEM53 = @ptrFromInt(0x6003d2d4),
    .M_MEM54 = @ptrFromInt(0x6003d2d8),
    .M_MEM55 = @ptrFromInt(0x6003d2dc),
    .M_MEM56 = @ptrFromInt(0x6003d2e0),
    .M_MEM57 = @ptrFromInt(0x6003d2e4),
    .M_MEM58 = @ptrFromInt(0x6003d2e8),
    .M_MEM59 = @ptrFromInt(0x6003d2ec),
    .M_MEM60 = @ptrFromInt(0x6003d2f0),
    .M_MEM61 = @ptrFromInt(0x6003d2f4),
    .M_MEM62 = @ptrFromInt(0x6003d2f8),
    .M_MEM63 = @ptrFromInt(0x6003d2fc),
    .M_MEM64 = @ptrFromInt(0x6003d300),
    .M_MEM65 = @ptrFromInt(0x6003d304),
    .M_MEM66 = @ptrFromInt(0x6003d308),
    .M_MEM67 = @ptrFromInt(0x6003d30c),
    .M_MEM68 = @ptrFromInt(0x6003d310),
    .M_MEM69 = @ptrFromInt(0x6003d314),
    .M_MEM70 = @ptrFromInt(0x6003d318),
    .M_MEM71 = @ptrFromInt(0x6003d31c),
    .M_MEM72 = @ptrFromInt(0x6003d320),
    .M_MEM73 = @ptrFromInt(0x6003d324),
    .M_MEM74 = @ptrFromInt(0x6003d328),
    .M_MEM75 = @ptrFromInt(0x6003d32c),
    .M_MEM76 = @ptrFromInt(0x6003d330),
    .M_MEM77 = @ptrFromInt(0x6003d334),
    .M_MEM78 = @ptrFromInt(0x6003d338),
    .M_MEM79 = @ptrFromInt(0x6003d33c),
    .M_MEM80 = @ptrFromInt(0x6003d340),
    .M_MEM81 = @ptrFromInt(0x6003d344),
    .M_MEM82 = @ptrFromInt(0x6003d348),
    .M_MEM83 = @ptrFromInt(0x6003d34c),
    .M_MEM84 = @ptrFromInt(0x6003d350),
    .M_MEM85 = @ptrFromInt(0x6003d354),
    .M_MEM86 = @ptrFromInt(0x6003d358),
    .M_MEM87 = @ptrFromInt(0x6003d35c),
    .M_MEM88 = @ptrFromInt(0x6003d360),
    .M_MEM89 = @ptrFromInt(0x6003d364),
    .M_MEM90 = @ptrFromInt(0x6003d368),
    .M_MEM91 = @ptrFromInt(0x6003d36c),
    .M_MEM92 = @ptrFromInt(0x6003d370),
    .M_MEM93 = @ptrFromInt(0x6003d374),
    .M_MEM94 = @ptrFromInt(0x6003d378),
    .M_MEM95 = @ptrFromInt(0x6003d37c),
    .M_MEM96 = @ptrFromInt(0x6003d380),
    .M_MEM97 = @ptrFromInt(0x6003d384),
    .M_MEM98 = @ptrFromInt(0x6003d388),
    .M_MEM99 = @ptrFromInt(0x6003d38c),
    .M_MEM100 = @ptrFromInt(0x6003d390),
    .M_MEM101 = @ptrFromInt(0x6003d394),
    .M_MEM102 = @ptrFromInt(0x6003d398),
    .M_MEM103 = @ptrFromInt(0x6003d39c),
    .M_MEM104 = @ptrFromInt(0x6003d3a0),
    .M_MEM105 = @ptrFromInt(0x6003d3a4),
    .M_MEM106 = @ptrFromInt(0x6003d3a8),
    .M_MEM107 = @ptrFromInt(0x6003d3ac),
    .M_MEM108 = @ptrFromInt(0x6003d3b0),
    .M_MEM109 = @ptrFromInt(0x6003d3b4),
    .M_MEM110 = @ptrFromInt(0x6003d3b8),
    .M_MEM111 = @ptrFromInt(0x6003d3bc),
    .M_MEM112 = @ptrFromInt(0x6003d3c0),
    .M_MEM113 = @ptrFromInt(0x6003d3c4),
    .M_MEM114 = @ptrFromInt(0x6003d3c8),
    .M_MEM115 = @ptrFromInt(0x6003d3cc),
    .M_MEM116 = @ptrFromInt(0x6003d3d0),
    .M_MEM117 = @ptrFromInt(0x6003d3d4),
    .M_MEM118 = @ptrFromInt(0x6003d3d8),
    .M_MEM119 = @ptrFromInt(0x6003d3dc),
    .M_MEM120 = @ptrFromInt(0x6003d3e0),
    .M_MEM121 = @ptrFromInt(0x6003d3e4),
    .M_MEM122 = @ptrFromInt(0x6003d3e8),
    .M_MEM123 = @ptrFromInt(0x6003d3ec),
    .M_MEM124 = @ptrFromInt(0x6003d3f0),
    .M_MEM125 = @ptrFromInt(0x6003d3f4),
    .M_MEM126 = @ptrFromInt(0x6003d3f8),
    .M_MEM127 = @ptrFromInt(0x6003d3fc),
    .RB_MEM0 = @ptrFromInt(0x6003d400),
    .RB_MEM1 = @ptrFromInt(0x6003d404),
    .RB_MEM2 = @ptrFromInt(0x6003d408),
    .RB_MEM3 = @ptrFromInt(0x6003d40c),
    .RB_MEM4 = @ptrFromInt(0x6003d410),
    .RB_MEM5 = @ptrFromInt(0x6003d414),
    .RB_MEM6 = @ptrFromInt(0x6003d418),
    .RB_MEM7 = @ptrFromInt(0x6003d41c),
    .RB_MEM8 = @ptrFromInt(0x6003d420),
    .RB_MEM9 = @ptrFromInt(0x6003d424),
    .RB_MEM10 = @ptrFromInt(0x6003d428),
    .RB_MEM11 = @ptrFromInt(0x6003d42c),
    .RB_MEM12 = @ptrFromInt(0x6003d430),
    .RB_MEM13 = @ptrFromInt(0x6003d434),
    .RB_MEM14 = @ptrFromInt(0x6003d438),
    .RB_MEM15 = @ptrFromInt(0x6003d43c),
    .RB_MEM16 = @ptrFromInt(0x6003d440),
    .RB_MEM17 = @ptrFromInt(0x6003d444),
    .RB_MEM18 = @ptrFromInt(0x6003d448),
    .RB_MEM19 = @ptrFromInt(0x6003d44c),
    .RB_MEM20 = @ptrFromInt(0x6003d450),
    .RB_MEM21 = @ptrFromInt(0x6003d454),
    .RB_MEM22 = @ptrFromInt(0x6003d458),
    .RB_MEM23 = @ptrFromInt(0x6003d45c),
    .RB_MEM24 = @ptrFromInt(0x6003d460),
    .RB_MEM25 = @ptrFromInt(0x6003d464),
    .RB_MEM26 = @ptrFromInt(0x6003d468),
    .RB_MEM27 = @ptrFromInt(0x6003d46c),
    .RB_MEM28 = @ptrFromInt(0x6003d470),
    .RB_MEM29 = @ptrFromInt(0x6003d474),
    .RB_MEM30 = @ptrFromInt(0x6003d478),
    .RB_MEM31 = @ptrFromInt(0x6003d47c),
    .RB_MEM32 = @ptrFromInt(0x6003d480),
    .RB_MEM33 = @ptrFromInt(0x6003d484),
    .RB_MEM34 = @ptrFromInt(0x6003d488),
    .RB_MEM35 = @ptrFromInt(0x6003d48c),
    .RB_MEM36 = @ptrFromInt(0x6003d490),
    .RB_MEM37 = @ptrFromInt(0x6003d494),
    .RB_MEM38 = @ptrFromInt(0x6003d498),
    .RB_MEM39 = @ptrFromInt(0x6003d49c),
    .RB_MEM40 = @ptrFromInt(0x6003d4a0),
    .RB_MEM41 = @ptrFromInt(0x6003d4a4),
    .RB_MEM42 = @ptrFromInt(0x6003d4a8),
    .RB_MEM43 = @ptrFromInt(0x6003d4ac),
    .RB_MEM44 = @ptrFromInt(0x6003d4b0),
    .RB_MEM45 = @ptrFromInt(0x6003d4b4),
    .RB_MEM46 = @ptrFromInt(0x6003d4b8),
    .RB_MEM47 = @ptrFromInt(0x6003d4bc),
    .RB_MEM48 = @ptrFromInt(0x6003d4c0),
    .RB_MEM49 = @ptrFromInt(0x6003d4c4),
    .RB_MEM50 = @ptrFromInt(0x6003d4c8),
    .RB_MEM51 = @ptrFromInt(0x6003d4cc),
    .RB_MEM52 = @ptrFromInt(0x6003d4d0),
    .RB_MEM53 = @ptrFromInt(0x6003d4d4),
    .RB_MEM54 = @ptrFromInt(0x6003d4d8),
    .RB_MEM55 = @ptrFromInt(0x6003d4dc),
    .RB_MEM56 = @ptrFromInt(0x6003d4e0),
    .RB_MEM57 = @ptrFromInt(0x6003d4e4),
    .RB_MEM58 = @ptrFromInt(0x6003d4e8),
    .RB_MEM59 = @ptrFromInt(0x6003d4ec),
    .RB_MEM60 = @ptrFromInt(0x6003d4f0),
    .RB_MEM61 = @ptrFromInt(0x6003d4f4),
    .RB_MEM62 = @ptrFromInt(0x6003d4f8),
    .RB_MEM63 = @ptrFromInt(0x6003d4fc),
    .RB_MEM64 = @ptrFromInt(0x6003d500),
    .RB_MEM65 = @ptrFromInt(0x6003d504),
    .RB_MEM66 = @ptrFromInt(0x6003d508),
    .RB_MEM67 = @ptrFromInt(0x6003d50c),
    .RB_MEM68 = @ptrFromInt(0x6003d510),
    .RB_MEM69 = @ptrFromInt(0x6003d514),
    .RB_MEM70 = @ptrFromInt(0x6003d518),
    .RB_MEM71 = @ptrFromInt(0x6003d51c),
    .RB_MEM72 = @ptrFromInt(0x6003d520),
    .RB_MEM73 = @ptrFromInt(0x6003d524),
    .RB_MEM74 = @ptrFromInt(0x6003d528),
    .RB_MEM75 = @ptrFromInt(0x6003d52c),
    .RB_MEM76 = @ptrFromInt(0x6003d530),
    .RB_MEM77 = @ptrFromInt(0x6003d534),
    .RB_MEM78 = @ptrFromInt(0x6003d538),
    .RB_MEM79 = @ptrFromInt(0x6003d53c),
    .RB_MEM80 = @ptrFromInt(0x6003d540),
    .RB_MEM81 = @ptrFromInt(0x6003d544),
    .RB_MEM82 = @ptrFromInt(0x6003d548),
    .RB_MEM83 = @ptrFromInt(0x6003d54c),
    .RB_MEM84 = @ptrFromInt(0x6003d550),
    .RB_MEM85 = @ptrFromInt(0x6003d554),
    .RB_MEM86 = @ptrFromInt(0x6003d558),
    .RB_MEM87 = @ptrFromInt(0x6003d55c),
    .RB_MEM88 = @ptrFromInt(0x6003d560),
    .RB_MEM89 = @ptrFromInt(0x6003d564),
    .RB_MEM90 = @ptrFromInt(0x6003d568),
    .RB_MEM91 = @ptrFromInt(0x6003d56c),
    .RB_MEM92 = @ptrFromInt(0x6003d570),
    .RB_MEM93 = @ptrFromInt(0x6003d574),
    .RB_MEM94 = @ptrFromInt(0x6003d578),
    .RB_MEM95 = @ptrFromInt(0x6003d57c),
    .RB_MEM96 = @ptrFromInt(0x6003d580),
    .RB_MEM97 = @ptrFromInt(0x6003d584),
    .RB_MEM98 = @ptrFromInt(0x6003d588),
    .RB_MEM99 = @ptrFromInt(0x6003d58c),
    .RB_MEM100 = @ptrFromInt(0x6003d590),
    .RB_MEM101 = @ptrFromInt(0x6003d594),
    .RB_MEM102 = @ptrFromInt(0x6003d598),
    .RB_MEM103 = @ptrFromInt(0x6003d59c),
    .RB_MEM104 = @ptrFromInt(0x6003d5a0),
    .RB_MEM105 = @ptrFromInt(0x6003d5a4),
    .RB_MEM106 = @ptrFromInt(0x6003d5a8),
    .RB_MEM107 = @ptrFromInt(0x6003d5ac),
    .RB_MEM108 = @ptrFromInt(0x6003d5b0),
    .RB_MEM109 = @ptrFromInt(0x6003d5b4),
    .RB_MEM110 = @ptrFromInt(0x6003d5b8),
    .RB_MEM111 = @ptrFromInt(0x6003d5bc),
    .RB_MEM112 = @ptrFromInt(0x6003d5c0),
    .RB_MEM113 = @ptrFromInt(0x6003d5c4),
    .RB_MEM114 = @ptrFromInt(0x6003d5c8),
    .RB_MEM115 = @ptrFromInt(0x6003d5cc),
    .RB_MEM116 = @ptrFromInt(0x6003d5d0),
    .RB_MEM117 = @ptrFromInt(0x6003d5d4),
    .RB_MEM118 = @ptrFromInt(0x6003d5d8),
    .RB_MEM119 = @ptrFromInt(0x6003d5dc),
    .RB_MEM120 = @ptrFromInt(0x6003d5e0),
    .RB_MEM121 = @ptrFromInt(0x6003d5e4),
    .RB_MEM122 = @ptrFromInt(0x6003d5e8),
    .RB_MEM123 = @ptrFromInt(0x6003d5ec),
    .RB_MEM124 = @ptrFromInt(0x6003d5f0),
    .RB_MEM125 = @ptrFromInt(0x6003d5f4),
    .RB_MEM126 = @ptrFromInt(0x6003d5f8),
    .RB_MEM127 = @ptrFromInt(0x6003d5fc),
    .BOX_MEM0 = @ptrFromInt(0x6003d600),
    .BOX_MEM1 = @ptrFromInt(0x6003d604),
    .BOX_MEM2 = @ptrFromInt(0x6003d608),
    .BOX_MEM3 = @ptrFromInt(0x6003d60c),
    .BOX_MEM4 = @ptrFromInt(0x6003d610),
    .BOX_MEM5 = @ptrFromInt(0x6003d614),
    .BOX_MEM6 = @ptrFromInt(0x6003d618),
    .BOX_MEM7 = @ptrFromInt(0x6003d61c),
    .BOX_MEM8 = @ptrFromInt(0x6003d620),
    .BOX_MEM9 = @ptrFromInt(0x6003d624),
    .BOX_MEM10 = @ptrFromInt(0x6003d628),
    .BOX_MEM11 = @ptrFromInt(0x6003d62c),
    .X_MEM0 = @ptrFromInt(0x6003d800),
    .X_MEM1 = @ptrFromInt(0x6003d804),
    .X_MEM2 = @ptrFromInt(0x6003d808),
    .X_MEM3 = @ptrFromInt(0x6003d80c),
    .X_MEM4 = @ptrFromInt(0x6003d810),
    .X_MEM5 = @ptrFromInt(0x6003d814),
    .X_MEM6 = @ptrFromInt(0x6003d818),
    .X_MEM7 = @ptrFromInt(0x6003d81c),
    .X_MEM8 = @ptrFromInt(0x6003d820),
    .X_MEM9 = @ptrFromInt(0x6003d824),
    .X_MEM10 = @ptrFromInt(0x6003d828),
    .X_MEM11 = @ptrFromInt(0x6003d82c),
    .X_MEM12 = @ptrFromInt(0x6003d830),
    .X_MEM13 = @ptrFromInt(0x6003d834),
    .X_MEM14 = @ptrFromInt(0x6003d838),
    .X_MEM15 = @ptrFromInt(0x6003d83c),
    .X_MEM16 = @ptrFromInt(0x6003d840),
    .X_MEM17 = @ptrFromInt(0x6003d844),
    .X_MEM18 = @ptrFromInt(0x6003d848),
    .X_MEM19 = @ptrFromInt(0x6003d84c),
    .X_MEM20 = @ptrFromInt(0x6003d850),
    .X_MEM21 = @ptrFromInt(0x6003d854),
    .X_MEM22 = @ptrFromInt(0x6003d858),
    .X_MEM23 = @ptrFromInt(0x6003d85c),
    .X_MEM24 = @ptrFromInt(0x6003d860),
    .X_MEM25 = @ptrFromInt(0x6003d864),
    .X_MEM26 = @ptrFromInt(0x6003d868),
    .X_MEM27 = @ptrFromInt(0x6003d86c),
    .X_MEM28 = @ptrFromInt(0x6003d870),
    .X_MEM29 = @ptrFromInt(0x6003d874),
    .X_MEM30 = @ptrFromInt(0x6003d878),
    .X_MEM31 = @ptrFromInt(0x6003d87c),
    .X_MEM32 = @ptrFromInt(0x6003d880),
    .X_MEM33 = @ptrFromInt(0x6003d884),
    .X_MEM34 = @ptrFromInt(0x6003d888),
    .X_MEM35 = @ptrFromInt(0x6003d88c),
    .X_MEM36 = @ptrFromInt(0x6003d890),
    .X_MEM37 = @ptrFromInt(0x6003d894),
    .X_MEM38 = @ptrFromInt(0x6003d898),
    .X_MEM39 = @ptrFromInt(0x6003d89c),
    .X_MEM40 = @ptrFromInt(0x6003d8a0),
    .X_MEM41 = @ptrFromInt(0x6003d8a4),
    .X_MEM42 = @ptrFromInt(0x6003d8a8),
    .X_MEM43 = @ptrFromInt(0x6003d8ac),
    .X_MEM44 = @ptrFromInt(0x6003d8b0),
    .X_MEM45 = @ptrFromInt(0x6003d8b4),
    .X_MEM46 = @ptrFromInt(0x6003d8b8),
    .X_MEM47 = @ptrFromInt(0x6003d8bc),
    .X_MEM48 = @ptrFromInt(0x6003d8c0),
    .X_MEM49 = @ptrFromInt(0x6003d8c4),
    .X_MEM50 = @ptrFromInt(0x6003d8c8),
    .X_MEM51 = @ptrFromInt(0x6003d8cc),
    .X_MEM52 = @ptrFromInt(0x6003d8d0),
    .X_MEM53 = @ptrFromInt(0x6003d8d4),
    .X_MEM54 = @ptrFromInt(0x6003d8d8),
    .X_MEM55 = @ptrFromInt(0x6003d8dc),
    .X_MEM56 = @ptrFromInt(0x6003d8e0),
    .X_MEM57 = @ptrFromInt(0x6003d8e4),
    .X_MEM58 = @ptrFromInt(0x6003d8e8),
    .X_MEM59 = @ptrFromInt(0x6003d8ec),
    .X_MEM60 = @ptrFromInt(0x6003d8f0),
    .X_MEM61 = @ptrFromInt(0x6003d8f4),
    .X_MEM62 = @ptrFromInt(0x6003d8f8),
    .X_MEM63 = @ptrFromInt(0x6003d8fc),
    .X_MEM64 = @ptrFromInt(0x6003d900),
    .X_MEM65 = @ptrFromInt(0x6003d904),
    .X_MEM66 = @ptrFromInt(0x6003d908),
    .X_MEM67 = @ptrFromInt(0x6003d90c),
    .X_MEM68 = @ptrFromInt(0x6003d910),
    .X_MEM69 = @ptrFromInt(0x6003d914),
    .X_MEM70 = @ptrFromInt(0x6003d918),
    .X_MEM71 = @ptrFromInt(0x6003d91c),
    .X_MEM72 = @ptrFromInt(0x6003d920),
    .X_MEM73 = @ptrFromInt(0x6003d924),
    .X_MEM74 = @ptrFromInt(0x6003d928),
    .X_MEM75 = @ptrFromInt(0x6003d92c),
    .X_MEM76 = @ptrFromInt(0x6003d930),
    .X_MEM77 = @ptrFromInt(0x6003d934),
    .X_MEM78 = @ptrFromInt(0x6003d938),
    .X_MEM79 = @ptrFromInt(0x6003d93c),
    .X_MEM80 = @ptrFromInt(0x6003d940),
    .X_MEM81 = @ptrFromInt(0x6003d944),
    .X_MEM82 = @ptrFromInt(0x6003d948),
    .X_MEM83 = @ptrFromInt(0x6003d94c),
    .X_MEM84 = @ptrFromInt(0x6003d950),
    .X_MEM85 = @ptrFromInt(0x6003d954),
    .X_MEM86 = @ptrFromInt(0x6003d958),
    .X_MEM87 = @ptrFromInt(0x6003d95c),
    .X_MEM88 = @ptrFromInt(0x6003d960),
    .X_MEM89 = @ptrFromInt(0x6003d964),
    .X_MEM90 = @ptrFromInt(0x6003d968),
    .X_MEM91 = @ptrFromInt(0x6003d96c),
    .X_MEM92 = @ptrFromInt(0x6003d970),
    .X_MEM93 = @ptrFromInt(0x6003d974),
    .X_MEM94 = @ptrFromInt(0x6003d978),
    .X_MEM95 = @ptrFromInt(0x6003d97c),
    .X_MEM96 = @ptrFromInt(0x6003d980),
    .X_MEM97 = @ptrFromInt(0x6003d984),
    .X_MEM98 = @ptrFromInt(0x6003d988),
    .X_MEM99 = @ptrFromInt(0x6003d98c),
    .X_MEM100 = @ptrFromInt(0x6003d990),
    .X_MEM101 = @ptrFromInt(0x6003d994),
    .X_MEM102 = @ptrFromInt(0x6003d998),
    .X_MEM103 = @ptrFromInt(0x6003d99c),
    .X_MEM104 = @ptrFromInt(0x6003d9a0),
    .X_MEM105 = @ptrFromInt(0x6003d9a4),
    .X_MEM106 = @ptrFromInt(0x6003d9a8),
    .X_MEM107 = @ptrFromInt(0x6003d9ac),
    .X_MEM108 = @ptrFromInt(0x6003d9b0),
    .X_MEM109 = @ptrFromInt(0x6003d9b4),
    .X_MEM110 = @ptrFromInt(0x6003d9b8),
    .X_MEM111 = @ptrFromInt(0x6003d9bc),
    .X_MEM112 = @ptrFromInt(0x6003d9c0),
    .X_MEM113 = @ptrFromInt(0x6003d9c4),
    .X_MEM114 = @ptrFromInt(0x6003d9c8),
    .X_MEM115 = @ptrFromInt(0x6003d9cc),
    .X_MEM116 = @ptrFromInt(0x6003d9d0),
    .X_MEM117 = @ptrFromInt(0x6003d9d4),
    .X_MEM118 = @ptrFromInt(0x6003d9d8),
    .X_MEM119 = @ptrFromInt(0x6003d9dc),
    .X_MEM120 = @ptrFromInt(0x6003d9e0),
    .X_MEM121 = @ptrFromInt(0x6003d9e4),
    .X_MEM122 = @ptrFromInt(0x6003d9e8),
    .X_MEM123 = @ptrFromInt(0x6003d9ec),
    .X_MEM124 = @ptrFromInt(0x6003d9f0),
    .X_MEM125 = @ptrFromInt(0x6003d9f4),
    .X_MEM126 = @ptrFromInt(0x6003d9f8),
    .X_MEM127 = @ptrFromInt(0x6003d9fc),
    .Z_MEM0 = @ptrFromInt(0x6003da00),
    .Z_MEM1 = @ptrFromInt(0x6003da04),
    .Z_MEM2 = @ptrFromInt(0x6003da08),
    .Z_MEM3 = @ptrFromInt(0x6003da0c),
    .Z_MEM4 = @ptrFromInt(0x6003da10),
    .Z_MEM5 = @ptrFromInt(0x6003da14),
    .Z_MEM6 = @ptrFromInt(0x6003da18),
    .Z_MEM7 = @ptrFromInt(0x6003da1c),
    .Z_MEM8 = @ptrFromInt(0x6003da20),
    .Z_MEM9 = @ptrFromInt(0x6003da24),
    .Z_MEM10 = @ptrFromInt(0x6003da28),
    .Z_MEM11 = @ptrFromInt(0x6003da2c),
    .Z_MEM12 = @ptrFromInt(0x6003da30),
    .Z_MEM13 = @ptrFromInt(0x6003da34),
    .Z_MEM14 = @ptrFromInt(0x6003da38),
    .Z_MEM15 = @ptrFromInt(0x6003da3c),
    .Z_MEM16 = @ptrFromInt(0x6003da40),
    .Z_MEM17 = @ptrFromInt(0x6003da44),
    .Z_MEM18 = @ptrFromInt(0x6003da48),
    .Z_MEM19 = @ptrFromInt(0x6003da4c),
    .Z_MEM20 = @ptrFromInt(0x6003da50),
    .Z_MEM21 = @ptrFromInt(0x6003da54),
    .Z_MEM22 = @ptrFromInt(0x6003da58),
    .Z_MEM23 = @ptrFromInt(0x6003da5c),
    .Z_MEM24 = @ptrFromInt(0x6003da60),
    .Z_MEM25 = @ptrFromInt(0x6003da64),
    .Z_MEM26 = @ptrFromInt(0x6003da68),
    .Z_MEM27 = @ptrFromInt(0x6003da6c),
    .Z_MEM28 = @ptrFromInt(0x6003da70),
    .Z_MEM29 = @ptrFromInt(0x6003da74),
    .Z_MEM30 = @ptrFromInt(0x6003da78),
    .Z_MEM31 = @ptrFromInt(0x6003da7c),
    .Z_MEM32 = @ptrFromInt(0x6003da80),
    .Z_MEM33 = @ptrFromInt(0x6003da84),
    .Z_MEM34 = @ptrFromInt(0x6003da88),
    .Z_MEM35 = @ptrFromInt(0x6003da8c),
    .Z_MEM36 = @ptrFromInt(0x6003da90),
    .Z_MEM37 = @ptrFromInt(0x6003da94),
    .Z_MEM38 = @ptrFromInt(0x6003da98),
    .Z_MEM39 = @ptrFromInt(0x6003da9c),
    .Z_MEM40 = @ptrFromInt(0x6003daa0),
    .Z_MEM41 = @ptrFromInt(0x6003daa4),
    .Z_MEM42 = @ptrFromInt(0x6003daa8),
    .Z_MEM43 = @ptrFromInt(0x6003daac),
    .Z_MEM44 = @ptrFromInt(0x6003dab0),
    .Z_MEM45 = @ptrFromInt(0x6003dab4),
    .Z_MEM46 = @ptrFromInt(0x6003dab8),
    .Z_MEM47 = @ptrFromInt(0x6003dabc),
    .Z_MEM48 = @ptrFromInt(0x6003dac0),
    .Z_MEM49 = @ptrFromInt(0x6003dac4),
    .Z_MEM50 = @ptrFromInt(0x6003dac8),
    .Z_MEM51 = @ptrFromInt(0x6003dacc),
    .Z_MEM52 = @ptrFromInt(0x6003dad0),
    .Z_MEM53 = @ptrFromInt(0x6003dad4),
    .Z_MEM54 = @ptrFromInt(0x6003dad8),
    .Z_MEM55 = @ptrFromInt(0x6003dadc),
    .Z_MEM56 = @ptrFromInt(0x6003dae0),
    .Z_MEM57 = @ptrFromInt(0x6003dae4),
    .Z_MEM58 = @ptrFromInt(0x6003dae8),
    .Z_MEM59 = @ptrFromInt(0x6003daec),
    .Z_MEM60 = @ptrFromInt(0x6003daf0),
    .Z_MEM61 = @ptrFromInt(0x6003daf4),
    .Z_MEM62 = @ptrFromInt(0x6003daf8),
    .Z_MEM63 = @ptrFromInt(0x6003dafc),
    .Z_MEM64 = @ptrFromInt(0x6003db00),
    .Z_MEM65 = @ptrFromInt(0x6003db04),
    .Z_MEM66 = @ptrFromInt(0x6003db08),
    .Z_MEM67 = @ptrFromInt(0x6003db0c),
    .Z_MEM68 = @ptrFromInt(0x6003db10),
    .Z_MEM69 = @ptrFromInt(0x6003db14),
    .Z_MEM70 = @ptrFromInt(0x6003db18),
    .Z_MEM71 = @ptrFromInt(0x6003db1c),
    .Z_MEM72 = @ptrFromInt(0x6003db20),
    .Z_MEM73 = @ptrFromInt(0x6003db24),
    .Z_MEM74 = @ptrFromInt(0x6003db28),
    .Z_MEM75 = @ptrFromInt(0x6003db2c),
    .Z_MEM76 = @ptrFromInt(0x6003db30),
    .Z_MEM77 = @ptrFromInt(0x6003db34),
    .Z_MEM78 = @ptrFromInt(0x6003db38),
    .Z_MEM79 = @ptrFromInt(0x6003db3c),
    .Z_MEM80 = @ptrFromInt(0x6003db40),
    .Z_MEM81 = @ptrFromInt(0x6003db44),
    .Z_MEM82 = @ptrFromInt(0x6003db48),
    .Z_MEM83 = @ptrFromInt(0x6003db4c),
    .Z_MEM84 = @ptrFromInt(0x6003db50),
    .Z_MEM85 = @ptrFromInt(0x6003db54),
    .Z_MEM86 = @ptrFromInt(0x6003db58),
    .Z_MEM87 = @ptrFromInt(0x6003db5c),
    .Z_MEM88 = @ptrFromInt(0x6003db60),
    .Z_MEM89 = @ptrFromInt(0x6003db64),
    .Z_MEM90 = @ptrFromInt(0x6003db68),
    .Z_MEM91 = @ptrFromInt(0x6003db6c),
    .Z_MEM92 = @ptrFromInt(0x6003db70),
    .Z_MEM93 = @ptrFromInt(0x6003db74),
    .Z_MEM94 = @ptrFromInt(0x6003db78),
    .Z_MEM95 = @ptrFromInt(0x6003db7c),
    .Z_MEM96 = @ptrFromInt(0x6003db80),
    .Z_MEM97 = @ptrFromInt(0x6003db84),
    .Z_MEM98 = @ptrFromInt(0x6003db88),
    .Z_MEM99 = @ptrFromInt(0x6003db8c),
    .Z_MEM100 = @ptrFromInt(0x6003db90),
    .Z_MEM101 = @ptrFromInt(0x6003db94),
    .Z_MEM102 = @ptrFromInt(0x6003db98),
    .Z_MEM103 = @ptrFromInt(0x6003db9c),
    .Z_MEM104 = @ptrFromInt(0x6003dba0),
    .Z_MEM105 = @ptrFromInt(0x6003dba4),
    .Z_MEM106 = @ptrFromInt(0x6003dba8),
    .Z_MEM107 = @ptrFromInt(0x6003dbac),
    .Z_MEM108 = @ptrFromInt(0x6003dbb0),
    .Z_MEM109 = @ptrFromInt(0x6003dbb4),
    .Z_MEM110 = @ptrFromInt(0x6003dbb8),
    .Z_MEM111 = @ptrFromInt(0x6003dbbc),
    .Z_MEM112 = @ptrFromInt(0x6003dbc0),
    .Z_MEM113 = @ptrFromInt(0x6003dbc4),
    .Z_MEM114 = @ptrFromInt(0x6003dbc8),
    .Z_MEM115 = @ptrFromInt(0x6003dbcc),
    .Z_MEM116 = @ptrFromInt(0x6003dbd0),
    .Z_MEM117 = @ptrFromInt(0x6003dbd4),
    .Z_MEM118 = @ptrFromInt(0x6003dbd8),
    .Z_MEM119 = @ptrFromInt(0x6003dbdc),
    .Z_MEM120 = @ptrFromInt(0x6003dbe0),
    .Z_MEM121 = @ptrFromInt(0x6003dbe4),
    .Z_MEM122 = @ptrFromInt(0x6003dbe8),
    .Z_MEM123 = @ptrFromInt(0x6003dbec),
    .Z_MEM124 = @ptrFromInt(0x6003dbf0),
    .Z_MEM125 = @ptrFromInt(0x6003dbf4),
    .Z_MEM126 = @ptrFromInt(0x6003dbf8),
    .Z_MEM127 = @ptrFromInt(0x6003dbfc),
...
const EFUSE = struct {
    ...
    PGM_DATA0: *volatile EFUSE_PGM_DATA0,
    /// Register 1 that stores data to be programmed.
    PGM_DATA1: *volatile EFUSE_PGM_DATA1,
    /// Register 2 that stores data to be programmed.
    PGM_DATA2: *volatile EFUSE_PGM_DATA2,
    /// Register 3 that stores data to be programmed.
    PGM_DATA3: *volatile EFUSE_PGM_DATA3,
    /// Register 4 that stores data to be programmed.
    PGM_DATA4: *volatile EFUSE_PGM_DATA4,
    /// Register 5 that stores data to be programmed.
    PGM_DATA5: *volatile EFUSE_PGM_DATA5,
    /// Register 6 that stores data to be programmed.
    PGM_DATA6: *volatile EFUSE_PGM_DATA6,
    /// Register 7 that stores data to be programmed.
    PGM_DATA7: *volatile EFUSE_PGM_DATA7,
    /// Register 0 that stores the RS code to be programmed.
    PGM_CHECK_VALUE0: *volatile EFUSE_PGM_CHECK_VALUE0,
    /// Register 1 that stores the RS code to be programmed.
    PGM_CHECK_VALUE1: *volatile EFUSE_PGM_CHECK_VALUE1,
    /// Register 2 that stores the RS code to be programmed.
    PGM_CHECK_VALUE2: *volatile EFUSE_PGM_CHECK_VALUE2,
    /// BLOCK0 data register 0.
    RD_WR_DIS: *volatile EFUSE_RD_WR_DIS,
    /// BLOCK0 data register 1.
    RD_REPEAT_DATA0: *volatile EFUSE_RD_REPEAT_DATA0,
    /// BLOCK0 data register 2.
    RD_REPEAT_DATA1: *volatile EFUSE_RD_REPEAT_DATA1,
    /// BLOCK0 data register 3.
    RD_REPEAT_DATA2: *volatile EFUSE_RD_REPEAT_DATA2,
    /// BLOCK0 data register 4.
    RD_REPEAT_DATA3: *volatile EFUSE_RD_REPEAT_DATA3,
    /// BLOCK0 data register 5.
    RD_REPEAT_DATA4: *volatile EFUSE_RD_REPEAT_DATA4,
    /// BLOCK1 data register 0.
    RD_MAC_SPI_SYS_0: *volatile EFUSE_RD_MAC_SPI_SYS_0,
    /// BLOCK1 data register 1.
    RD_MAC_SPI_SYS_1: *volatile EFUSE_RD_MAC_SPI_SYS_1,
    /// BLOCK1 data register 2.
    RD_MAC_SPI_SYS_2: *volatile EFUSE_RD_MAC_SPI_SYS_2,
    /// BLOCK1 data register 3.
    RD_MAC_SPI_SYS_3: *volatile EFUSE_RD_MAC_SPI_SYS_3,
    /// BLOCK1 data register 4.
    RD_MAC_SPI_SYS_4: *volatile EFUSE_RD_MAC_SPI_SYS_4,
    /// BLOCK1 data register 5.
    RD_MAC_SPI_SYS_5: *volatile EFUSE_RD_MAC_SPI_SYS_5,
    /// Register 0 of BLOCK2 (system).
    RD_SYS_PART1_DATA0: *volatile EFUSE_RD_SYS_PART1_DATA0,
    /// Register 1 of BLOCK2 (system).
    RD_SYS_PART1_DATA1: *volatile EFUSE_RD_SYS_PART1_DATA1,
    /// Register 2 of BLOCK2 (system).
    RD_SYS_PART1_DATA2: *volatile EFUSE_RD_SYS_PART1_DATA2,
    /// Register 3 of BLOCK2 (system).
    RD_SYS_PART1_DATA3: *volatile EFUSE_RD_SYS_PART1_DATA3,
    /// Register 4 of BLOCK2 (system).
    RD_SYS_PART1_DATA4: *volatile EFUSE_RD_SYS_PART1_DATA4,
    /// Register 5 of BLOCK2 (system).
    RD_SYS_PART1_DATA5: *volatile EFUSE_RD_SYS_PART1_DATA5,
    /// Register 6 of BLOCK2 (system).
    RD_SYS_PART1_DATA6: *volatile EFUSE_RD_SYS_PART1_DATA6,
    /// Register 7 of BLOCK2 (system).
    RD_SYS_PART1_DATA7: *volatile EFUSE_RD_SYS_PART1_DATA7,
    /// Register 0 of BLOCK3 (user).
    RD_USR_DATA0: *volatile EFUSE_RD_USR_DATA0,
    /// Register 1 of BLOCK3 (user).
    RD_USR_DATA1: *volatile EFUSE_RD_USR_DATA1,
    /// Register 2 of BLOCK3 (user).
    RD_USR_DATA2: *volatile EFUSE_RD_USR_DATA2,
    /// Register 3 of BLOCK3 (user).
    RD_USR_DATA3: *volatile EFUSE_RD_USR_DATA3,
    /// Register 4 of BLOCK3 (user).
    RD_USR_DATA4: *volatile EFUSE_RD_USR_DATA4,
    /// Register 5 of BLOCK3 (user).
    RD_USR_DATA5: *volatile EFUSE_RD_USR_DATA5,
    /// Register 6 of BLOCK3 (user).
    RD_USR_DATA6: *volatile EFUSE_RD_USR_DATA6,
    /// Register 7 of BLOCK3 (user).
    RD_USR_DATA7: *volatile EFUSE_RD_USR_DATA7,
    /// Register 0 of BLOCK4 (KEY0).
    RD_KEY0_DATA0: *volatile EFUSE_RD_KEY0_DATA0,
    /// Register 1 of BLOCK4 (KEY0).
    RD_KEY0_DATA1: *volatile EFUSE_RD_KEY0_DATA1,
    /// Register 2 of BLOCK4 (KEY0).
    RD_KEY0_DATA2: *volatile EFUSE_RD_KEY0_DATA2,
    /// Register 3 of BLOCK4 (KEY0).
    RD_KEY0_DATA3: *volatile EFUSE_RD_KEY0_DATA3,
    /// Register 4 of BLOCK4 (KEY0).
    RD_KEY0_DATA4: *volatile EFUSE_RD_KEY0_DATA4,
    /// Register 5 of BLOCK4 (KEY0).
    RD_KEY0_DATA5: *volatile EFUSE_RD_KEY0_DATA5,
    /// Register 6 of BLOCK4 (KEY0).
    RD_KEY0_DATA6: *volatile EFUSE_RD_KEY0_DATA6,
    /// Register 7 of BLOCK4 (KEY0).
    RD_KEY0_DATA7: *volatile EFUSE_RD_KEY0_DATA7,
    /// Register 0 of BLOCK5 (KEY1).
    RD_KEY1_DATA0: *volatile EFUSE_RD_KEY1_DATA0,
    /// Register 1 of BLOCK5 (KEY1).
    RD_KEY1_DATA1: *volatile EFUSE_RD_KEY1_DATA1,
    /// Register 2 of BLOCK5 (KEY1).
    RD_KEY1_DATA2: *volatile EFUSE_RD_KEY1_DATA2,
    /// Register 3 of BLOCK5 (KEY1).
    RD_KEY1_DATA3: *volatile EFUSE_RD_KEY1_DATA3,
    /// Register 4 of BLOCK5 (KEY1).
    RD_KEY1_DATA4: *volatile EFUSE_RD_KEY1_DATA4,
    /// Register 5 of BLOCK5 (KEY1).
    RD_KEY1_DATA5: *volatile EFUSE_RD_KEY1_DATA5,
    /// Register 6 of BLOCK5 (KEY1).
    RD_KEY1_DATA6: *volatile EFUSE_RD_KEY1_DATA6,
    /// Register 7 of BLOCK5 (KEY1).
    RD_KEY1_DATA7: *volatile EFUSE_RD_KEY1_DATA7,
    /// Register 0 of BLOCK6 (KEY2).
    RD_KEY2_DATA0: *volatile EFUSE_RD_KEY2_DATA0,
    /// Register 1 of BLOCK6 (KEY2).
    RD_KEY2_DATA1: *volatile EFUSE_RD_KEY2_DATA1,
    /// Register 2 of BLOCK6 (KEY2).
    RD_KEY2_DATA2: *volatile EFUSE_RD_KEY2_DATA2,
    /// Register 3 of BLOCK6 (KEY2).
    RD_KEY2_DATA3: *volatile EFUSE_RD_KEY2_DATA3,
    /// Register 4 of BLOCK6 (KEY2).
    RD_KEY2_DATA4: *volatile EFUSE_RD_KEY2_DATA4,
    /// Register 5 of BLOCK6 (KEY2).
    RD_KEY2_DATA5: *volatile EFUSE_RD_KEY2_DATA5,
    /// Register 6 of BLOCK6 (KEY2).
    RD_KEY2_DATA6: *volatile EFUSE_RD_KEY2_DATA6,
    /// Register 7 of BLOCK6 (KEY2).
    RD_KEY2_DATA7: *volatile EFUSE_RD_KEY2_DATA7,
    /// Register 0 of BLOCK7 (KEY3).
    RD_KEY3_DATA0: *volatile EFUSE_RD_KEY3_DATA0,
    /// Register 1 of BLOCK7 (KEY3).
    RD_KEY3_DATA1: *volatile EFUSE_RD_KEY3_DATA1,
    /// Register 2 of BLOCK7 (KEY3).
    RD_KEY3_DATA2: *volatile EFUSE_RD_KEY3_DATA2,
    /// Register 3 of BLOCK7 (KEY3).
    RD_KEY3_DATA3: *volatile EFUSE_RD_KEY3_DATA3,
    /// Register 4 of BLOCK7 (KEY3).
    RD_KEY3_DATA4: *volatile EFUSE_RD_KEY3_DATA4,
    /// Register 5 of BLOCK7 (KEY3).
    RD_KEY3_DATA5: *volatile EFUSE_RD_KEY3_DATA5,
    /// Register 6 of BLOCK7 (KEY3).
    RD_KEY3_DATA6: *volatile EFUSE_RD_KEY3_DATA6,
    /// Register 7 of BLOCK7 (KEY3).
    RD_KEY3_DATA7: *volatile EFUSE_RD_KEY3_DATA7,
    /// Register 0 of BLOCK8 (KEY4).
    RD_KEY4_DATA0: *volatile EFUSE_RD_KEY4_DATA0,
    /// Register 1 of BLOCK8 (KEY4).
    RD_KEY4_DATA1: *volatile EFUSE_RD_KEY4_DATA1,
    /// Register 2 of BLOCK8 (KEY4).
    RD_KEY4_DATA2: *volatile EFUSE_RD_KEY4_DATA2,
    /// Register 3 of BLOCK8 (KEY4).
    RD_KEY4_DATA3: *volatile EFUSE_RD_KEY4_DATA3,
    /// Register 4 of BLOCK8 (KEY4).
    RD_KEY4_DATA4: *volatile EFUSE_RD_KEY4_DATA4,
    /// Register 5 of BLOCK8 (KEY4).
    RD_KEY4_DATA5: *volatile EFUSE_RD_KEY4_DATA5,
    /// Register 6 of BLOCK8 (KEY4).
    RD_KEY4_DATA6: *volatile EFUSE_RD_KEY4_DATA6,
    /// Register 7 of BLOCK8 (KEY4).
    RD_KEY4_DATA7: *volatile EFUSE_RD_KEY4_DATA7,
    /// Register 0 of BLOCK9 (KEY5).
    RD_KEY5_DATA0: *volatile EFUSE_RD_KEY5_DATA0,
    /// Register 1 of BLOCK9 (KEY5).
    RD_KEY5_DATA1: *volatile EFUSE_RD_KEY5_DATA1,
    /// Register 2 of BLOCK9 (KEY5).
    RD_KEY5_DATA2: *volatile EFUSE_RD_KEY5_DATA2,
    /// Register 3 of BLOCK9 (KEY5).
    RD_KEY5_DATA3: *volatile EFUSE_RD_KEY5_DATA3,
    /// Register 4 of BLOCK9 (KEY5).
    RD_KEY5_DATA4: *volatile EFUSE_RD_KEY5_DATA4,
    /// Register 5 of BLOCK9 (KEY5).
    RD_KEY5_DATA5: *volatile EFUSE_RD_KEY5_DATA5,
    /// Register 6 of BLOCK9 (KEY5).
    RD_KEY5_DATA6: *volatile EFUSE_RD_KEY5_DATA6,
    /// Register 7 of BLOCK9 (KEY5).
    RD_KEY5_DATA7: *volatile EFUSE_RD_KEY5_DATA7,
    /// Register 0 of BLOCK10 (system).
    RD_SYS_PART2_DATA0: *volatile EFUSE_RD_SYS_PART2_DATA0,
    /// Register 1 of BLOCK9 (KEY5).
    RD_SYS_PART2_DATA1: *volatile EFUSE_RD_SYS_PART2_DATA1,
    /// Register 2 of BLOCK10 (system).
    RD_SYS_PART2_DATA2: *volatile EFUSE_RD_SYS_PART2_DATA2,
    /// Register 3 of BLOCK10 (system).
    RD_SYS_PART2_DATA3: *volatile EFUSE_RD_SYS_PART2_DATA3,
    /// Register 4 of BLOCK10 (system).
    RD_SYS_PART2_DATA4: *volatile EFUSE_RD_SYS_PART2_DATA4,
    /// Register 5 of BLOCK10 (system).
    RD_SYS_PART2_DATA5: *volatile EFUSE_RD_SYS_PART2_DATA5,
    /// Register 6 of BLOCK10 (system).
    RD_SYS_PART2_DATA6: *volatile EFUSE_RD_SYS_PART2_DATA6,
    /// Register 7 of BLOCK10 (system).
    RD_SYS_PART2_DATA7: *volatile EFUSE_RD_SYS_PART2_DATA7,
    /// Programming error record register 0 of BLOCK0.
    RD_REPEAT_ERR0: *volatile EFUSE_RD_REPEAT_ERR0,
    /// Programming error record register 1 of BLOCK0.
    RD_REPEAT_ERR1: *volatile EFUSE_RD_REPEAT_ERR1,
    /// Programming error record register 2 of BLOCK0.
    RD_REPEAT_ERR2: *volatile EFUSE_RD_REPEAT_ERR2,
    /// Programming error record register 3 of BLOCK0.
    RD_REPEAT_ERR3: *volatile EFUSE_RD_REPEAT_ERR3,
    /// Programming error record register 4 of BLOCK0.
    RD_REPEAT_ERR4: *volatile EFUSE_RD_REPEAT_ERR4,
    /// Programming error record register 0 of BLOCK1-10.
    RD_RS_ERR0: *volatile EFUSE_RD_RS_ERR0,
    /// Programming error record register 1 of BLOCK1-10.
    RD_RS_ERR1: *volatile EFUSE_RD_RS_ERR1,
    /// eFuse clock configuration register.
    CLK: *volatile EFUSE_CLK,
    /// eFuse operation mode configuration register.
    CONF: *volatile EFUSE_CONF,
    /// eFuse status register.
    STATUS: *volatile EFUSE_STATUS,
    /// eFuse command register.
    CMD: *volatile EFUSE_CMD,
    /// eFuse raw interrupt register.
    INT_RAW: *volatile EFUSE_INT_RAW,
    /// eFuse interrupt status register.
    INT_ST: *volatile EFUSE_INT_ST,
    /// eFuse interrupt enable register.
    INT_ENA: *volatile EFUSE_INT_ENA,
    /// eFuse interrupt clear register.
    INT_CLR: *volatile EFUSE_INT_CLR,
    /// Controls the eFuse programming voltage.
    DAC_CONF: *volatile EFUSE_DAC_CONF,
    /// Configures read timing parameters.
    RD_TIM_CONF: *volatile EFUSE_RD_TIM_CONF,
    /// Configuration register 1 of eFuse programming timing parameters.
    WR_TIM_CONF1: *volatile EFUSE_WR_TIM_CONF1,
    /// Configuration register 2 of eFuse programming timing parameters.
    WR_TIM_CONF2: *volatile EFUSE_WR_TIM_CONF2,
    /// eFuse version register.
    DATE: *volatile EFUSE_DATE,
};
...
const EXTMEM = struct {
    ...
    ICACHE_CTRL: *volatile EXTMEM_ICACHE_CTRL,
    /// This description will be updated in the near future.
    ICACHE_CTRL1: *volatile EXTMEM_ICACHE_CTRL1,
    /// This description will be updated in the near future.
    ICACHE_TAG_POWER_CTRL: *volatile EXTMEM_ICACHE_TAG_POWER_CTRL,
    /// This description will be updated in the near future.
    ICACHE_PRELOCK_CTRL: *volatile EXTMEM_ICACHE_PRELOCK_CTRL,
    /// This description will be updated in the near future.
    ICACHE_PRELOCK_SCT0_ADDR: *volatile EXTMEM_ICACHE_PRELOCK_SCT0_ADDR,
    /// This description will be updated in the near future.
    ICACHE_PRELOCK_SCT1_ADDR: *volatile EXTMEM_ICACHE_PRELOCK_SCT1_ADDR,
    /// This description will be updated in the near future.
    ICACHE_PRELOCK_SCT_SIZE: *volatile EXTMEM_ICACHE_PRELOCK_SCT_SIZE,
    /// This description will be updated in the near future.
    ICACHE_LOCK_CTRL: *volatile EXTMEM_ICACHE_LOCK_CTRL,
    /// This description will be updated in the near future.
    ICACHE_LOCK_ADDR: *volatile EXTMEM_ICACHE_LOCK_ADDR,
    /// This description will be updated in the near future.
    ICACHE_LOCK_SIZE: *volatile EXTMEM_ICACHE_LOCK_SIZE,
    /// This description will be updated in the near future.
    ICACHE_SYNC_CTRL: *volatile EXTMEM_ICACHE_SYNC_CTRL,
    /// This description will be updated in the near future.
    ICACHE_SYNC_ADDR: *volatile EXTMEM_ICACHE_SYNC_ADDR,
    /// This description will be updated in the near future.
    ICACHE_SYNC_SIZE: *volatile EXTMEM_ICACHE_SYNC_SIZE,
    /// This description will be updated in the near future.
    ICACHE_PRELOAD_CTRL: *volatile EXTMEM_ICACHE_PRELOAD_CTRL,
    /// This description will be updated in the near future.
    ICACHE_PRELOAD_ADDR: *volatile EXTMEM_ICACHE_PRELOAD_ADDR,
    /// This description will be updated in the near future.
    ICACHE_PRELOAD_SIZE: *volatile EXTMEM_ICACHE_PRELOAD_SIZE,
    /// This description will be updated in the near future.
    ICACHE_AUTOLOAD_CTRL: *volatile EXTMEM_ICACHE_AUTOLOAD_CTRL,
    /// This description will be updated in the near future.
    ICACHE_AUTOLOAD_SCT0_ADDR: *volatile EXTMEM_ICACHE_AUTOLOAD_SCT0_ADDR,
    /// This description will be updated in the near future.
    ICACHE_AUTOLOAD_SCT0_SIZE: *volatile EXTMEM_ICACHE_AUTOLOAD_SCT0_SIZE,
    /// This description will be updated in the near future.
    ICACHE_AUTOLOAD_SCT1_ADDR: *volatile EXTMEM_ICACHE_AUTOLOAD_SCT1_ADDR,
    /// This description will be updated in the near future.
    ICACHE_AUTOLOAD_SCT1_SIZE: *volatile EXTMEM_ICACHE_AUTOLOAD_SCT1_SIZE,
    /// This description will be updated in the near future.
    IBUS_TO_FLASH_START_VADDR: *volatile EXTMEM_IBUS_TO_FLASH_START_VADDR,
    /// This description will be updated in the near future.
    IBUS_TO_FLASH_END_VADDR: *volatile EXTMEM_IBUS_TO_FLASH_END_VADDR,
    /// This description will be updated in the near future.
    DBUS_TO_FLASH_START_VADDR: *volatile EXTMEM_DBUS_TO_FLASH_START_VADDR,
    /// This description will be updated in the near future.
    DBUS_TO_FLASH_END_VADDR: *volatile EXTMEM_DBUS_TO_FLASH_END_VADDR,
    /// This description will be updated in the near future.
    CACHE_ACS_CNT_CLR: *volatile EXTMEM_CACHE_ACS_CNT_CLR,
    /// This description will be updated in the near future.
    IBUS_ACS_MISS_CNT: *volatile EXTMEM_IBUS_ACS_MISS_CNT,
    /// This description will be updated in the near future.
    IBUS_ACS_CNT: *volatile EXTMEM_IBUS_ACS_CNT,
    /// This description will be updated in the near future.
    DBUS_ACS_FLASH_MISS_CNT: *volatile EXTMEM_DBUS_ACS_FLASH_MISS_CNT,
    /// This description will be updated in the near future.
    DBUS_ACS_CNT: *volatile EXTMEM_DBUS_ACS_CNT,
    /// This description will be updated in the near future.
    CACHE_ILG_INT_ENA: *volatile EXTMEM_CACHE_ILG_INT_ENA,
    /// This description will be updated in the near future.
    CACHE_ILG_INT_CLR: *volatile EXTMEM_CACHE_ILG_INT_CLR,
    /// This description will be updated in the near future.
    CACHE_ILG_INT_ST: *volatile EXTMEM_CACHE_ILG_INT_ST,
    /// This description will be updated in the near future.
    CORE0_ACS_CACHE_INT_ENA: *volatile EXTMEM_CORE0_ACS_CACHE_INT_ENA,
    /// This description will be updated in the near future.
    CORE0_ACS_CACHE_INT_CLR: *volatile EXTMEM_CORE0_ACS_CACHE_INT_CLR,
    /// This description will be updated in the near future.
    CORE0_ACS_CACHE_INT_ST: *volatile EXTMEM_CORE0_ACS_CACHE_INT_ST,
    /// This description will be updated in the near future.
    CORE0_DBUS_REJECT_ST: *volatile EXTMEM_CORE0_DBUS_REJECT_ST,
    /// This description will be updated in the near future.
    CORE0_DBUS_REJECT_VADDR: *volatile EXTMEM_CORE0_DBUS_REJECT_VADDR,
    /// This description will be updated in the near future.
    CORE0_IBUS_REJECT_ST: *volatile EXTMEM_CORE0_IBUS_REJECT_ST,
    /// This description will be updated in the near future.
    CORE0_IBUS_REJECT_VADDR: *volatile EXTMEM_CORE0_IBUS_REJECT_VADDR,
    /// This description will be updated in the near future.
    CACHE_MMU_FAULT_CONTENT: *volatile EXTMEM_CACHE_MMU_FAULT_CONTENT,
    /// This description will be updated in the near future.
    CACHE_MMU_FAULT_VADDR: *volatile EXTMEM_CACHE_MMU_FAULT_VADDR,
    /// This description will be updated in the near future.
    CACHE_WRAP_AROUND_CTRL: *volatile EXTMEM_CACHE_WRAP_AROUND_CTRL,
    /// This description will be updated in the near future.
    CACHE_MMU_POWER_CTRL: *volatile EXTMEM_CACHE_MMU_POWER_CTRL,
    /// This description will be updated in the near future.
    CACHE_STATE: *volatile EXTMEM_CACHE_STATE,
    /// This description will be updated in the near future.
    CACHE_ENCRYPT_DECRYPT_RECORD_DISABLE: *volatile EXTMEM_CACHE_ENCRYPT_DECRYPT_RECORD_DISABLE,
    /// This description will be updated in the near future.
    CACHE_ENCRYPT_DECRYPT_CLK_FORCE_ON: *volatile EXTMEM_CACHE_ENCRYPT_DECRYPT_CLK_FORCE_ON,
    /// This description will be updated in the near future.
    CACHE_PRELOAD_INT_CTRL: *volatile EXTMEM_CACHE_PRELOAD_INT_CTRL,
    /// This description will be updated in the near future.
    CACHE_SYNC_INT_CTRL: *volatile EXTMEM_CACHE_SYNC_INT_CTRL,
    /// This description will be updated in the near future.
    CACHE_MMU_OWNER: *volatile EXTMEM_CACHE_MMU_OWNER,
    /// This description will be updated in the near future.
    CACHE_CONF_MISC: *volatile EXTMEM_CACHE_CONF_MISC,
    /// This description will be updated in the near future.
    ICACHE_FREEZE: *volatile EXTMEM_ICACHE_FREEZE,
    /// This description will be updated in the near future.
    ICACHE_ATOMIC_OPERATE_ENA: *volatile EXTMEM_ICACHE_ATOMIC_OPERATE_ENA,
    /// This description will be updated in the near future.
    CACHE_REQUEST: *volatile EXTMEM_CACHE_REQUEST,
    /// This description will be updated in the near future.
    IBUS_PMS_TBL_LOCK: *volatile EXTMEM_IBUS_PMS_TBL_LOCK,
    /// This description will be updated in the near future.
    IBUS_PMS_TBL_BOUNDARY0: *volatile EXTMEM_IBUS_PMS_TBL_BOUNDARY0,
    /// This description will be updated in the near future.
    IBUS_PMS_TBL_BOUNDARY1: *volatile EXTMEM_IBUS_PMS_TBL_BOUNDARY1,
    /// This description will be updated in the near future.
    IBUS_PMS_TBL_BOUNDARY2: *volatile EXTMEM_IBUS_PMS_TBL_BOUNDARY2,
    /// This description will be updated in the near future.
    IBUS_PMS_TBL_ATTR: *volatile EXTMEM_IBUS_PMS_TBL_ATTR,
    /// This description will be updated in the near future.
    DBUS_PMS_TBL_LOCK: *volatile EXTMEM_DBUS_PMS_TBL_LOCK,
    /// This description will be updated in the near future.
    DBUS_PMS_TBL_BOUNDARY0: *volatile EXTMEM_DBUS_PMS_TBL_BOUNDARY0,
    /// This description will be updated in the near future.
    DBUS_PMS_TBL_BOUNDARY1: *volatile EXTMEM_DBUS_PMS_TBL_BOUNDARY1,
    /// This description will be updated in the near future.
    DBUS_PMS_TBL_BOUNDARY2: *volatile EXTMEM_DBUS_PMS_TBL_BOUNDARY2,
    /// This description will be updated in the near future.
    DBUS_PMS_TBL_ATTR: *volatile EXTMEM_DBUS_PMS_TBL_ATTR,
    /// This description will be updated in the near future.
    CLOCK_GATE: *volatile EXTMEM_CLOCK_GATE,
    /// This description will be updated in the near future.
    REG_DATE: *volatile EXTMEM_REG_DATE,
};
...
const GPIO = struct {
    /// GPIO bit select register
    BT_SELECT: *volatile GPIO_BT_SELECT,
    /// GPIO output register
    OUT: *volatile GPIO_OUT,
    /// GPIO output set register
    OUT_W1TS: *volatile GPIO_OUT_W1TS,
    /// GPIO output clear register
    OUT_W1TC: *volatile GPIO_OUT_W1TC,
    /// GPIO sdio select register
    SDIO_SELECT: *volatile GPIO_SDIO_SELECT,
    /// GPIO output enable register
    ENABLE: *volatile GPIO_ENABLE,
    /// GPIO output enable set register
    ENABLE_W1TS: *volatile GPIO_ENABLE_W1TS,
    /// GPIO output enable clear register
    ENABLE_W1TC: *volatile GPIO_ENABLE_W1TC,
    /// pad strapping register
    STRAP: *volatile GPIO_STRAP,
    /// GPIO input register
    IN: *volatile GPIO_IN,
    /// GPIO interrupt status register
    STATUS: *volatile GPIO_STATUS,
    /// GPIO interrupt status set register
    STATUS_W1TS: *volatile GPIO_STATUS_W1TS,
    /// GPIO interrupt status clear register
    STATUS_W1TC: *volatile GPIO_STATUS_W1TC,
    /// GPIO PRO_CPU interrupt status register
    PCPU_INT: *volatile GPIO_PCPU_INT,
    /// GPIO PRO_CPU(not shielded) interrupt status register
    PCPU_NMI_INT: *volatile GPIO_PCPU_NMI_INT,
    /// GPIO CPUSDIO interrupt status register
    CPUSDIO_INT: *volatile GPIO_CPUSDIO_INT,
    /// GPIO pin configuration register
    PIN0: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN1: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN2: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN3: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN4: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN5: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN6: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN7: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN8: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN9: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN10: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN11: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN12: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN13: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN14: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN15: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN16: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN17: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN18: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN19: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN20: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN21: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN22: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN23: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN24: *volatile GPIO_PINN,
    /// GPIO pin configuration register
    PIN25: *volatile GPIO_PINN,
    /// GPIO interrupt source register
    STATUS_NEXT: *volatile GPIO_STATUS_NEXT,
    /// GPIO input function configuration register
    FUNC0_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC1_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC2_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC3_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC4_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC5_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC6_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC7_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC8_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC9_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC10_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC11_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC12_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC13_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC14_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC15_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC16_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC17_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC18_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC19_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC20_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC21_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC22_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC23_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC24_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC25_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC26_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC27_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC28_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC29_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC30_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC31_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC32_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC33_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC34_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC35_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC36_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC37_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC38_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC39_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC40_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC41_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC42_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC43_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC44_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC45_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC46_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC47_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC48_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC49_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC50_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC51_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC52_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC53_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC54_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC55_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC56_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC57_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC58_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC59_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC60_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC61_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC62_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC63_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC64_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC65_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC66_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC67_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC68_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC69_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC70_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC71_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC72_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC73_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC74_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC75_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC76_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC77_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC78_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC79_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC80_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC81_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC82_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC83_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC84_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC85_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC86_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC87_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC88_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC89_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC90_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC91_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC92_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC93_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC94_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC95_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC96_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC97_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC98_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC99_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC100_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC101_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC102_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC103_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC104_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC105_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC106_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC107_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC108_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC109_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC110_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC111_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC112_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC113_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC114_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC115_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC116_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC117_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC118_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC119_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC120_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC121_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC122_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC123_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC124_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC125_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC126_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO input function configuration register
    FUNC127_IN_SEL_CFG: *volatile GPIO_FUNCN_IN_SEL_CFG,
    /// GPIO output function select register
    FUNC0_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC1_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC2_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC3_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC4_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC5_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC6_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC7_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC8_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC9_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC10_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC11_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC12_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC13_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC14_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC15_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC16_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC17_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC18_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC19_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC20_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC21_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC22_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC23_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC24_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO output function select register
    FUNC25_OUT_SEL_CFG: *volatile GPIO_FUNCN_OUT_SEL_CFG,
    /// GPIO clock gate register
    CLOCK_GATE: *volatile GPIO_CLOCK_GATE,
    /// GPIO version register
    REG_DATE: *volatile GPIO_REG_DATE,
};
...
const GPIO_instance = GPIO{
    ...
    .PIN1 = @ptrFromInt(0x60004078),
    .PIN2 = @ptrFromInt(0x6000407c),
    .PIN3 = @ptrFromInt(0x60004080),
    .PIN4 = @ptrFromInt(0x60004084),
    .PIN5 = @ptrFromInt(0x60004088),
    .PIN6 = @ptrFromInt(0x6000408c),
    .PIN7 = @ptrFromInt(0x60004090),
    .PIN8 = @ptrFromInt(0x60004094),
    .PIN9 = @ptrFromInt(0x60004098),
    .PIN10 = @ptrFromInt(0x6000409c),
    .PIN11 = @ptrFromInt(0x600040a0),
    .PIN12 = @ptrFromInt(0x600040a4),
    .PIN13 = @ptrFromInt(0x600040a8),
    .PIN14 = @ptrFromInt(0x600040ac),
    .PIN15 = @ptrFromInt(0x600040b0),
    .PIN16 = @ptrFromInt(0x600040b4),
    .PIN17 = @ptrFromInt(0x600040b8),
    .PIN18 = @ptrFromInt(0x600040bc),
    .PIN19 = @ptrFromInt(0x600040c0),
    .PIN20 = @ptrFromInt(0x600040c4),
    .PIN21 = @ptrFromInt(0x600040c8),
    .PIN22 = @ptrFromInt(0x600040cc),
    .PIN23 = @ptrFromInt(0x600040d0),
    .PIN24 = @ptrFromInt(0x600040d4),
    .PIN25 = @ptrFromInt(0x600040d8),
    .STATUS_NEXT = @ptrFromInt(0x6000414c),
    .FUNC0_IN_SEL_CFG = @ptrFromInt(0x60004154),
    .FUNC1_IN_SEL_CFG = @ptrFromInt(0x60004158),
    .FUNC2_IN_SEL_CFG = @ptrFromInt(0x6000415c),
    .FUNC3_IN_SEL_CFG = @ptrFromInt(0x60004160),
    .FUNC4_IN_SEL_CFG = @ptrFromInt(0x60004164),
    .FUNC5_IN_SEL_CFG = @ptrFromInt(0x60004168),
    .FUNC6_IN_SEL_CFG = @ptrFromInt(0x6000416c),
    .FUNC7_IN_SEL_CFG = @ptrFromInt(0x60004170),
    .FUNC8_IN_SEL_CFG = @ptrFromInt(0x60004174),
    .FUNC9_IN_SEL_CFG = @ptrFromInt(0x60004178),
    .FUNC10_IN_SEL_CFG = @ptrFromInt(0x6000417c),
    .FUNC11_IN_SEL_CFG = @ptrFromInt(0x60004180),
    .FUNC12_IN_SEL_CFG = @ptrFromInt(0x60004184),
    .FUNC13_IN_SEL_CFG = @ptrFromInt(0x60004188),
    .FUNC14_IN_SEL_CFG = @ptrFromInt(0x6000418c),
    .FUNC15_IN_SEL_CFG = @ptrFromInt(0x60004190),
    .FUNC16_IN_SEL_CFG = @ptrFromInt(0x60004194),
    .FUNC17_IN_SEL_CFG = @ptrFromInt(0x60004198),
    .FUNC18_IN_SEL_CFG = @ptrFromInt(0x6000419c),
    .FUNC19_IN_SEL_CFG = @ptrFromInt(0x600041a0),
    .FUNC20_IN_SEL_CFG = @ptrFromInt(0x600041a4),
    .FUNC21_IN_SEL_CFG = @ptrFromInt(0x600041a8),
    .FUNC22_IN_SEL_CFG = @ptrFromInt(0x600041ac),
    .FUNC23_IN_SEL_CFG = @ptrFromInt(0x600041b0),
    .FUNC24_IN_SEL_CFG = @ptrFromInt(0x600041b4),
    .FUNC25_IN_SEL_CFG = @ptrFromInt(0x600041b8),
    .FUNC26_IN_SEL_CFG = @ptrFromInt(0x600041bc),
    .FUNC27_IN_SEL_CFG = @ptrFromInt(0x600041c0),
    .FUNC28_IN_SEL_CFG = @ptrFromInt(0x600041c4),
    .FUNC29_IN_SEL_CFG = @ptrFromInt(0x600041c8),
    .FUNC30_IN_SEL_CFG = @ptrFromInt(0x600041cc),
    .FUNC31_IN_SEL_CFG = @ptrFromInt(0x600041d0),
    .FUNC32_IN_SEL_CFG = @ptrFromInt(0x600041d4),
    .FUNC33_IN_SEL_CFG = @ptrFromInt(0x600041d8),
    .FUNC34_IN_SEL_CFG = @ptrFromInt(0x600041dc),
    .FUNC35_IN_SEL_CFG = @ptrFromInt(0x600041e0),
    .FUNC36_IN_SEL_CFG = @ptrFromInt(0x600041e4),
    .FUNC37_IN_SEL_CFG = @ptrFromInt(0x600041e8),
    .FUNC38_IN_SEL_CFG = @ptrFromInt(0x600041ec),
    .FUNC39_IN_SEL_CFG = @ptrFromInt(0x600041f0),
    .FUNC40_IN_SEL_CFG = @ptrFromInt(0x600041f4),
    .FUNC41_IN_SEL_CFG = @ptrFromInt(0x600041f8),
    .FUNC42_IN_SEL_CFG = @ptrFromInt(0x600041fc),
    .FUNC43_IN_SEL_CFG = @ptrFromInt(0x60004200),
    .FUNC44_IN_SEL_CFG = @ptrFromInt(0x60004204),
    .FUNC45_IN_SEL_CFG = @ptrFromInt(0x60004208),
    .FUNC46_IN_SEL_CFG = @ptrFromInt(0x6000420c),
    .FUNC47_IN_SEL_CFG = @ptrFromInt(0x60004210),
    .FUNC48_IN_SEL_CFG = @ptrFromInt(0x60004214),
    .FUNC49_IN_SEL_CFG = @ptrFromInt(0x60004218),
    .FUNC50_IN_SEL_CFG = @ptrFromInt(0x6000421c),
    .FUNC51_IN_SEL_CFG = @ptrFromInt(0x60004220),
    .FUNC52_IN_SEL_CFG = @ptrFromInt(0x60004224),
    .FUNC53_IN_SEL_CFG = @ptrFromInt(0x60004228),
    .FUNC54_IN_SEL_CFG = @ptrFromInt(0x6000422c),
    .FUNC55_IN_SEL_CFG = @ptrFromInt(0x60004230),
    .FUNC56_IN_SEL_CFG = @ptrFromInt(0x60004234),
    .FUNC57_IN_SEL_CFG = @ptrFromInt(0x60004238),
    .FUNC58_IN_SEL_CFG = @ptrFromInt(0x6000423c),
    .FUNC59_IN_SEL_CFG = @ptrFromInt(0x60004240),
    .FUNC60_IN_SEL_CFG = @ptrFromInt(0x60004244),
    .FUNC61_IN_SEL_CFG = @ptrFromInt(0x60004248),
    .FUNC62_IN_SEL_CFG = @ptrFromInt(0x6000424c),
    .FUNC63_IN_SEL_CFG = @ptrFromInt(0x60004250),
    .FUNC64_IN_SEL_CFG = @ptrFromInt(0x60004254),
    .FUNC65_IN_SEL_CFG = @ptrFromInt(0x60004258),
    .FUNC66_IN_SEL_CFG = @ptrFromInt(0x6000425c),
    .FUNC67_IN_SEL_CFG = @ptrFromInt(0x60004260),
    .FUNC68_IN_SEL_CFG = @ptrFromInt(0x60004264),
    .FUNC69_IN_SEL_CFG = @ptrFromInt(0x60004268),
    .FUNC70_IN_SEL_CFG = @ptrFromInt(0x6000426c),
    .FUNC71_IN_SEL_CFG = @ptrFromInt(0x60004270),
    .FUNC72_IN_SEL_CFG = @ptrFromInt(0x60004274),
    .FUNC73_IN_SEL_CFG = @ptrFromInt(0x60004278),
    .FUNC74_IN_SEL_CFG = @ptrFromInt(0x6000427c),
    .FUNC75_IN_SEL_CFG = @ptrFromInt(0x60004280),
    .FUNC76_IN_SEL_CFG = @ptrFromInt(0x60004284),
    .FUNC77_IN_SEL_CFG = @ptrFromInt(0x60004288),
    .FUNC78_IN_SEL_CFG = @ptrFromInt(0x6000428c),
    .FUNC79_IN_SEL_CFG = @ptrFromInt(0x60004290),
    .FUNC80_IN_SEL_CFG = @ptrFromInt(0x60004294),
    .FUNC81_IN_SEL_CFG = @ptrFromInt(0x60004298),
    .FUNC82_IN_SEL_CFG = @ptrFromInt(0x6000429c),
    .FUNC83_IN_SEL_CFG = @ptrFromInt(0x600042a0),
    .FUNC84_IN_SEL_CFG = @ptrFromInt(0x600042a4),
    .FUNC85_IN_SEL_CFG = @ptrFromInt(0x600042a8),
    .FUNC86_IN_SEL_CFG = @ptrFromInt(0x600042ac),
    .FUNC87_IN_SEL_CFG = @ptrFromInt(0x600042b0),
    .FUNC88_IN_SEL_CFG = @ptrFromInt(0x600042b4),
    .FUNC89_IN_SEL_CFG = @ptrFromInt(0x600042b8),
    .FUNC90_IN_SEL_CFG = @ptrFromInt(0x600042bc),
    .FUNC91_IN_SEL_CFG = @ptrFromInt(0x600042c0),
    .FUNC92_IN_SEL_CFG = @ptrFromInt(0x600042c4),
    .FUNC93_IN_SEL_CFG = @ptrFromInt(0x600042c8),
    .FUNC94_IN_SEL_CFG = @ptrFromInt(0x600042cc),
    .FUNC95_IN_SEL_CFG = @ptrFromInt(0x600042d0),
    .FUNC96_IN_SEL_CFG = @ptrFromInt(0x600042d4),
    .FUNC97_IN_SEL_CFG = @ptrFromInt(0x600042d8),
    .FUNC98_IN_SEL_CFG = @ptrFromInt(0x600042dc),
    .FUNC99_IN_SEL_CFG = @ptrFromInt(0x600042e0),
    .FUNC100_IN_SEL_CFG = @ptrFromInt(0x600042e4),
    .FUNC101_IN_SEL_CFG = @ptrFromInt(0x600042e8),
    .FUNC102_IN_SEL_CFG = @ptrFromInt(0x600042ec),
    .FUNC103_IN_SEL_CFG = @ptrFromInt(0x600042f0),
    .FUNC104_IN_SEL_CFG = @ptrFromInt(0x600042f4),
    .FUNC105_IN_SEL_CFG = @ptrFromInt(0x600042f8),
    .FUNC106_IN_SEL_CFG = @ptrFromInt(0x600042fc),
    .FUNC107_IN_SEL_CFG = @ptrFromInt(0x60004300),
    .FUNC108_IN_SEL_CFG = @ptrFromInt(0x60004304),
    .FUNC109_IN_SEL_CFG = @ptrFromInt(0x60004308),
    .FUNC110_IN_SEL_CFG = @ptrFromInt(0x6000430c),
    .FUNC111_IN_SEL_CFG = @ptrFromInt(0x60004310),
    .FUNC112_IN_SEL_CFG = @ptrFromInt(0x60004314),
    .FUNC113_IN_SEL_CFG = @ptrFromInt(0x60004318),
    .FUNC114_IN_SEL_CFG = @ptrFromInt(0x6000431c),
    .FUNC115_IN_SEL_CFG = @ptrFromInt(0x60004320),
    .FUNC116_IN_SEL_CFG = @ptrFromInt(0x60004324),
    .FUNC117_IN_SEL_CFG = @ptrFromInt(0x60004328),
    .FUNC118_IN_SEL_CFG = @ptrFromInt(0x6000432c),
    .FUNC119_IN_SEL_CFG = @ptrFromInt(0x60004330),
    .FUNC120_IN_SEL_CFG = @ptrFromInt(0x60004334),
    .FUNC121_IN_SEL_CFG = @ptrFromInt(0x60004338),
    .FUNC122_IN_SEL_CFG = @ptrFromInt(0x6000433c),
    .FUNC123_IN_SEL_CFG = @ptrFromInt(0x60004340),
    .FUNC124_IN_SEL_CFG = @ptrFromInt(0x60004344),
    .FUNC125_IN_SEL_CFG = @ptrFromInt(0x60004348),
    .FUNC126_IN_SEL_CFG = @ptrFromInt(0x6000434c),
    .FUNC127_IN_SEL_CFG = @ptrFromInt(0x60004350),
    .FUNC0_OUT_SEL_CFG = @ptrFromInt(0x60004554),
    .FUNC1_OUT_SEL_CFG = @ptrFromInt(0x60004558),
    .FUNC2_OUT_SEL_CFG = @ptrFromInt(0x6000455c),
    .FUNC3_OUT_SEL_CFG = @ptrFromInt(0x60004560),
    .FUNC4_OUT_SEL_CFG = @ptrFromInt(0x60004564),
    .FUNC5_OUT_SEL_CFG = @ptrFromInt(0x60004568),
    .FUNC6_OUT_SEL_CFG = @ptrFromInt(0x6000456c),
    .FUNC7_OUT_SEL_CFG = @ptrFromInt(0x60004570),
    .FUNC8_OUT_SEL_CFG = @ptrFromInt(0x60004574),
    .FUNC9_OUT_SEL_CFG = @ptrFromInt(0x60004578),
    .FUNC10_OUT_SEL_CFG = @ptrFromInt(0x6000457c),
    .FUNC11_OUT_SEL_CFG = @ptrFromInt(0x60004580),
    .FUNC12_OUT_SEL_CFG = @ptrFromInt(0x60004584),
    .FUNC13_OUT_SEL_CFG = @ptrFromInt(0x60004588),
    .FUNC14_OUT_SEL_CFG = @ptrFromInt(0x6000458c),
    .FUNC15_OUT_SEL_CFG = @ptrFromInt(0x60004590),
    .FUNC16_OUT_SEL_CFG = @ptrFromInt(0x60004594),
    .FUNC17_OUT_SEL_CFG = @ptrFromInt(0x60004598),
    .FUNC18_OUT_SEL_CFG = @ptrFromInt(0x6000459c),
    .FUNC19_OUT_SEL_CFG = @ptrFromInt(0x600045a0),
    .FUNC20_OUT_SEL_CFG = @ptrFromInt(0x600045a4),
    .FUNC21_OUT_SEL_CFG = @ptrFromInt(0x600045a8),
    .FUNC22_OUT_SEL_CFG = @ptrFromInt(0x600045ac),
    .FUNC23_OUT_SEL_CFG = @ptrFromInt(0x600045b0),
    .FUNC24_OUT_SEL_CFG = @ptrFromInt(0x600045b4),
    .FUNC25_OUT_SEL_CFG = @ptrFromInt(0x600045b8),
...
const GPIO_SD = struct {
    ...
    SIGMADELTA0: *volatile GPIO_SD_SIGMADELTAN,
    /// Duty Cycle Configure Register of SDM1
    SIGMADELTA1: *volatile GPIO_SD_SIGMADELTAN,
    /// Duty Cycle Configure Register of SDM2
    SIGMADELTA2: *volatile GPIO_SD_SIGMADELTAN,
    /// Duty Cycle Configure Register of SDM3
    SIGMADELTA3: *volatile GPIO_SD_SIGMADELTAN,
    /// Clock Gating Configure Register
    SIGMADELTA_CG: *volatile GPIO_SD_SIGMADELTA_CG,
    /// MISC Register
    SIGMADELTA_MISC: *volatile GPIO_SD_SIGMADELTA_MISC,
    /// Version Control Register
    SIGMADELTA_VERSION: *volatile GPIO_SD_SIGMADELTA_VERSION,
};

const GPIO_SD_instance = GPIO_SD{
    .SIGMADELTA0 = @ptrFromInt(0x60004f00),
    .SIGMADELTA1 = @ptrFromInt(0x60004f04),
    .SIGMADELTA2 = @ptrFromInt(0x60004f08),
    .SIGMADELTA3 = @ptrFromInt(0x60004f0c),
...
const HMAC = struct {
    ...
    SET_START: *volatile HMAC_SET_START,
    /// Configure purpose.
    SET_PARA_PURPOSE: *volatile HMAC_SET_PARA_PURPOSE,
    /// Configure key.
    SET_PARA_KEY: *volatile HMAC_SET_PARA_KEY,
    /// Finish initial configuration.
    SET_PARA_FINISH: *volatile HMAC_SET_PARA_FINISH,
    /// Process control register 1.
    SET_MESSAGE_ONE: *volatile HMAC_SET_MESSAGE_ONE,
    /// Process control register 2.
    SET_MESSAGE_ING: *volatile HMAC_SET_MESSAGE_ING,
    /// Process control register 3.
    SET_MESSAGE_END: *volatile HMAC_SET_MESSAGE_END,
    /// Process control register 4.
    SET_RESULT_FINISH: *volatile HMAC_SET_RESULT_FINISH,
    /// Invalidate register 0.
    SET_INVALIDATE_JTAG: *volatile HMAC_SET_INVALIDATE_JTAG,
    /// Invalidate register 1.
    SET_INVALIDATE_DS: *volatile HMAC_SET_INVALIDATE_DS,
    /// Error register.
    QUERY_ERROR: *volatile HMAC_QUERY_ERROR,
    /// Busy register.
    QUERY_BUSY: *volatile HMAC_QUERY_BUSY,
    /// Message block memory.
    WR_MESSAGE_MEM0: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Message block memory.
    WR_MESSAGE_MEM1: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Message block memory.
    WR_MESSAGE_MEM2: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Message block memory.
    WR_MESSAGE_MEM3: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Message block memory.
    WR_MESSAGE_MEM4: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Message block memory.
    WR_MESSAGE_MEM5: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Message block memory.
    WR_MESSAGE_MEM6: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Message block memory.
    WR_MESSAGE_MEM7: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Message block memory.
    WR_MESSAGE_MEM8: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Message block memory.
    WR_MESSAGE_MEM9: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Message block memory.
    WR_MESSAGE_MEM10: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Message block memory.
    WR_MESSAGE_MEM11: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Message block memory.
    WR_MESSAGE_MEM12: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Message block memory.
    WR_MESSAGE_MEM13: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Message block memory.
    WR_MESSAGE_MEM14: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Message block memory.
    WR_MESSAGE_MEM15: *volatile HMAC_WR_MESSAGE_MEMN,
    /// Result from upstream.
    RD_RESULT_MEM0: *volatile HMAC_RD_RESULT_MEMN,
    /// Result from upstream.
    RD_RESULT_MEM1: *volatile HMAC_RD_RESULT_MEMN,
    /// Result from upstream.
    RD_RESULT_MEM2: *volatile HMAC_RD_RESULT_MEMN,
    /// Result from upstream.
    RD_RESULT_MEM3: *volatile HMAC_RD_RESULT_MEMN,
    /// Result from upstream.
    RD_RESULT_MEM4: *volatile HMAC_RD_RESULT_MEMN,
    /// Result from upstream.
    RD_RESULT_MEM5: *volatile HMAC_RD_RESULT_MEMN,
    /// Result from upstream.
    RD_RESULT_MEM6: *volatile HMAC_RD_RESULT_MEMN,
    /// Result from upstream.
    RD_RESULT_MEM7: *volatile HMAC_RD_RESULT_MEMN,
    /// Process control register 5.
    SET_MESSAGE_PAD: *volatile HMAC_SET_MESSAGE_PAD,
    /// Process control register 6.
    ONE_BLOCK: *volatile HMAC_ONE_BLOCK,
    /// Jtag register 0.
    SOFT_JTAG_CTRL: *volatile HMAC_SOFT_JTAG_CTRL,
    /// Jtag register 1.
    WR_JTAG: *volatile HMAC_WR_JTAG,
};
...
const HMAC_instance = HMAC{
    ...
    .WR_MESSAGE_MEM1 = @ptrFromInt(0x6003e084),
    .WR_MESSAGE_MEM2 = @ptrFromInt(0x6003e088),
    .WR_MESSAGE_MEM3 = @ptrFromInt(0x6003e08c),
    .WR_MESSAGE_MEM4 = @ptrFromInt(0x6003e090),
    .WR_MESSAGE_MEM5 = @ptrFromInt(0x6003e094),
    .WR_MESSAGE_MEM6 = @ptrFromInt(0x6003e098),
    .WR_MESSAGE_MEM7 = @ptrFromInt(0x6003e09c),
    .WR_MESSAGE_MEM8 = @ptrFromInt(0x6003e0a0),
    .WR_MESSAGE_MEM9 = @ptrFromInt(0x6003e0a4),
    .WR_MESSAGE_MEM10 = @ptrFromInt(0x6003e0a8),
    .WR_MESSAGE_MEM11 = @ptrFromInt(0x6003e0ac),
    .WR_MESSAGE_MEM12 = @ptrFromInt(0x6003e0b0),
    .WR_MESSAGE_MEM13 = @ptrFromInt(0x6003e0b4),
    .WR_MESSAGE_MEM14 = @ptrFromInt(0x6003e0b8),
    .WR_MESSAGE_MEM15 = @ptrFromInt(0x6003e0bc),
    .RD_RESULT_MEM0 = @ptrFromInt(0x6003e0c0),
    .RD_RESULT_MEM1 = @ptrFromInt(0x6003e0c4),
    .RD_RESULT_MEM2 = @ptrFromInt(0x6003e0c8),
    .RD_RESULT_MEM3 = @ptrFromInt(0x6003e0cc),
    .RD_RESULT_MEM4 = @ptrFromInt(0x6003e0d0),
    .RD_RESULT_MEM5 = @ptrFromInt(0x6003e0d4),
    .RD_RESULT_MEM6 = @ptrFromInt(0x6003e0d8),
    .RD_RESULT_MEM7 = @ptrFromInt(0x6003e0dc),
...
const I2C0 = struct {
    ...
    SCL_LOW_PERIOD: *volatile I2C0_SCL_LOW_PERIOD,
    /// I2C_CTR_REG
    CTR: *volatile I2C0_CTR,
    /// I2C_SR_REG
    SR: *volatile I2C0_SR,
    /// I2C_TO_REG
    TO: *volatile I2C0_TO,
    /// I2C_SLAVE_ADDR_REG
    SLAVE_ADDR: *volatile I2C0_SLAVE_ADDR,
    /// I2C_FIFO_ST_REG
    FIFO_ST: *volatile I2C0_FIFO_ST,
    /// I2C_FIFO_CONF_REG
    FIFO_CONF: *volatile I2C0_FIFO_CONF,
    /// I2C_FIFO_DATA_REG
    DATA: *volatile I2C0_DATA,
    /// I2C_INT_RAW_REG
    INT_RAW: *volatile I2C0_INT_RAW,
    /// I2C_INT_CLR_REG
    INT_CLR: *volatile I2C0_INT_CLR,
    /// I2C_INT_ENA_REG
    INT_ENA: *volatile I2C0_INT_ENA,
    /// I2C_INT_STATUS_REG
    INT_STATUS: *volatile I2C0_INT_STATUS,
    /// I2C_SDA_HOLD_REG
    SDA_HOLD: *volatile I2C0_SDA_HOLD,
    /// I2C_SDA_SAMPLE_REG
    SDA_SAMPLE: *volatile I2C0_SDA_SAMPLE,
    /// I2C_SCL_HIGH_PERIOD_REG
    SCL_HIGH_PERIOD: *volatile I2C0_SCL_HIGH_PERIOD,
    /// I2C_SCL_START_HOLD_REG
    SCL_START_HOLD: *volatile I2C0_SCL_START_HOLD,
    /// I2C_SCL_RSTART_SETUP_REG
    SCL_RSTART_SETUP: *volatile I2C0_SCL_RSTART_SETUP,
    /// I2C_SCL_STOP_HOLD_REG
    SCL_STOP_HOLD: *volatile I2C0_SCL_STOP_HOLD,
    /// I2C_SCL_STOP_SETUP_REG
    SCL_STOP_SETUP: *volatile I2C0_SCL_STOP_SETUP,
    /// I2C_FILTER_CFG_REG
    FILTER_CFG: *volatile I2C0_FILTER_CFG,
    /// I2C_CLK_CONF_REG
    CLK_CONF: *volatile I2C0_CLK_CONF,
    /// I2C_COMD0_REG
    COMD0: *volatile I2C0_COMDN,
    /// I2C_COMD1_REG
    COMD1: *volatile I2C0_COMDN,
    /// I2C_COMD2_REG
    COMD2: *volatile I2C0_COMDN,
    /// I2C_COMD3_REG
    COMD3: *volatile I2C0_COMDN,
    /// I2C_COMD4_REG
    COMD4: *volatile I2C0_COMDN,
    /// I2C_COMD5_REG
    COMD5: *volatile I2C0_COMDN,
    /// I2C_COMD6_REG
    COMD6: *volatile I2C0_COMDN,
    /// I2C_COMD7_REG
    COMD7: *volatile I2C0_COMDN,
    /// I2C_SCL_ST_TIME_OUT_REG
    SCL_ST_TIME_OUT: *volatile I2C0_SCL_ST_TIME_OUT,
    /// I2C_SCL_MAIN_ST_TIME_OUT_REG
    SCL_MAIN_ST_TIME_OUT: *volatile I2C0_SCL_MAIN_ST_TIME_OUT,
    /// I2C_SCL_SP_CONF_REG
    SCL_SP_CONF: *volatile I2C0_SCL_SP_CONF,
    /// I2C_SCL_STRETCH_CONF_REG
    SCL_STRETCH_CONF: *volatile I2C0_SCL_STRETCH_CONF,
    /// I2C_DATE_REG
    DATE: *volatile I2C0_DATE,
    /// I2C_TXFIFO_START_ADDR_REG
    TXFIFO_START_ADDR: *volatile I2C0_TXFIFO_START_ADDR,
    /// I2C_RXFIFO_START_ADDR_REG
    RXFIFO_START_ADDR: *volatile I2C0_RXFIFO_START_ADDR,
};
...
const I2C0_instance = I2C0{
    ...
    .COMD1 = @ptrFromInt(0x6001305c),
    .COMD2 = @ptrFromInt(0x60013060),
    .COMD3 = @ptrFromInt(0x60013064),
    .COMD4 = @ptrFromInt(0x60013068),
    .COMD5 = @ptrFromInt(0x6001306c),
    .COMD6 = @ptrFromInt(0x60013070),
    .COMD7 = @ptrFromInt(0x60013074),
...
const I2S0 = struct {
    ...
    INT_RAW: *volatile I2S0_INT_RAW,
    /// I2S interrupt status register.
    INT_ST: *volatile I2S0_INT_ST,
    /// I2S interrupt enable register.
    INT_ENA: *volatile I2S0_INT_ENA,
    /// I2S interrupt clear register.
    INT_CLR: *volatile I2S0_INT_CLR,
    /// I2S RX configure register
    RX_CONF: *volatile I2S0_RX_CONF,
    /// I2S TX configure register
    TX_CONF: *volatile I2S0_TX_CONF,
    /// I2S RX configure register 1
    RX_CONF1: *volatile I2S0_RX_CONF1,
    /// I2S TX configure register 1
    TX_CONF1: *volatile I2S0_TX_CONF1,
    /// I2S RX clock configure register
    RX_CLKM_CONF: *volatile I2S0_RX_CLKM_CONF,
    /// I2S TX clock configure register
    TX_CLKM_CONF: *volatile I2S0_TX_CLKM_CONF,
    /// I2S RX module clock divider configure register
    RX_CLKM_DIV_CONF: *volatile I2S0_RX_CLKM_DIV_CONF,
    /// I2S TX module clock divider configure register
    TX_CLKM_DIV_CONF: *volatile I2S0_TX_CLKM_DIV_CONF,
    /// I2S TX PCM2PDM configuration register
    TX_PCM2PDM_CONF: *volatile I2S0_TX_PCM2PDM_CONF,
    /// I2S TX PCM2PDM configuration register
    TX_PCM2PDM_CONF1: *volatile I2S0_TX_PCM2PDM_CONF1,
    /// I2S TX TDM mode control register
    RX_TDM_CTRL: *volatile I2S0_RX_TDM_CTRL,
    /// I2S TX TDM mode control register
    TX_TDM_CTRL: *volatile I2S0_TX_TDM_CTRL,
    /// I2S RX timing control register
    RX_TIMING: *volatile I2S0_RX_TIMING,
    /// I2S TX timing control register
    TX_TIMING: *volatile I2S0_TX_TIMING,
    /// I2S HUNG configure register.
    LC_HUNG_CONF: *volatile I2S0_LC_HUNG_CONF,
    /// I2S RX data number control register.
    RXEOF_NUM: *volatile I2S0_RXEOF_NUM,
    /// I2S signal data register
    CONF_SIGLE_DATA: *volatile I2S0_CONF_SIGLE_DATA,
    /// I2S TX status register
    STATE: *volatile I2S0_STATE,
    /// Version control register
    DATE: *volatile I2S0_DATE,
};
...
const INTERRUPT_CORE0 = struct {
    ...
    MAC_INTR_MAP: *volatile INTERRUPT_CORE0_MAC_INTR_MAP,
    /// mac nmi_intr map register
    MAC_NMI_MAP: *volatile INTERRUPT_CORE0_MAC_NMI_MAP,
    /// pwr intr map register
    PWR_INTR_MAP: *volatile INTERRUPT_CORE0_PWR_INTR_MAP,
    /// bb intr map register
    BB_INT_MAP: *volatile INTERRUPT_CORE0_BB_INT_MAP,
    /// bt intr map register
    BT_MAC_INT_MAP: *volatile INTERRUPT_CORE0_BT_MAC_INT_MAP,
    /// bb_bt intr map register
    BT_BB_INT_MAP: *volatile INTERRUPT_CORE0_BT_BB_INT_MAP,
    /// bb_bt_nmi intr map register
    BT_BB_NMI_MAP: *volatile INTERRUPT_CORE0_BT_BB_NMI_MAP,
    /// rwbt intr map register
    RWBT_IRQ_MAP: *volatile INTERRUPT_CORE0_RWBT_IRQ_MAP,
    /// rwble intr map register
    RWBLE_IRQ_MAP: *volatile INTERRUPT_CORE0_RWBLE_IRQ_MAP,
    /// rwbt_nmi intr map register
    RWBT_NMI_MAP: *volatile INTERRUPT_CORE0_RWBT_NMI_MAP,
    /// rwble_nmi intr map register
    RWBLE_NMI_MAP: *volatile INTERRUPT_CORE0_RWBLE_NMI_MAP,
    /// i2c intr map register
    I2C_MST_INT_MAP: *volatile INTERRUPT_CORE0_I2C_MST_INT_MAP,
    /// slc0 intr map register
    SLC0_INTR_MAP: *volatile INTERRUPT_CORE0_SLC0_INTR_MAP,
    /// slc1 intr map register
    SLC1_INTR_MAP: *volatile INTERRUPT_CORE0_SLC1_INTR_MAP,
    /// apb_ctrl intr map register
    APB_CTRL_INTR_MAP: *volatile INTERRUPT_CORE0_APB_CTRL_INTR_MAP,
    /// uchi0 intr map register
    UHCI0_INTR_MAP: *volatile INTERRUPT_CORE0_UHCI0_INTR_MAP,
    /// gpio intr map register
    GPIO_INTERRUPT_PRO_MAP: *volatile INTERRUPT_CORE0_GPIO_INTERRUPT_PRO_MAP,
    /// gpio_pro intr map register
    GPIO_INTERRUPT_PRO_NMI_MAP: *volatile INTERRUPT_CORE0_GPIO_INTERRUPT_PRO_NMI_MAP,
    /// gpio_pro_nmi intr map register
    SPI_INTR_1_MAP: *volatile INTERRUPT_CORE0_SPI_INTR_1_MAP,
    /// spi1 intr map register
    SPI_INTR_2_MAP: *volatile INTERRUPT_CORE0_SPI_INTR_2_MAP,
    /// spi2 intr map register
    I2S1_INT_MAP: *volatile INTERRUPT_CORE0_I2S1_INT_MAP,
    /// i2s1 intr map register
    UART_INTR_MAP: *volatile INTERRUPT_CORE0_UART_INTR_MAP,
    /// uart1 intr map register
    UART1_INTR_MAP: *volatile INTERRUPT_CORE0_UART1_INTR_MAP,
    /// ledc intr map register
    LEDC_INT_MAP: *volatile INTERRUPT_CORE0_LEDC_INT_MAP,
    /// efuse intr map register
    EFUSE_INT_MAP: *volatile INTERRUPT_CORE0_EFUSE_INT_MAP,
    /// can intr map register
    CAN_INT_MAP: *volatile INTERRUPT_CORE0_CAN_INT_MAP,
    /// usb intr map register
    USB_INTR_MAP: *volatile INTERRUPT_CORE0_USB_INTR_MAP,
    /// rtc intr map register
    RTC_CORE_INTR_MAP: *volatile INTERRUPT_CORE0_RTC_CORE_INTR_MAP,
    /// rmt intr map register
    RMT_INTR_MAP: *volatile INTERRUPT_CORE0_RMT_INTR_MAP,
    /// i2c intr map register
    I2C_EXT0_INTR_MAP: *volatile INTERRUPT_CORE0_I2C_EXT0_INTR_MAP,
    /// timer1 intr map register
    TIMER_INT1_MAP: *volatile INTERRUPT_CORE0_TIMER_INT1_MAP,
    /// timer2 intr map register
    TIMER_INT2_MAP: *volatile INTERRUPT_CORE0_TIMER_INT2_MAP,
    /// tg to intr map register
    TG_T0_INT_MAP: *volatile INTERRUPT_CORE0_TG_T0_INT_MAP,
    /// tg wdt intr map register
    TG_WDT_INT_MAP: *volatile INTERRUPT_CORE0_TG_WDT_INT_MAP,
    /// tg1 to intr map register
    TG1_T0_INT_MAP: *volatile INTERRUPT_CORE0_TG1_T0_INT_MAP,
    /// tg1 wdt intr map register
    TG1_WDT_INT_MAP: *volatile INTERRUPT_CORE0_TG1_WDT_INT_MAP,
    /// cache ia intr map register
    CACHE_IA_INT_MAP: *volatile INTERRUPT_CORE0_CACHE_IA_INT_MAP,
    /// systimer intr map register
    SYSTIMER_TARGET0_INT_MAP: *volatile INTERRUPT_CORE0_SYSTIMER_TARGET0_INT_MAP,
    /// systimer target1 intr map register
    SYSTIMER_TARGET1_INT_MAP: *volatile INTERRUPT_CORE0_SYSTIMER_TARGET1_INT_MAP,
    /// systimer target2 intr map register
    SYSTIMER_TARGET2_INT_MAP: *volatile INTERRUPT_CORE0_SYSTIMER_TARGET2_INT_MAP,
    /// spi mem reject intr map register
    SPI_MEM_REJECT_INTR_MAP: *volatile INTERRUPT_CORE0_SPI_MEM_REJECT_INTR_MAP,
    /// icache perload intr map register
    ICACHE_PRELOAD_INT_MAP: *volatile INTERRUPT_CORE0_ICACHE_PRELOAD_INT_MAP,
    /// icache sync intr map register
    ICACHE_SYNC_INT_MAP: *volatile INTERRUPT_CORE0_ICACHE_SYNC_INT_MAP,
    /// adc intr map register
    APB_ADC_INT_MAP: *volatile INTERRUPT_CORE0_APB_ADC_INT_MAP,
    /// dma ch0 intr map register
    DMA_CH0_INT_MAP: *volatile INTERRUPT_CORE0_DMA_CH0_INT_MAP,
    /// dma ch1 intr map register
    DMA_CH1_INT_MAP: *volatile INTERRUPT_CORE0_DMA_CH1_INT_MAP,
    /// dma ch2 intr map register
    DMA_CH2_INT_MAP: *volatile INTERRUPT_CORE0_DMA_CH2_INT_MAP,
    /// rsa intr map register
    RSA_INT_MAP: *volatile INTERRUPT_CORE0_RSA_INT_MAP,
    /// aes intr map register
    AES_INT_MAP: *volatile INTERRUPT_CORE0_AES_INT_MAP,
    /// sha intr map register
    SHA_INT_MAP: *volatile INTERRUPT_CORE0_SHA_INT_MAP,
    /// cpu from cpu 0 intr map register
    CPU_INTR_FROM_CPU_0_MAP: *volatile INTERRUPT_CORE0_CPU_INTR_FROM_CPU_0_MAP,
    /// cpu from cpu 0 intr map register
    CPU_INTR_FROM_CPU_1_MAP: *volatile INTERRUPT_CORE0_CPU_INTR_FROM_CPU_1_MAP,
    /// cpu from cpu 1 intr map register
    CPU_INTR_FROM_CPU_2_MAP: *volatile INTERRUPT_CORE0_CPU_INTR_FROM_CPU_2_MAP,
    /// cpu from cpu 3 intr map register
    CPU_INTR_FROM_CPU_3_MAP: *volatile INTERRUPT_CORE0_CPU_INTR_FROM_CPU_3_MAP,
    /// assist debug intr map register
    ASSIST_DEBUG_INTR_MAP: *volatile INTERRUPT_CORE0_ASSIST_DEBUG_INTR_MAP,
    /// dma pms violatile intr map register
    DMA_APBPERI_PMS_MONITOR_VIOLATE_INTR_MAP: *volatile INTERRUPT_CORE0_DMA_APBPERI_PMS_MONITOR_VIOLATE_INTR_MAP,
    /// iram0 pms violatile intr map register
    CORE_0_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP: *volatile INTERRUPT_CORE0_CORE_0_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP,
    /// mac intr map register
    CORE_0_DRAM0_PMS_MONITOR_VIOLATE_INTR_MAP: *volatile INTERRUPT_CORE0_CORE_0_DRAM0_PMS_MONITOR_VIOLATE_INTR_MAP,
    /// mac intr map register
    CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR_MAP: *volatile INTERRUPT_CORE0_CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR_MAP,
    /// mac intr map register
    CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP: *volatile INTERRUPT_CORE0_CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP,
    /// mac intr map register
    BACKUP_PMS_VIOLATE_INTR_MAP: *volatile INTERRUPT_CORE0_BACKUP_PMS_VIOLATE_INTR_MAP,
    /// mac intr map register
    CACHE_CORE0_ACS_INT_MAP: *volatile INTERRUPT_CORE0_CACHE_CORE0_ACS_INT_MAP,
    /// mac intr map register
    INTR_STATUS_REG_0: *volatile INTERRUPT_CORE0_INTR_STATUS_REG_0,
    /// mac intr map register
    INTR_STATUS_REG_1: *volatile INTERRUPT_CORE0_INTR_STATUS_REG_1,
    /// mac intr map register
    CLOCK_GATE: *volatile INTERRUPT_CORE0_CLOCK_GATE,
    /// mac intr map register
    CPU_INT_ENABLE: *volatile INTERRUPT_CORE0_CPU_INT_ENABLE,
    /// mac intr map register
    CPU_INT_TYPE: *volatile INTERRUPT_CORE0_CPU_INT_TYPE,
    /// mac intr map register
    CPU_INT_CLEAR: *volatile INTERRUPT_CORE0_CPU_INT_CLEAR,
    /// mac intr map register
    CPU_INT_EIP_STATUS: *volatile INTERRUPT_CORE0_CPU_INT_EIP_STATUS,
    /// mac intr map register
    CPU_INT_PRI_0: *volatile INTERRUPT_CORE0_CPU_INT_PRI_0,
    /// mac intr map register
    CPU_INT_PRI_1: *volatile INTERRUPT_CORE0_CPU_INT_PRI_1,
    /// mac intr map register
    CPU_INT_PRI_2: *volatile INTERRUPT_CORE0_CPU_INT_PRI_2,
    /// mac intr map register
    CPU_INT_PRI_3: *volatile INTERRUPT_CORE0_CPU_INT_PRI_3,
    /// mac intr map register
    CPU_INT_PRI_4: *volatile INTERRUPT_CORE0_CPU_INT_PRI_4,
    /// mac intr map register
    CPU_INT_PRI_5: *volatile INTERRUPT_CORE0_CPU_INT_PRI_5,
    /// mac intr map register
    CPU_INT_PRI_6: *volatile INTERRUPT_CORE0_CPU_INT_PRI_6,
    /// mac intr map register
    CPU_INT_PRI_7: *volatile INTERRUPT_CORE0_CPU_INT_PRI_7,
    /// mac intr map register
    CPU_INT_PRI_8: *volatile INTERRUPT_CORE0_CPU_INT_PRI_8,
    /// mac intr map register
    CPU_INT_PRI_9: *volatile INTERRUPT_CORE0_CPU_INT_PRI_9,
    /// mac intr map register
    CPU_INT_PRI_10: *volatile INTERRUPT_CORE0_CPU_INT_PRI_10,
    /// mac intr map register
    CPU_INT_PRI_11: *volatile INTERRUPT_CORE0_CPU_INT_PRI_11,
    /// mac intr map register
    CPU_INT_PRI_12: *volatile INTERRUPT_CORE0_CPU_INT_PRI_12,
    /// mac intr map register
    CPU_INT_PRI_13: *volatile INTERRUPT_CORE0_CPU_INT_PRI_13,
    /// mac intr map register
    CPU_INT_PRI_14: *volatile INTERRUPT_CORE0_CPU_INT_PRI_14,
    /// mac intr map register
    CPU_INT_PRI_15: *volatile INTERRUPT_CORE0_CPU_INT_PRI_15,
    /// mac intr map register
    CPU_INT_PRI_16: *volatile INTERRUPT_CORE0_CPU_INT_PRI_16,
    /// mac intr map register
    CPU_INT_PRI_17: *volatile INTERRUPT_CORE0_CPU_INT_PRI_17,
    /// mac intr map register
    CPU_INT_PRI_18: *volatile INTERRUPT_CORE0_CPU_INT_PRI_18,
    /// mac intr map register
    CPU_INT_PRI_19: *volatile INTERRUPT_CORE0_CPU_INT_PRI_19,
    /// mac intr map register
    CPU_INT_PRI_20: *volatile INTERRUPT_CORE0_CPU_INT_PRI_20,
    /// mac intr map register
    CPU_INT_PRI_21: *volatile INTERRUPT_CORE0_CPU_INT_PRI_21,
    /// mac intr map register
    CPU_INT_PRI_22: *volatile INTERRUPT_CORE0_CPU_INT_PRI_22,
    /// mac intr map register
    CPU_INT_PRI_23: *volatile INTERRUPT_CORE0_CPU_INT_PRI_23,
    /// mac intr map register
    CPU_INT_PRI_24: *volatile INTERRUPT_CORE0_CPU_INT_PRI_24,
    /// mac intr map register
    CPU_INT_PRI_25: *volatile INTERRUPT_CORE0_CPU_INT_PRI_25,
    /// mac intr map register
    CPU_INT_PRI_26: *volatile INTERRUPT_CORE0_CPU_INT_PRI_26,
    /// mac intr map register
    CPU_INT_PRI_27: *volatile INTERRUPT_CORE0_CPU_INT_PRI_27,
    /// mac intr map register
    CPU_INT_PRI_28: *volatile INTERRUPT_CORE0_CPU_INT_PRI_28,
    /// mac intr map register
    CPU_INT_PRI_29: *volatile INTERRUPT_CORE0_CPU_INT_PRI_29,
    /// mac intr map register
    CPU_INT_PRI_30: *volatile INTERRUPT_CORE0_CPU_INT_PRI_30,
    /// mac intr map register
    CPU_INT_PRI_31: *volatile INTERRUPT_CORE0_CPU_INT_PRI_31,
    /// mac intr map register
    CPU_INT_THRESH: *volatile INTERRUPT_CORE0_CPU_INT_THRESH,
    /// mac intr map register
    INTERRUPT_REG_DATE: *volatile INTERRUPT_CORE0_INTERRUPT_REG_DATE,
};
...
const IO_MUX = struct {
    ...
    PIN_CTRL: *volatile IO_MUX_PIN_CTRL,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO0: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO1: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO2: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO3: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO4: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO5: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO6: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO7: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO8: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO9: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO10: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO11: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO12: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO13: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO14: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO15: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO16: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO17: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO18: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO19: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO20: *volatile IO_MUX_GPION,
    /// IO MUX Configure Register for pad XTAL_32K_P
    GPIO21: *volatile IO_MUX_GPION,
    /// IO MUX Version Control Register
    DATE: *volatile IO_MUX_DATE,
};

const IO_MUX_instance = IO_MUX{
    .PIN_CTRL = @ptrFromInt(0x60009000),
    .GPIO0 = @ptrFromInt(0x60009004),
    .GPIO1 = @ptrFromInt(0x60009008),
    .GPIO2 = @ptrFromInt(0x6000900c),
    .GPIO3 = @ptrFromInt(0x60009010),
    .GPIO4 = @ptrFromInt(0x60009014),
    .GPIO5 = @ptrFromInt(0x60009018),
    .GPIO6 = @ptrFromInt(0x6000901c),
    .GPIO7 = @ptrFromInt(0x60009020),
    .GPIO8 = @ptrFromInt(0x60009024),
    .GPIO9 = @ptrFromInt(0x60009028),
    .GPIO10 = @ptrFromInt(0x6000902c),
    .GPIO11 = @ptrFromInt(0x60009030),
    .GPIO12 = @ptrFromInt(0x60009034),
    .GPIO13 = @ptrFromInt(0x60009038),
    .GPIO14 = @ptrFromInt(0x6000903c),
    .GPIO15 = @ptrFromInt(0x60009040),
    .GPIO16 = @ptrFromInt(0x60009044),
    .GPIO17 = @ptrFromInt(0x60009048),
    .GPIO18 = @ptrFromInt(0x6000904c),
    .GPIO19 = @ptrFromInt(0x60009050),
    .GPIO20 = @ptrFromInt(0x60009054),
    .GPIO21 = @ptrFromInt(0x60009058),
...
const LEDC = struct {
    /// LEDC_LSCH0_CONF0.
    CH0_CONF0: *volatile LEDC_CHN_CONF0,
    /// LEDC_LSCH1_CONF1.
    CH1_CONF0: *volatile LEDC_CHN_CONF0,
    /// LEDC_LSCH2_CONF2.
    CH2_CONF0: *volatile LEDC_CHN_CONF0,
    /// LEDC_LSCH3_CONF3.
    CH3_CONF0: *volatile LEDC_CHN_CONF0,
    /// LEDC_LSCH4_CONF4.
    CH4_CONF0: *volatile LEDC_CHN_CONF0,
    /// LEDC_LSCH5_CONF5.
    CH5_CONF0: *volatile LEDC_CHN_CONF0,
    /// LEDC_LSCH0_HPOINT.
    CH0_HPOINT: *volatile LEDC_CHN_HPOINT,
    /// LEDC_LSCH1_HPOINT.
    CH1_HPOINT: *volatile LEDC_CHN_HPOINT,
    /// LEDC_LSCH2_HPOINT.
    CH2_HPOINT: *volatile LEDC_CHN_HPOINT,
    /// LEDC_LSCH3_HPOINT.
    CH3_HPOINT: *volatile LEDC_CHN_HPOINT,
    /// LEDC_LSCH4_HPOINT.
    CH4_HPOINT: *volatile LEDC_CHN_HPOINT,
    /// LEDC_LSCH5_HPOINT.
    CH5_HPOINT: *volatile LEDC_CHN_HPOINT,
    /// LEDC_LSCH0_DUTY.
    CH0_DUTY: *volatile LEDC_CHN_DUTY,
    /// LEDC_LSCH1_DUTY.
    CH1_DUTY: *volatile LEDC_CHN_DUTY,
    /// LEDC_LSCH2_DUTY.
    CH2_DUTY: *volatile LEDC_CHN_DUTY,
    /// LEDC_LSCH3_DUTY.
    CH3_DUTY: *volatile LEDC_CHN_DUTY,
    /// LEDC_LSCH4_DUTY.
    CH4_DUTY: *volatile LEDC_CHN_DUTY,
    /// LEDC_LSCH5_DUTY.
    CH5_DUTY: *volatile LEDC_CHN_DUTY,
    /// LEDC_LSCH0_CONF1.
    CH0_CONF1: *volatile LEDC_CHN_CONF1,
    /// LEDC_LSCH1_CONF1.
    CH1_CONF1: *volatile LEDC_CHN_CONF1,
    /// LEDC_LSCH2_CONF1.
    CH2_CONF1: *volatile LEDC_CHN_CONF1,
    /// LEDC_LSCH3_CONF1.
    CH3_CONF1: *volatile LEDC_CHN_CONF1,
    /// LEDC_LSCH4_CONF1.
    CH4_CONF1: *volatile LEDC_CHN_CONF1,
    /// LEDC_LSCH5_CONF1.
    CH5_CONF1: *volatile LEDC_CHN_CONF1,
    /// LEDC_LSCH0_DUTY_R.
    CH0_DUTY_R: *volatile LEDC_CHN_DUTY_R,
    /// LEDC_LSCH1_DUTY_R.
    CH1_DUTY_R: *volatile LEDC_CHN_DUTY_R,
    /// LEDC_LSCH2_DUTY_R.
    CH2_DUTY_R: *volatile LEDC_CHN_DUTY_R,
    /// LEDC_LSCH3_DUTY_R.
    CH3_DUTY_R: *volatile LEDC_CHN_DUTY_R,
    /// LEDC_LSCH4_DUTY_R.
    CH4_DUTY_R: *volatile LEDC_CHN_DUTY_R,
    /// LEDC_LSCH5_DUTY_R.
    CH5_DUTY_R: *volatile LEDC_CHN_DUTY_R,
    /// LEDC_LSTIMER0_CONF.
    TIMER0_CONF: *volatile LEDC_TIMERN_CONF,
    /// LEDC_LSTIMER1_CONF.
    TIMER1_CONF: *volatile LEDC_TIMERN_CONF,
    /// LEDC_LSTIMER2_CONF.
    TIMER2_CONF: *volatile LEDC_TIMERN_CONF,
    /// LEDC_LSTIMER3_CONF.
    TIMER3_CONF: *volatile LEDC_TIMERN_CONF,
    /// LEDC_LSTIMER0_VALUE.
    TIMER0_VALUE: *volatile LEDC_TIMERN_VALUE,
    /// LEDC_LSTIMER1_VALUE.
    TIMER1_VALUE: *volatile LEDC_TIMERN_VALUE,
    /// LEDC_LSTIMER2_VALUE.
    TIMER2_VALUE: *volatile LEDC_TIMERN_VALUE,
    /// LEDC_LSTIMER3_VALUE.
    TIMER3_VALUE: *volatile LEDC_TIMERN_VALUE,
    /// LEDC_INT_RAW.
    INT_RAW: *volatile LEDC_INT_RAW,
    /// LEDC_INT_ST.
    INT_ST: *volatile LEDC_INT_ST,
    /// LEDC_INT_ENA.
    INT_ENA: *volatile LEDC_INT_ENA,
    /// LEDC_INT_CLR.
    INT_CLR: *volatile LEDC_INT_CLR,
    /// LEDC_CONF.
    CONF: *volatile LEDC_CONF,
    /// LEDC_DATE.
    DATE: *volatile LEDC_DATE,
};

const LEDC_instance = LEDC{
    .CH0_CONF0 = @ptrFromInt(0x60019000),
    .CH1_CONF0 = @ptrFromInt(0x60019014),
    .CH2_CONF0 = @ptrFromInt(0x60019028),
    .CH3_CONF0 = @ptrFromInt(0x6001903c),
    .CH4_CONF0 = @ptrFromInt(0x60019050),
    .CH5_CONF0 = @ptrFromInt(0x60019064),
    .CH0_HPOINT = @ptrFromInt(0x60019004),
    .CH1_HPOINT = @ptrFromInt(0x60019018),
    .CH2_HPOINT = @ptrFromInt(0x6001902c),
    .CH3_HPOINT = @ptrFromInt(0x60019040),
    .CH4_HPOINT = @ptrFromInt(0x60019054),
    .CH5_HPOINT = @ptrFromInt(0x60019068),
    .CH0_DUTY = @ptrFromInt(0x60019008),
    .CH1_DUTY = @ptrFromInt(0x6001901c),
    .CH2_DUTY = @ptrFromInt(0x60019030),
    .CH3_DUTY = @ptrFromInt(0x60019044),
    .CH4_DUTY = @ptrFromInt(0x60019058),
    .CH5_DUTY = @ptrFromInt(0x6001906c),
    .CH0_CONF1 = @ptrFromInt(0x6001900c),
    .CH1_CONF1 = @ptrFromInt(0x60019020),
    .CH2_CONF1 = @ptrFromInt(0x60019034),
    .CH3_CONF1 = @ptrFromInt(0x60019048),
    .CH4_CONF1 = @ptrFromInt(0x6001905c),
    .CH5_CONF1 = @ptrFromInt(0x60019070),
    .CH0_DUTY_R = @ptrFromInt(0x60019010),
    .CH1_DUTY_R = @ptrFromInt(0x60019024),
    .CH2_DUTY_R = @ptrFromInt(0x60019038),
    .CH3_DUTY_R = @ptrFromInt(0x6001904c),
    .CH4_DUTY_R = @ptrFromInt(0x60019060),
    .CH5_DUTY_R = @ptrFromInt(0x60019074),
    .TIMER0_CONF = @ptrFromInt(0x600190a0),
    .TIMER1_CONF = @ptrFromInt(0x600190a8),
    .TIMER2_CONF = @ptrFromInt(0x600190b0),
    .TIMER3_CONF = @ptrFromInt(0x600190b8),
    .TIMER0_VALUE = @ptrFromInt(0x600190a4),
    .TIMER1_VALUE = @ptrFromInt(0x600190ac),
    .TIMER2_VALUE = @ptrFromInt(0x600190b4),
    .TIMER3_VALUE = @ptrFromInt(0x600190bc),
...
const RMT = struct {
    /// RMT_CH0DATA_REG.
    CH0DATA: *volatile RMT_CHNDATA,
    /// RMT_CH1DATA_REG.
    CH1DATA: *volatile RMT_CHNDATA,
    /// RMT_CH2DATA_REG.
    CH2DATA: *volatile RMT_CHNDATA,
    /// RMT_CH3DATA_REG.
    CH3DATA: *volatile RMT_CHNDATA,
    /// RMT_CH0CONF0_REG.
    CH0_TX_CONF0: *volatile RMT_CHN_TX_CONF0,
    /// RMT_CH1CONF1_REG.
    CH1_TX_CONF0: *volatile RMT_CHN_TX_CONF0,
    /// RMT_CH2CONF0_REG.
    CH0_RX_CONF0: *volatile RMT_CHN_RX_CONF0,
    /// RMT_CH2CONF0_REG.
    CH1_RX_CONF0: *volatile RMT_CHN_RX_CONF0,
    /// RMT_CH2CONF1_REG.
    CH0_RX_CONF1: *volatile RMT_CHN_RX_CONF1,
    /// RMT_CH2CONF1_REG.
    CH1_RX_CONF1: *volatile RMT_CHN_RX_CONF1,
    /// RMT_CH0STATUS_REG.
    CH0_TX_STATUS: *volatile RMT_CHN_TX_STATUS,
    /// RMT_CH1STATUS_REG.
    CH1_TX_STATUS: *volatile RMT_CHN_TX_STATUS,
    /// RMT_CH2STATUS_REG.
    CH0_RX_STATUS: *volatile RMT_CHN_RX_STATUS,
    /// RMT_CH2STATUS_REG.
    CH1_RX_STATUS: *volatile RMT_CHN_RX_STATUS,
    /// RMT_INT_RAW_REG.
    INT_RAW: *volatile RMT_INT_RAW,
    /// RMT_INT_ST_REG.
    INT_ST: *volatile RMT_INT_ST,
    /// RMT_INT_ENA_REG.
    INT_ENA: *volatile RMT_INT_ENA,
    /// RMT_INT_CLR_REG.
    INT_CLR: *volatile RMT_INT_CLR,
    /// RMT_CH0CARRIER_DUTY_REG.
    CH0CARRIER_DUTY: *volatile RMT_CHNCARRIER_DUTY,
    /// RMT_CH1CARRIER_DUTY_REG.
    CH1CARRIER_DUTY: *volatile RMT_CHNCARRIER_DUTY,
    /// RMT_CH2_RX_CARRIER_RM_REG.
    CH0_RX_CARRIER_RM: *volatile RMT_CHN_RX_CARRIER_RM,
    /// RMT_CH2_RX_CARRIER_RM_REG.
    CH1_RX_CARRIER_RM: *volatile RMT_CHN_RX_CARRIER_RM,
    /// RMT_CH0_TX_LIM_REG.
    CH0_TX_LIM: *volatile RMT_CHN_TX_LIM,
    /// RMT_CH1_TX_LIM_REG.
    CH1_TX_LIM: *volatile RMT_CHN_TX_LIM,
    /// RMT_CH2_RX_LIM_REG.
    CH0_RX_LIM: *volatile RMT_CHN_RX_LIM,
    /// RMT_CH2_RX_LIM_REG.
    CH1_RX_LIM: *volatile RMT_CHN_RX_LIM,
    /// RMT_SYS_CONF_REG.
    SYS_CONF: *volatile RMT_SYS_CONF,
    /// RMT_TX_SIM_REG.
    TX_SIM: *volatile RMT_TX_SIM,
    /// RMT_REF_CNT_RST_REG.
    REF_CNT_RST: *volatile RMT_REF_CNT_RST,
    /// RMT_DATE_REG.
    DATE: *volatile RMT_DATE,
};

const RMT_instance = RMT{
    .CH0DATA = @ptrFromInt(0x60016000),
    .CH1DATA = @ptrFromInt(0x60016004),
    .CH2DATA = @ptrFromInt(0x60016008),
    .CH3DATA = @ptrFromInt(0x6001600c),
    .CH0_TX_CONF0 = @ptrFromInt(0x60016010),
    .CH1_TX_CONF0 = @ptrFromInt(0x60016014),
    .CH0_RX_CONF0 = @ptrFromInt(0x60016018),
    .CH1_RX_CONF0 = @ptrFromInt(0x60016020),
    .CH0_RX_CONF1 = @ptrFromInt(0x6001601c),
    .CH1_RX_CONF1 = @ptrFromInt(0x60016024),
    .CH0_TX_STATUS = @ptrFromInt(0x60016028),
    .CH1_TX_STATUS = @ptrFromInt(0x6001602c),
    .CH0_RX_STATUS = @ptrFromInt(0x60016030),
    .CH1_RX_STATUS = @ptrFromInt(0x60016034),
    ...
    .CH1CARRIER_DUTY = @ptrFromInt(0x6001604c),
    .CH0_RX_CARRIER_RM = @ptrFromInt(0x60016050),
    .CH1_RX_CARRIER_RM = @ptrFromInt(0x60016054),
    .CH0_TX_LIM = @ptrFromInt(0x60016058),
    .CH1_TX_LIM = @ptrFromInt(0x6001605c),
    .CH0_RX_LIM = @ptrFromInt(0x60016060),
    .CH1_RX_LIM = @ptrFromInt(0x60016064),
...
const RSA = struct {
    ...
    M_MEM0: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM1: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM2: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM3: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM4: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM5: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM6: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM7: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM8: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM9: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM10: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM11: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM12: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM13: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM14: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM15: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM16: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM17: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM18: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM19: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM20: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM21: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM22: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM23: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM24: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM25: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM26: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM27: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM28: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM29: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM30: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM31: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM32: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM33: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM34: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM35: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM36: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM37: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM38: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM39: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM40: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM41: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM42: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM43: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM44: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM45: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM46: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM47: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM48: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM49: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM50: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM51: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM52: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM53: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM54: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM55: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM56: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM57: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM58: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM59: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM60: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM61: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM62: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM63: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM64: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM65: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM66: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM67: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM68: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM69: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM70: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM71: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM72: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM73: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM74: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM75: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM76: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM77: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM78: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM79: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM80: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM81: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM82: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM83: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM84: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM85: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM86: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM87: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM88: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM89: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM90: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM91: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM92: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM93: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM94: *volatile RSA_M_MEMN,
    /// The memory that stores M
    M_MEM95: *volatile RSA_M_MEMN,
    /// The memory that stores Z
    Z_MEM0: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM1: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM2: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM3: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM4: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM5: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM6: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM7: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM8: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM9: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM10: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM11: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM12: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM13: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM14: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM15: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM16: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM17: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM18: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM19: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM20: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM21: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM22: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM23: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM24: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM25: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM26: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM27: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM28: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM29: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM30: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM31: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM32: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM33: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM34: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM35: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM36: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM37: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM38: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM39: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM40: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM41: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM42: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM43: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM44: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM45: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM46: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM47: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM48: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM49: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM50: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM51: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM52: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM53: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM54: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM55: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM56: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM57: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM58: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM59: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM60: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM61: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM62: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM63: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM64: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM65: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM66: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM67: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM68: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM69: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM70: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM71: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM72: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM73: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM74: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM75: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM76: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM77: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM78: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM79: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM80: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM81: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM82: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM83: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM84: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM85: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM86: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM87: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM88: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM89: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM90: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM91: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM92: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM93: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM94: *volatile RSA_Z_MEMN,
    /// The memory that stores Z
    Z_MEM95: *volatile RSA_Z_MEMN,
    /// The memory that stores Y
    Y_MEM0: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM1: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM2: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM3: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM4: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM5: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM6: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM7: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM8: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM9: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM10: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM11: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM12: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM13: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM14: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM15: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM16: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM17: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM18: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM19: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM20: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM21: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM22: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM23: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM24: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM25: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM26: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM27: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM28: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM29: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM30: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM31: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM32: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM33: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM34: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM35: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM36: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM37: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM38: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM39: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM40: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM41: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM42: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM43: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM44: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM45: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM46: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM47: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM48: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM49: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM50: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM51: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM52: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM53: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM54: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM55: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM56: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM57: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM58: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM59: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM60: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM61: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM62: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM63: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM64: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM65: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM66: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM67: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM68: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM69: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM70: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM71: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM72: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM73: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM74: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM75: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM76: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM77: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM78: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM79: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM80: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM81: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM82: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM83: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM84: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM85: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM86: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM87: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM88: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM89: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM90: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM91: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM92: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM93: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM94: *volatile RSA_Y_MEMN,
    /// The memory that stores Y
    Y_MEM95: *volatile RSA_Y_MEMN,
    /// The memory that stores X
    X_MEM0: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM1: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM2: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM3: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM4: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM5: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM6: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM7: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM8: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM9: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM10: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM11: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM12: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM13: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM14: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM15: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM16: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM17: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM18: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM19: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM20: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM21: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM22: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM23: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM24: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM25: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM26: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM27: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM28: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM29: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM30: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM31: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM32: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM33: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM34: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM35: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM36: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM37: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM38: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM39: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM40: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM41: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM42: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM43: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM44: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM45: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM46: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM47: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM48: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM49: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM50: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM51: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM52: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM53: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM54: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM55: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM56: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM57: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM58: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM59: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM60: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM61: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM62: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM63: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM64: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM65: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM66: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM67: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM68: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM69: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM70: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM71: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM72: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM73: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM74: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM75: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM76: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM77: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM78: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM79: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM80: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM81: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM82: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM83: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM84: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM85: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM86: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM87: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM88: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM89: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM90: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM91: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM92: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM93: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM94: *volatile RSA_X_MEMN,
    /// The memory that stores X
    X_MEM95: *volatile RSA_X_MEMN,
    /// RSA M_prime register
    M_PRIME: *volatile RSA_M_PRIME,
    /// RSA mode register
    MODE: *volatile RSA_MODE,
    /// RSA query clean register
    QUERY_CLEAN: *volatile RSA_QUERY_CLEAN,
    /// RSA modular exponentiation trigger register.
    SET_START_MODEXP: *volatile RSA_SET_START_MODEXP,
    /// RSA modular multiplication trigger register.
    SET_START_MODMULT: *volatile RSA_SET_START_MODMULT,
    /// RSA normal multiplication trigger register.
    SET_START_MULT: *volatile RSA_SET_START_MULT,
    /// RSA query idle register
    QUERY_IDLE: *volatile RSA_QUERY_IDLE,
    /// RSA interrupt clear register
    INT_CLR: *volatile RSA_INT_CLR,
    /// RSA constant time option register
    CONSTANT_TIME: *volatile RSA_CONSTANT_TIME,
    /// RSA search option
    SEARCH_ENABLE: *volatile RSA_SEARCH_ENABLE,
    /// RSA search position configure register
    SEARCH_POS: *volatile RSA_SEARCH_POS,
    /// RSA interrupt enable register
    INT_ENA: *volatile RSA_INT_ENA,
    /// RSA version control register
    DATE: *volatile RSA_DATE,
};

const RSA_instance = RSA{
    .M_MEM0 = @ptrFromInt(0x6003c000),
    .M_MEM1 = @ptrFromInt(0x6003c004),
    .M_MEM2 = @ptrFromInt(0x6003c008),
    .M_MEM3 = @ptrFromInt(0x6003c00c),
    .M_MEM4 = @ptrFromInt(0x6003c010),
    .M_MEM5 = @ptrFromInt(0x6003c014),
    .M_MEM6 = @ptrFromInt(0x6003c018),
    .M_MEM7 = @ptrFromInt(0x6003c01c),
    .M_MEM8 = @ptrFromInt(0x6003c020),
    .M_MEM9 = @ptrFromInt(0x6003c024),
    .M_MEM10 = @ptrFromInt(0x6003c028),
    .M_MEM11 = @ptrFromInt(0x6003c02c),
    .M_MEM12 = @ptrFromInt(0x6003c030),
    .M_MEM13 = @ptrFromInt(0x6003c034),
    .M_MEM14 = @ptrFromInt(0x6003c038),
    .M_MEM15 = @ptrFromInt(0x6003c03c),
    .M_MEM16 = @ptrFromInt(0x6003c040),
    .M_MEM17 = @ptrFromInt(0x6003c044),
    .M_MEM18 = @ptrFromInt(0x6003c048),
    .M_MEM19 = @ptrFromInt(0x6003c04c),
    .M_MEM20 = @ptrFromInt(0x6003c050),
    .M_MEM21 = @ptrFromInt(0x6003c054),
    .M_MEM22 = @ptrFromInt(0x6003c058),
    .M_MEM23 = @ptrFromInt(0x6003c05c),
    .M_MEM24 = @ptrFromInt(0x6003c060),
    .M_MEM25 = @ptrFromInt(0x6003c064),
    .M_MEM26 = @ptrFromInt(0x6003c068),
    .M_MEM27 = @ptrFromInt(0x6003c06c),
    .M_MEM28 = @ptrFromInt(0x6003c070),
    .M_MEM29 = @ptrFromInt(0x6003c074),
    .M_MEM30 = @ptrFromInt(0x6003c078),
    .M_MEM31 = @ptrFromInt(0x6003c07c),
    .M_MEM32 = @ptrFromInt(0x6003c080),
    .M_MEM33 = @ptrFromInt(0x6003c084),
    .M_MEM34 = @ptrFromInt(0x6003c088),
    .M_MEM35 = @ptrFromInt(0x6003c08c),
    .M_MEM36 = @ptrFromInt(0x6003c090),
    .M_MEM37 = @ptrFromInt(0x6003c094),
    .M_MEM38 = @ptrFromInt(0x6003c098),
    .M_MEM39 = @ptrFromInt(0x6003c09c),
    .M_MEM40 = @ptrFromInt(0x6003c0a0),
    .M_MEM41 = @ptrFromInt(0x6003c0a4),
    .M_MEM42 = @ptrFromInt(0x6003c0a8),
    .M_MEM43 = @ptrFromInt(0x6003c0ac),
    .M_MEM44 = @ptrFromInt(0x6003c0b0),
    .M_MEM45 = @ptrFromInt(0x6003c0b4),
    .M_MEM46 = @ptrFromInt(0x6003c0b8),
    .M_MEM47 = @ptrFromInt(0x6003c0bc),
    .M_MEM48 = @ptrFromInt(0x6003c0c0),
    .M_MEM49 = @ptrFromInt(0x6003c0c4),
    .M_MEM50 = @ptrFromInt(0x6003c0c8),
    .M_MEM51 = @ptrFromInt(0x6003c0cc),
    .M_MEM52 = @ptrFromInt(0x6003c0d0),
    .M_MEM53 = @ptrFromInt(0x6003c0d4),
    .M_MEM54 = @ptrFromInt(0x6003c0d8),
    .M_MEM55 = @ptrFromInt(0x6003c0dc),
    .M_MEM56 = @ptrFromInt(0x6003c0e0),
    .M_MEM57 = @ptrFromInt(0x6003c0e4),
    .M_MEM58 = @ptrFromInt(0x6003c0e8),
    .M_MEM59 = @ptrFromInt(0x6003c0ec),
    .M_MEM60 = @ptrFromInt(0x6003c0f0),
    .M_MEM61 = @ptrFromInt(0x6003c0f4),
    .M_MEM62 = @ptrFromInt(0x6003c0f8),
    .M_MEM63 = @ptrFromInt(0x6003c0fc),
    .M_MEM64 = @ptrFromInt(0x6003c100),
    .M_MEM65 = @ptrFromInt(0x6003c104),
    .M_MEM66 = @ptrFromInt(0x6003c108),
    .M_MEM67 = @ptrFromInt(0x6003c10c),
    .M_MEM68 = @ptrFromInt(0x6003c110),
    .M_MEM69 = @ptrFromInt(0x6003c114),
    .M_MEM70 = @ptrFromInt(0x6003c118),
    .M_MEM71 = @ptrFromInt(0x6003c11c),
    .M_MEM72 = @ptrFromInt(0x6003c120),
    .M_MEM73 = @ptrFromInt(0x6003c124),
    .M_MEM74 = @ptrFromInt(0x6003c128),
    .M_MEM75 = @ptrFromInt(0x6003c12c),
    .M_MEM76 = @ptrFromInt(0x6003c130),
    .M_MEM77 = @ptrFromInt(0x6003c134),
    .M_MEM78 = @ptrFromInt(0x6003c138),
    .M_MEM79 = @ptrFromInt(0x6003c13c),
    .M_MEM80 = @ptrFromInt(0x6003c140),
    .M_MEM81 = @ptrFromInt(0x6003c144),
    .M_MEM82 = @ptrFromInt(0x6003c148),
    .M_MEM83 = @ptrFromInt(0x6003c14c),
    .M_MEM84 = @ptrFromInt(0x6003c150),
    .M_MEM85 = @ptrFromInt(0x6003c154),
    .M_MEM86 = @ptrFromInt(0x6003c158),
    .M_MEM87 = @ptrFromInt(0x6003c15c),
    .M_MEM88 = @ptrFromInt(0x6003c160),
    .M_MEM89 = @ptrFromInt(0x6003c164),
    .M_MEM90 = @ptrFromInt(0x6003c168),
    .M_MEM91 = @ptrFromInt(0x6003c16c),
    .M_MEM92 = @ptrFromInt(0x6003c170),
    .M_MEM93 = @ptrFromInt(0x6003c174),
    .M_MEM94 = @ptrFromInt(0x6003c178),
    .M_MEM95 = @ptrFromInt(0x6003c17c),
    .Z_MEM0 = @ptrFromInt(0x6003c200),
    .Z_MEM1 = @ptrFromInt(0x6003c204),
    .Z_MEM2 = @ptrFromInt(0x6003c208),
    .Z_MEM3 = @ptrFromInt(0x6003c20c),
    .Z_MEM4 = @ptrFromInt(0x6003c210),
    .Z_MEM5 = @ptrFromInt(0x6003c214),
    .Z_MEM6 = @ptrFromInt(0x6003c218),
    .Z_MEM7 = @ptrFromInt(0x6003c21c),
    .Z_MEM8 = @ptrFromInt(0x6003c220),
    .Z_MEM9 = @ptrFromInt(0x6003c224),
    .Z_MEM10 = @ptrFromInt(0x6003c228),
    .Z_MEM11 = @ptrFromInt(0x6003c22c),
    .Z_MEM12 = @ptrFromInt(0x6003c230),
    .Z_MEM13 = @ptrFromInt(0x6003c234),
    .Z_MEM14 = @ptrFromInt(0x6003c238),
    .Z_MEM15 = @ptrFromInt(0x6003c23c),
    .Z_MEM16 = @ptrFromInt(0x6003c240),
    .Z_MEM17 = @ptrFromInt(0x6003c244),
    .Z_MEM18 = @ptrFromInt(0x6003c248),
    .Z_MEM19 = @ptrFromInt(0x6003c24c),
    .Z_MEM20 = @ptrFromInt(0x6003c250),
    .Z_MEM21 = @ptrFromInt(0x6003c254),
    .Z_MEM22 = @ptrFromInt(0x6003c258),
    .Z_MEM23 = @ptrFromInt(0x6003c25c),
    .Z_MEM24 = @ptrFromInt(0x6003c260),
    .Z_MEM25 = @ptrFromInt(0x6003c264),
    .Z_MEM26 = @ptrFromInt(0x6003c268),
    .Z_MEM27 = @ptrFromInt(0x6003c26c),
    .Z_MEM28 = @ptrFromInt(0x6003c270),
    .Z_MEM29 = @ptrFromInt(0x6003c274),
    .Z_MEM30 = @ptrFromInt(0x6003c278),
    .Z_MEM31 = @ptrFromInt(0x6003c27c),
    .Z_MEM32 = @ptrFromInt(0x6003c280),
    .Z_MEM33 = @ptrFromInt(0x6003c284),
    .Z_MEM34 = @ptrFromInt(0x6003c288),
    .Z_MEM35 = @ptrFromInt(0x6003c28c),
    .Z_MEM36 = @ptrFromInt(0x6003c290),
    .Z_MEM37 = @ptrFromInt(0x6003c294),
    .Z_MEM38 = @ptrFromInt(0x6003c298),
    .Z_MEM39 = @ptrFromInt(0x6003c29c),
    .Z_MEM40 = @ptrFromInt(0x6003c2a0),
    .Z_MEM41 = @ptrFromInt(0x6003c2a4),
    .Z_MEM42 = @ptrFromInt(0x6003c2a8),
    .Z_MEM43 = @ptrFromInt(0x6003c2ac),
    .Z_MEM44 = @ptrFromInt(0x6003c2b0),
    .Z_MEM45 = @ptrFromInt(0x6003c2b4),
    .Z_MEM46 = @ptrFromInt(0x6003c2b8),
    .Z_MEM47 = @ptrFromInt(0x6003c2bc),
    .Z_MEM48 = @ptrFromInt(0x6003c2c0),
    .Z_MEM49 = @ptrFromInt(0x6003c2c4),
    .Z_MEM50 = @ptrFromInt(0x6003c2c8),
    .Z_MEM51 = @ptrFromInt(0x6003c2cc),
    .Z_MEM52 = @ptrFromInt(0x6003c2d0),
    .Z_MEM53 = @ptrFromInt(0x6003c2d4),
    .Z_MEM54 = @ptrFromInt(0x6003c2d8),
    .Z_MEM55 = @ptrFromInt(0x6003c2dc),
    .Z_MEM56 = @ptrFromInt(0x6003c2e0),
    .Z_MEM57 = @ptrFromInt(0x6003c2e4),
    .Z_MEM58 = @ptrFromInt(0x6003c2e8),
    .Z_MEM59 = @ptrFromInt(0x6003c2ec),
    .Z_MEM60 = @ptrFromInt(0x6003c2f0),
    .Z_MEM61 = @ptrFromInt(0x6003c2f4),
    .Z_MEM62 = @ptrFromInt(0x6003c2f8),
    .Z_MEM63 = @ptrFromInt(0x6003c2fc),
    .Z_MEM64 = @ptrFromInt(0x6003c300),
    .Z_MEM65 = @ptrFromInt(0x6003c304),
    .Z_MEM66 = @ptrFromInt(0x6003c308),
    .Z_MEM67 = @ptrFromInt(0x6003c30c),
    .Z_MEM68 = @ptrFromInt(0x6003c310),
    .Z_MEM69 = @ptrFromInt(0x6003c314),
    .Z_MEM70 = @ptrFromInt(0x6003c318),
    .Z_MEM71 = @ptrFromInt(0x6003c31c),
    .Z_MEM72 = @ptrFromInt(0x6003c320),
    .Z_MEM73 = @ptrFromInt(0x6003c324),
    .Z_MEM74 = @ptrFromInt(0x6003c328),
    .Z_MEM75 = @ptrFromInt(0x6003c32c),
    .Z_MEM76 = @ptrFromInt(0x6003c330),
    .Z_MEM77 = @ptrFromInt(0x6003c334),
    .Z_MEM78 = @ptrFromInt(0x6003c338),
    .Z_MEM79 = @ptrFromInt(0x6003c33c),
    .Z_MEM80 = @ptrFromInt(0x6003c340),
    .Z_MEM81 = @ptrFromInt(0x6003c344),
    .Z_MEM82 = @ptrFromInt(0x6003c348),
    .Z_MEM83 = @ptrFromInt(0x6003c34c),
    .Z_MEM84 = @ptrFromInt(0x6003c350),
    .Z_MEM85 = @ptrFromInt(0x6003c354),
    .Z_MEM86 = @ptrFromInt(0x6003c358),
    .Z_MEM87 = @ptrFromInt(0x6003c35c),
    .Z_MEM88 = @ptrFromInt(0x6003c360),
    .Z_MEM89 = @ptrFromInt(0x6003c364),
    .Z_MEM90 = @ptrFromInt(0x6003c368),
    .Z_MEM91 = @ptrFromInt(0x6003c36c),
    .Z_MEM92 = @ptrFromInt(0x6003c370),
    .Z_MEM93 = @ptrFromInt(0x6003c374),
    .Z_MEM94 = @ptrFromInt(0x6003c378),
    .Z_MEM95 = @ptrFromInt(0x6003c37c),
    .Y_MEM0 = @ptrFromInt(0x6003c400),
    .Y_MEM1 = @ptrFromInt(0x6003c404),
    .Y_MEM2 = @ptrFromInt(0x6003c408),
    .Y_MEM3 = @ptrFromInt(0x6003c40c),
    .Y_MEM4 = @ptrFromInt(0x6003c410),
    .Y_MEM5 = @ptrFromInt(0x6003c414),
    .Y_MEM6 = @ptrFromInt(0x6003c418),
    .Y_MEM7 = @ptrFromInt(0x6003c41c),
    .Y_MEM8 = @ptrFromInt(0x6003c420),
    .Y_MEM9 = @ptrFromInt(0x6003c424),
    .Y_MEM10 = @ptrFromInt(0x6003c428),
    .Y_MEM11 = @ptrFromInt(0x6003c42c),
    .Y_MEM12 = @ptrFromInt(0x6003c430),
    .Y_MEM13 = @ptrFromInt(0x6003c434),
    .Y_MEM14 = @ptrFromInt(0x6003c438),
    .Y_MEM15 = @ptrFromInt(0x6003c43c),
    .Y_MEM16 = @ptrFromInt(0x6003c440),
    .Y_MEM17 = @ptrFromInt(0x6003c444),
    .Y_MEM18 = @ptrFromInt(0x6003c448),
    .Y_MEM19 = @ptrFromInt(0x6003c44c),
    .Y_MEM20 = @ptrFromInt(0x6003c450),
    .Y_MEM21 = @ptrFromInt(0x6003c454),
    .Y_MEM22 = @ptrFromInt(0x6003c458),
    .Y_MEM23 = @ptrFromInt(0x6003c45c),
    .Y_MEM24 = @ptrFromInt(0x6003c460),
    .Y_MEM25 = @ptrFromInt(0x6003c464),
    .Y_MEM26 = @ptrFromInt(0x6003c468),
    .Y_MEM27 = @ptrFromInt(0x6003c46c),
    .Y_MEM28 = @ptrFromInt(0x6003c470),
    .Y_MEM29 = @ptrFromInt(0x6003c474),
    .Y_MEM30 = @ptrFromInt(0x6003c478),
    .Y_MEM31 = @ptrFromInt(0x6003c47c),
    .Y_MEM32 = @ptrFromInt(0x6003c480),
    .Y_MEM33 = @ptrFromInt(0x6003c484),
    .Y_MEM34 = @ptrFromInt(0x6003c488),
    .Y_MEM35 = @ptrFromInt(0x6003c48c),
    .Y_MEM36 = @ptrFromInt(0x6003c490),
    .Y_MEM37 = @ptrFromInt(0x6003c494),
    .Y_MEM38 = @ptrFromInt(0x6003c498),
    .Y_MEM39 = @ptrFromInt(0x6003c49c),
    .Y_MEM40 = @ptrFromInt(0x6003c4a0),
    .Y_MEM41 = @ptrFromInt(0x6003c4a4),
    .Y_MEM42 = @ptrFromInt(0x6003c4a8),
    .Y_MEM43 = @ptrFromInt(0x6003c4ac),
    .Y_MEM44 = @ptrFromInt(0x6003c4b0),
    .Y_MEM45 = @ptrFromInt(0x6003c4b4),
    .Y_MEM46 = @ptrFromInt(0x6003c4b8),
    .Y_MEM47 = @ptrFromInt(0x6003c4bc),
    .Y_MEM48 = @ptrFromInt(0x6003c4c0),
    .Y_MEM49 = @ptrFromInt(0x6003c4c4),
    .Y_MEM50 = @ptrFromInt(0x6003c4c8),
    .Y_MEM51 = @ptrFromInt(0x6003c4cc),
    .Y_MEM52 = @ptrFromInt(0x6003c4d0),
    .Y_MEM53 = @ptrFromInt(0x6003c4d4),
    .Y_MEM54 = @ptrFromInt(0x6003c4d8),
    .Y_MEM55 = @ptrFromInt(0x6003c4dc),
    .Y_MEM56 = @ptrFromInt(0x6003c4e0),
    .Y_MEM57 = @ptrFromInt(0x6003c4e4),
    .Y_MEM58 = @ptrFromInt(0x6003c4e8),
    .Y_MEM59 = @ptrFromInt(0x6003c4ec),
    .Y_MEM60 = @ptrFromInt(0x6003c4f0),
    .Y_MEM61 = @ptrFromInt(0x6003c4f4),
    .Y_MEM62 = @ptrFromInt(0x6003c4f8),
    .Y_MEM63 = @ptrFromInt(0x6003c4fc),
    .Y_MEM64 = @ptrFromInt(0x6003c500),
    .Y_MEM65 = @ptrFromInt(0x6003c504),
    .Y_MEM66 = @ptrFromInt(0x6003c508),
    .Y_MEM67 = @ptrFromInt(0x6003c50c),
    .Y_MEM68 = @ptrFromInt(0x6003c510),
    .Y_MEM69 = @ptrFromInt(0x6003c514),
    .Y_MEM70 = @ptrFromInt(0x6003c518),
    .Y_MEM71 = @ptrFromInt(0x6003c51c),
    .Y_MEM72 = @ptrFromInt(0x6003c520),
    .Y_MEM73 = @ptrFromInt(0x6003c524),
    .Y_MEM74 = @ptrFromInt(0x6003c528),
    .Y_MEM75 = @ptrFromInt(0x6003c52c),
    .Y_MEM76 = @ptrFromInt(0x6003c530),
    .Y_MEM77 = @ptrFromInt(0x6003c534),
    .Y_MEM78 = @ptrFromInt(0x6003c538),
    .Y_MEM79 = @ptrFromInt(0x6003c53c),
    .Y_MEM80 = @ptrFromInt(0x6003c540),
    .Y_MEM81 = @ptrFromInt(0x6003c544),
    .Y_MEM82 = @ptrFromInt(0x6003c548),
    .Y_MEM83 = @ptrFromInt(0x6003c54c),
    .Y_MEM84 = @ptrFromInt(0x6003c550),
    .Y_MEM85 = @ptrFromInt(0x6003c554),
    .Y_MEM86 = @ptrFromInt(0x6003c558),
    .Y_MEM87 = @ptrFromInt(0x6003c55c),
    .Y_MEM88 = @ptrFromInt(0x6003c560),
    .Y_MEM89 = @ptrFromInt(0x6003c564),
    .Y_MEM90 = @ptrFromInt(0x6003c568),
    .Y_MEM91 = @ptrFromInt(0x6003c56c),
    .Y_MEM92 = @ptrFromInt(0x6003c570),
    .Y_MEM93 = @ptrFromInt(0x6003c574),
    .Y_MEM94 = @ptrFromInt(0x6003c578),
    .Y_MEM95 = @ptrFromInt(0x6003c57c),
    .X_MEM0 = @ptrFromInt(0x6003c600),
    .X_MEM1 = @ptrFromInt(0x6003c604),
    .X_MEM2 = @ptrFromInt(0x6003c608),
    .X_MEM3 = @ptrFromInt(0x6003c60c),
    .X_MEM4 = @ptrFromInt(0x6003c610),
    .X_MEM5 = @ptrFromInt(0x6003c614),
    .X_MEM6 = @ptrFromInt(0x6003c618),
    .X_MEM7 = @ptrFromInt(0x6003c61c),
    .X_MEM8 = @ptrFromInt(0x6003c620),
    .X_MEM9 = @ptrFromInt(0x6003c624),
    .X_MEM10 = @ptrFromInt(0x6003c628),
    .X_MEM11 = @ptrFromInt(0x6003c62c),
    .X_MEM12 = @ptrFromInt(0x6003c630),
    .X_MEM13 = @ptrFromInt(0x6003c634),
    .X_MEM14 = @ptrFromInt(0x6003c638),
    .X_MEM15 = @ptrFromInt(0x6003c63c),
    .X_MEM16 = @ptrFromInt(0x6003c640),
    .X_MEM17 = @ptrFromInt(0x6003c644),
    .X_MEM18 = @ptrFromInt(0x6003c648),
    .X_MEM19 = @ptrFromInt(0x6003c64c),
    .X_MEM20 = @ptrFromInt(0x6003c650),
    .X_MEM21 = @ptrFromInt(0x6003c654),
    .X_MEM22 = @ptrFromInt(0x6003c658),
    .X_MEM23 = @ptrFromInt(0x6003c65c),
    .X_MEM24 = @ptrFromInt(0x6003c660),
    .X_MEM25 = @ptrFromInt(0x6003c664),
    .X_MEM26 = @ptrFromInt(0x6003c668),
    .X_MEM27 = @ptrFromInt(0x6003c66c),
    .X_MEM28 = @ptrFromInt(0x6003c670),
    .X_MEM29 = @ptrFromInt(0x6003c674),
    .X_MEM30 = @ptrFromInt(0x6003c678),
    .X_MEM31 = @ptrFromInt(0x6003c67c),
    .X_MEM32 = @ptrFromInt(0x6003c680),
    .X_MEM33 = @ptrFromInt(0x6003c684),
    .X_MEM34 = @ptrFromInt(0x6003c688),
    .X_MEM35 = @ptrFromInt(0x6003c68c),
    .X_MEM36 = @ptrFromInt(0x6003c690),
    .X_MEM37 = @ptrFromInt(0x6003c694),
    .X_MEM38 = @ptrFromInt(0x6003c698),
    .X_MEM39 = @ptrFromInt(0x6003c69c),
    .X_MEM40 = @ptrFromInt(0x6003c6a0),
    .X_MEM41 = @ptrFromInt(0x6003c6a4),
    .X_MEM42 = @ptrFromInt(0x6003c6a8),
    .X_MEM43 = @ptrFromInt(0x6003c6ac),
    .X_MEM44 = @ptrFromInt(0x6003c6b0),
    .X_MEM45 = @ptrFromInt(0x6003c6b4),
    .X_MEM46 = @ptrFromInt(0x6003c6b8),
    .X_MEM47 = @ptrFromInt(0x6003c6bc),
    .X_MEM48 = @ptrFromInt(0x6003c6c0),
    .X_MEM49 = @ptrFromInt(0x6003c6c4),
    .X_MEM50 = @ptrFromInt(0x6003c6c8),
    .X_MEM51 = @ptrFromInt(0x6003c6cc),
    .X_MEM52 = @ptrFromInt(0x6003c6d0),
    .X_MEM53 = @ptrFromInt(0x6003c6d4),
    .X_MEM54 = @ptrFromInt(0x6003c6d8),
    .X_MEM55 = @ptrFromInt(0x6003c6dc),
    .X_MEM56 = @ptrFromInt(0x6003c6e0),
    .X_MEM57 = @ptrFromInt(0x6003c6e4),
    .X_MEM58 = @ptrFromInt(0x6003c6e8),
    .X_MEM59 = @ptrFromInt(0x6003c6ec),
    .X_MEM60 = @ptrFromInt(0x6003c6f0),
    .X_MEM61 = @ptrFromInt(0x6003c6f4),
    .X_MEM62 = @ptrFromInt(0x6003c6f8),
    .X_MEM63 = @ptrFromInt(0x6003c6fc),
    .X_MEM64 = @ptrFromInt(0x6003c700),
    .X_MEM65 = @ptrFromInt(0x6003c704),
    .X_MEM66 = @ptrFromInt(0x6003c708),
    .X_MEM67 = @ptrFromInt(0x6003c70c),
    .X_MEM68 = @ptrFromInt(0x6003c710),
    .X_MEM69 = @ptrFromInt(0x6003c714),
    .X_MEM70 = @ptrFromInt(0x6003c718),
    .X_MEM71 = @ptrFromInt(0x6003c71c),
    .X_MEM72 = @ptrFromInt(0x6003c720),
    .X_MEM73 = @ptrFromInt(0x6003c724),
    .X_MEM74 = @ptrFromInt(0x6003c728),
    .X_MEM75 = @ptrFromInt(0x6003c72c),
    .X_MEM76 = @ptrFromInt(0x6003c730),
    .X_MEM77 = @ptrFromInt(0x6003c734),
    .X_MEM78 = @ptrFromInt(0x6003c738),
    .X_MEM79 = @ptrFromInt(0x6003c73c),
    .X_MEM80 = @ptrFromInt(0x6003c740),
    .X_MEM81 = @ptrFromInt(0x6003c744),
    .X_MEM82 = @ptrFromInt(0x6003c748),
    .X_MEM83 = @ptrFromInt(0x6003c74c),
    .X_MEM84 = @ptrFromInt(0x6003c750),
    .X_MEM85 = @ptrFromInt(0x6003c754),
    .X_MEM86 = @ptrFromInt(0x6003c758),
    .X_MEM87 = @ptrFromInt(0x6003c75c),
    .X_MEM88 = @ptrFromInt(0x6003c760),
    .X_MEM89 = @ptrFromInt(0x6003c764),
    .X_MEM90 = @ptrFromInt(0x6003c768),
    .X_MEM91 = @ptrFromInt(0x6003c76c),
    .X_MEM92 = @ptrFromInt(0x6003c770),
    .X_MEM93 = @ptrFromInt(0x6003c774),
    .X_MEM94 = @ptrFromInt(0x6003c778),
    .X_MEM95 = @ptrFromInt(0x6003c77c),
...
const RTC_CNTL = struct {
    ...
    OPTIONS0: *volatile RTC_CNTL_OPTIONS0,
    /// rtc configure register
    SLP_TIMER0: *volatile RTC_CNTL_SLP_TIMER0,
    /// rtc configure register
    SLP_TIMER1: *volatile RTC_CNTL_SLP_TIMER1,
    /// rtc configure register
    TIME_UPDATE: *volatile RTC_CNTL_TIME_UPDATE,
    /// rtc configure register
    TIME_LOW0: *volatile RTC_CNTL_TIME_LOW0,
    /// rtc configure register
    TIME_HIGH0: *volatile RTC_CNTL_TIME_HIGH0,
    /// rtc configure register
    STATE0: *volatile RTC_CNTL_STATE0,
    /// rtc configure register
    TIMER1: *volatile RTC_CNTL_TIMER1,
    /// rtc configure register
    TIMER2: *volatile RTC_CNTL_TIMER2,
    /// rtc configure register
    TIMER3: *volatile RTC_CNTL_TIMER3,
    /// rtc configure register
    TIMER4: *volatile RTC_CNTL_TIMER4,
    /// rtc configure register
    TIMER5: *volatile RTC_CNTL_TIMER5,
    /// rtc configure register
    TIMER6: *volatile RTC_CNTL_TIMER6,
    /// rtc configure register
    ANA_CONF: *volatile RTC_CNTL_ANA_CONF,
    /// rtc configure register
    RESET_STATE: *volatile RTC_CNTL_RESET_STATE,
    /// rtc configure register
    WAKEUP_STATE: *volatile RTC_CNTL_WAKEUP_STATE,
    /// rtc configure register
    INT_ENA_RTC: *volatile RTC_CNTL_INT_ENA_RTC,
    /// rtc configure register
    INT_RAW_RTC: *volatile RTC_CNTL_INT_RAW_RTC,
    /// rtc configure register
    INT_ST_RTC: *volatile RTC_CNTL_INT_ST_RTC,
    /// rtc configure register
    INT_CLR_RTC: *volatile RTC_CNTL_INT_CLR_RTC,
    /// rtc configure register
    STORE0: *volatile RTC_CNTL_STORE0,
    /// rtc configure register
    STORE1: *volatile RTC_CNTL_STORE1,
    /// rtc configure register
    STORE2: *volatile RTC_CNTL_STORE2,
    /// rtc configure register
    STORE3: *volatile RTC_CNTL_STORE3,
    /// rtc configure register
    EXT_XTL_CONF: *volatile RTC_CNTL_EXT_XTL_CONF,
    /// rtc configure register
    EXT_WAKEUP_CONF: *volatile RTC_CNTL_EXT_WAKEUP_CONF,
    /// rtc configure register
    SLP_REJECT_CONF: *volatile RTC_CNTL_SLP_REJECT_CONF,
    /// rtc configure register
    CPU_PERIOD_CONF: *volatile RTC_CNTL_CPU_PERIOD_CONF,
    /// rtc configure register
    CLK_CONF: *volatile RTC_CNTL_CLK_CONF,
    /// rtc configure register
    SLOW_CLK_CONF: *volatile RTC_CNTL_SLOW_CLK_CONF,
    /// rtc configure register
    SDIO_CONF: *volatile RTC_CNTL_SDIO_CONF,
    /// rtc configure register
    BIAS_CONF: *volatile RTC_CNTL_BIAS_CONF,
    /// rtc configure register
    RTC_CNTL: *volatile RTC_CNTL_RTC_CNTL,
    /// rtc configure register
    PWC: *volatile RTC_CNTL_PWC,
    /// rtc configure register
    DIG_PWC: *volatile RTC_CNTL_DIG_PWC,
    /// rtc configure register
    DIG_ISO: *volatile RTC_CNTL_DIG_ISO,
    /// rtc configure register
    WDTCONFIG0: *volatile RTC_CNTL_WDTCONFIG0,
    /// rtc configure register
    WDTCONFIG1: *volatile RTC_CNTL_WDTCONFIG1,
    /// rtc configure register
    WDTCONFIG2: *volatile RTC_CNTL_WDTCONFIG2,
    /// rtc configure register
    WDTCONFIG3: *volatile RTC_CNTL_WDTCONFIG3,
    /// rtc configure register
    WDTCONFIG4: *volatile RTC_CNTL_WDTCONFIG4,
    /// rtc configure register
    WDTFEED: *volatile RTC_CNTL_WDTFEED,
    /// rtc configure register
    WDTWPROTECT: *volatile RTC_CNTL_WDTWPROTECT,
    /// rtc configure register
    SWD_CONF: *volatile RTC_CNTL_SWD_CONF,
    /// rtc configure register
    SWD_WPROTECT: *volatile RTC_CNTL_SWD_WPROTECT,
    /// rtc configure register
    SW_CPU_STALL: *volatile RTC_CNTL_SW_CPU_STALL,
    /// rtc configure register
    STORE4: *volatile RTC_CNTL_STORE4,
    /// rtc configure register
    STORE5: *volatile RTC_CNTL_STORE5,
    /// rtc configure register
    STORE6: *volatile RTC_CNTL_STORE6,
    /// rtc configure register
    STORE7: *volatile RTC_CNTL_STORE7,
    /// rtc configure register
    LOW_POWER_ST: *volatile RTC_CNTL_LOW_POWER_ST,
    /// rtc configure register
    DIAG0: *volatile RTC_CNTL_DIAG0,
    /// rtc configure register
    PAD_HOLD: *volatile RTC_CNTL_PAD_HOLD,
    /// rtc configure register
    DIG_PAD_HOLD: *volatile RTC_CNTL_DIG_PAD_HOLD,
    /// rtc configure register
    BROWN_OUT: *volatile RTC_CNTL_BROWN_OUT,
    /// rtc configure register
    TIME_LOW1: *volatile RTC_CNTL_TIME_LOW1,
    /// rtc configure register
    TIME_HIGH1: *volatile RTC_CNTL_TIME_HIGH1,
    /// rtc configure register
    XTAL32K_CLK_FACTOR: *volatile RTC_CNTL_XTAL32K_CLK_FACTOR,
    /// rtc configure register
    XTAL32K_CONF: *volatile RTC_CNTL_XTAL32K_CONF,
    /// rtc configure register
    USB_CONF: *volatile RTC_CNTL_USB_CONF,
    /// RTC_CNTL_RTC_SLP_REJECT_CAUSE_REG
    SLP_REJECT_CAUSE: *volatile RTC_CNTL_SLP_REJECT_CAUSE,
    /// rtc configure register
    OPTION1: *volatile RTC_CNTL_OPTION1,
    /// RTC_CNTL_RTC_SLP_WAKEUP_CAUSE_REG
    SLP_WAKEUP_CAUSE: *volatile RTC_CNTL_SLP_WAKEUP_CAUSE,
    /// rtc configure register
    ULP_CP_TIMER_1: *volatile RTC_CNTL_ULP_CP_TIMER_1,
    /// rtc configure register
    INT_ENA_RTC_W1TS: *volatile RTC_CNTL_INT_ENA_RTC_W1TS,
    /// rtc configure register
    INT_ENA_RTC_W1TC: *volatile RTC_CNTL_INT_ENA_RTC_W1TC,
    /// rtc configure register
    RETENTION_CTRL: *volatile RTC_CNTL_RETENTION_CTRL,
    /// rtc configure register
    FIB_SEL: *volatile RTC_CNTL_FIB_SEL,
    /// rtc configure register
    GPIO_WAKEUP: *volatile RTC_CNTL_GPIO_WAKEUP,
    /// rtc configure register
    DBG_SEL: *volatile RTC_CNTL_DBG_SEL,
    /// rtc configure register
    DBG_MAP: *volatile RTC_CNTL_DBG_MAP,
    /// rtc configure register
    SENSOR_CTRL: *volatile RTC_CNTL_SENSOR_CTRL,
    /// rtc configure register
    DBG_SAR_SEL: *volatile RTC_CNTL_DBG_SAR_SEL,
    /// rtc configure register
    PG_CTRL: *volatile RTC_CNTL_PG_CTRL,
    /// rtc configure register
    DATE: *volatile RTC_CNTL_DATE,
};
...
const SENSITIVE = struct {
    ...
    ROM_TABLE_LOCK: *volatile SENSITIVE_ROM_TABLE_LOCK,
    /// SENSITIVE_ROM_TABLE_REG
    ROM_TABLE: *volatile SENSITIVE_ROM_TABLE,
    /// SENSITIVE_PRIVILEGE_MODE_SEL_LOCK_REG
    PRIVILEGE_MODE_SEL_LOCK: *volatile SENSITIVE_PRIVILEGE_MODE_SEL_LOCK,
    /// SENSITIVE_PRIVILEGE_MODE_SEL_REG
    PRIVILEGE_MODE_SEL: *volatile SENSITIVE_PRIVILEGE_MODE_SEL,
    /// SENSITIVE_APB_PERIPHERAL_ACCESS_0_REG
    APB_PERIPHERAL_ACCESS_0: *volatile SENSITIVE_APB_PERIPHERAL_ACCESS_0,
    /// SENSITIVE_APB_PERIPHERAL_ACCESS_1_REG
    APB_PERIPHERAL_ACCESS_1: *volatile SENSITIVE_APB_PERIPHERAL_ACCESS_1,
    /// SENSITIVE_INTERNAL_SRAM_USAGE_0_REG
    INTERNAL_SRAM_USAGE_0: *volatile SENSITIVE_INTERNAL_SRAM_USAGE_0,
    /// SENSITIVE_INTERNAL_SRAM_USAGE_1_REG
    INTERNAL_SRAM_USAGE_1: *volatile SENSITIVE_INTERNAL_SRAM_USAGE_1,
    /// SENSITIVE_INTERNAL_SRAM_USAGE_3_REG
    INTERNAL_SRAM_USAGE_3: *volatile SENSITIVE_INTERNAL_SRAM_USAGE_3,
    /// SENSITIVE_INTERNAL_SRAM_USAGE_4_REG
    INTERNAL_SRAM_USAGE_4: *volatile SENSITIVE_INTERNAL_SRAM_USAGE_4,
    /// SENSITIVE_CACHE_TAG_ACCESS_0_REG
    CACHE_TAG_ACCESS_0: *volatile SENSITIVE_CACHE_TAG_ACCESS_0,
    /// SENSITIVE_CACHE_TAG_ACCESS_1_REG
    CACHE_TAG_ACCESS_1: *volatile SENSITIVE_CACHE_TAG_ACCESS_1,
    /// SENSITIVE_CACHE_MMU_ACCESS_0_REG
    CACHE_MMU_ACCESS_0: *volatile SENSITIVE_CACHE_MMU_ACCESS_0,
    /// SENSITIVE_CACHE_MMU_ACCESS_1_REG
    CACHE_MMU_ACCESS_1: *volatile SENSITIVE_CACHE_MMU_ACCESS_1,
    /// SENSITIVE_DMA_APBPERI_SPI2_PMS_CONSTRAIN_0_REG
    DMA_APBPERI_SPI2_PMS_CONSTRAIN_0: *volatile SENSITIVE_DMA_APBPERI_SPI2_PMS_CONSTRAIN_0,
    /// SENSITIVE_DMA_APBPERI_SPI2_PMS_CONSTRAIN_1_REG
    DMA_APBPERI_SPI2_PMS_CONSTRAIN_1: *volatile SENSITIVE_DMA_APBPERI_SPI2_PMS_CONSTRAIN_1,
    /// SENSITIVE_DMA_APBPERI_UCHI0_PMS_CONSTRAIN_0_REG
    DMA_APBPERI_UCHI0_PMS_CONSTRAIN_0: *volatile SENSITIVE_DMA_APBPERI_UCHI0_PMS_CONSTRAIN_0,
    /// SENSITIVE_DMA_APBPERI_UCHI0_PMS_CONSTRAIN_1_REG
    DMA_APBPERI_UCHI0_PMS_CONSTRAIN_1: *volatile SENSITIVE_DMA_APBPERI_UCHI0_PMS_CONSTRAIN_1,
    /// SENSITIVE_DMA_APBPERI_I2S0_PMS_CONSTRAIN_0_REG
    DMA_APBPERI_I2S0_PMS_CONSTRAIN_0: *volatile SENSITIVE_DMA_APBPERI_I2S0_PMS_CONSTRAIN_0,
    /// SENSITIVE_DMA_APBPERI_I2S0_PMS_CONSTRAIN_1_REG
    DMA_APBPERI_I2S0_PMS_CONSTRAIN_1: *volatile SENSITIVE_DMA_APBPERI_I2S0_PMS_CONSTRAIN_1,
    /// SENSITIVE_DMA_APBPERI_MAC_PMS_CONSTRAIN_0_REG
    DMA_APBPERI_MAC_PMS_CONSTRAIN_0: *volatile SENSITIVE_DMA_APBPERI_MAC_PMS_CONSTRAIN_0,
    /// SENSITIVE_DMA_APBPERI_MAC_PMS_CONSTRAIN_1_REG
    DMA_APBPERI_MAC_PMS_CONSTRAIN_1: *volatile SENSITIVE_DMA_APBPERI_MAC_PMS_CONSTRAIN_1,
    /// SENSITIVE_DMA_APBPERI_BACKUP_PMS_CONSTRAIN_0_REG
    DMA_APBPERI_BACKUP_PMS_CONSTRAIN_0: *volatile SENSITIVE_DMA_APBPERI_BACKUP_PMS_CONSTRAIN_0,
    /// SENSITIVE_DMA_APBPERI_BACKUP_PMS_CONSTRAIN_1_REG
    DMA_APBPERI_BACKUP_PMS_CONSTRAIN_1: *volatile SENSITIVE_DMA_APBPERI_BACKUP_PMS_CONSTRAIN_1,
    /// SENSITIVE_DMA_APBPERI_LC_PMS_CONSTRAIN_0_REG
    DMA_APBPERI_LC_PMS_CONSTRAIN_0: *volatile SENSITIVE_DMA_APBPERI_LC_PMS_CONSTRAIN_0,
    /// SENSITIVE_DMA_APBPERI_LC_PMS_CONSTRAIN_1_REG
    DMA_APBPERI_LC_PMS_CONSTRAIN_1: *volatile SENSITIVE_DMA_APBPERI_LC_PMS_CONSTRAIN_1,
    /// SENSITIVE_DMA_APBPERI_AES_PMS_CONSTRAIN_0_REG
    DMA_APBPERI_AES_PMS_CONSTRAIN_0: *volatile SENSITIVE_DMA_APBPERI_AES_PMS_CONSTRAIN_0,
    /// SENSITIVE_DMA_APBPERI_AES_PMS_CONSTRAIN_1_REG
    DMA_APBPERI_AES_PMS_CONSTRAIN_1: *volatile SENSITIVE_DMA_APBPERI_AES_PMS_CONSTRAIN_1,
    /// SENSITIVE_DMA_APBPERI_SHA_PMS_CONSTRAIN_0_REG
    DMA_APBPERI_SHA_PMS_CONSTRAIN_0: *volatile SENSITIVE_DMA_APBPERI_SHA_PMS_CONSTRAIN_0,
    /// SENSITIVE_DMA_APBPERI_SHA_PMS_CONSTRAIN_1_REG
    DMA_APBPERI_SHA_PMS_CONSTRAIN_1: *volatile SENSITIVE_DMA_APBPERI_SHA_PMS_CONSTRAIN_1,
    /// SENSITIVE_DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_0_REG
    DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_0: *volatile SENSITIVE_DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_0,
    /// SENSITIVE_DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_1_REG
    DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_1: *volatile SENSITIVE_DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_1,
    /// SENSITIVE_DMA_APBPERI_PMS_MONITOR_0_REG
    DMA_APBPERI_PMS_MONITOR_0: *volatile SENSITIVE_DMA_APBPERI_PMS_MONITOR_0,
    /// SENSITIVE_DMA_APBPERI_PMS_MONITOR_1_REG
    DMA_APBPERI_PMS_MONITOR_1: *volatile SENSITIVE_DMA_APBPERI_PMS_MONITOR_1,
    /// SENSITIVE_DMA_APBPERI_PMS_MONITOR_2_REG
    DMA_APBPERI_PMS_MONITOR_2: *volatile SENSITIVE_DMA_APBPERI_PMS_MONITOR_2,
    /// SENSITIVE_DMA_APBPERI_PMS_MONITOR_3_REG
    DMA_APBPERI_PMS_MONITOR_3: *volatile SENSITIVE_DMA_APBPERI_PMS_MONITOR_3,
    /// SENSITIVE_CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_0_REG
    CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_0: *volatile SENSITIVE_CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_0,
    /// SENSITIVE_CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_1_REG
    CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_1: *volatile SENSITIVE_CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_1,
    /// SENSITIVE_CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_2_REG
    CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_2: *volatile SENSITIVE_CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_2,
    /// SENSITIVE_CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_3_REG
    CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_3: *volatile SENSITIVE_CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_3,
    /// SENSITIVE_CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_4_REG
    CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_4: *volatile SENSITIVE_CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_4,
    /// SENSITIVE_CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_5_REG
    CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_5: *volatile SENSITIVE_CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_5,
    /// SENSITIVE_CORE_X_IRAM0_PMS_CONSTRAIN_0_REG
    CORE_X_IRAM0_PMS_CONSTRAIN_0: *volatile SENSITIVE_CORE_X_IRAM0_PMS_CONSTRAIN_0,
    /// SENSITIVE_CORE_X_IRAM0_PMS_CONSTRAIN_1_REG
    CORE_X_IRAM0_PMS_CONSTRAIN_1: *volatile SENSITIVE_CORE_X_IRAM0_PMS_CONSTRAIN_1,
    /// SENSITIVE_CORE_X_IRAM0_PMS_CONSTRAIN_2_REG
    CORE_X_IRAM0_PMS_CONSTRAIN_2: *volatile SENSITIVE_CORE_X_IRAM0_PMS_CONSTRAIN_2,
    /// SENSITIVE_CORE_0_IRAM0_PMS_MONITOR_0_REG
    CORE_0_IRAM0_PMS_MONITOR_0: *volatile SENSITIVE_CORE_0_IRAM0_PMS_MONITOR_0,
    /// SENSITIVE_CORE_0_IRAM0_PMS_MONITOR_1_REG
    CORE_0_IRAM0_PMS_MONITOR_1: *volatile SENSITIVE_CORE_0_IRAM0_PMS_MONITOR_1,
    /// SENSITIVE_CORE_0_IRAM0_PMS_MONITOR_2_REG
    CORE_0_IRAM0_PMS_MONITOR_2: *volatile SENSITIVE_CORE_0_IRAM0_PMS_MONITOR_2,
    /// SENSITIVE_CORE_X_DRAM0_PMS_CONSTRAIN_0_REG
    CORE_X_DRAM0_PMS_CONSTRAIN_0: *volatile SENSITIVE_CORE_X_DRAM0_PMS_CONSTRAIN_0,
    /// SENSITIVE_CORE_X_DRAM0_PMS_CONSTRAIN_1_REG
    CORE_X_DRAM0_PMS_CONSTRAIN_1: *volatile SENSITIVE_CORE_X_DRAM0_PMS_CONSTRAIN_1,
    /// SENSITIVE_CORE_0_DRAM0_PMS_MONITOR_0_REG
    CORE_0_DRAM0_PMS_MONITOR_0: *volatile SENSITIVE_CORE_0_DRAM0_PMS_MONITOR_0,
    /// SENSITIVE_CORE_0_DRAM0_PMS_MONITOR_1_REG
    CORE_0_DRAM0_PMS_MONITOR_1: *volatile SENSITIVE_CORE_0_DRAM0_PMS_MONITOR_1,
    /// SENSITIVE_CORE_0_DRAM0_PMS_MONITOR_2_REG
    CORE_0_DRAM0_PMS_MONITOR_2: *volatile SENSITIVE_CORE_0_DRAM0_PMS_MONITOR_2,
    /// SENSITIVE_CORE_0_DRAM0_PMS_MONITOR_3_REG
    CORE_0_DRAM0_PMS_MONITOR_3: *volatile SENSITIVE_CORE_0_DRAM0_PMS_MONITOR_3,
    /// SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_0_REG
    CORE_0_PIF_PMS_CONSTRAIN_0: *volatile SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_0,
    /// SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_1_REG
    CORE_0_PIF_PMS_CONSTRAIN_1: *volatile SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_1,
    /// SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_2_REG
    CORE_0_PIF_PMS_CONSTRAIN_2: *volatile SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_2,
    /// SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_3_REG
    CORE_0_PIF_PMS_CONSTRAIN_3: *volatile SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_3,
    /// SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_4_REG
    CORE_0_PIF_PMS_CONSTRAIN_4: *volatile SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_4,
    /// SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_5_REG
    CORE_0_PIF_PMS_CONSTRAIN_5: *volatile SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_5,
    /// SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_6_REG
    CORE_0_PIF_PMS_CONSTRAIN_6: *volatile SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_6,
    /// SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_7_REG
    CORE_0_PIF_PMS_CONSTRAIN_7: *volatile SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_7,
    /// SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_8_REG
    CORE_0_PIF_PMS_CONSTRAIN_8: *volatile SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_8,
    /// SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_9_REG
    CORE_0_PIF_PMS_CONSTRAIN_9: *volatile SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_9,
    /// SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_10_REG
    CORE_0_PIF_PMS_CONSTRAIN_10: *volatile SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_10,
    /// SENSITIVE_REGION_PMS_CONSTRAIN_0_REG
    REGION_PMS_CONSTRAIN_0: *volatile SENSITIVE_REGION_PMS_CONSTRAIN_0,
    /// SENSITIVE_REGION_PMS_CONSTRAIN_1_REG
    REGION_PMS_CONSTRAIN_1: *volatile SENSITIVE_REGION_PMS_CONSTRAIN_1,
    /// SENSITIVE_REGION_PMS_CONSTRAIN_2_REG
    REGION_PMS_CONSTRAIN_2: *volatile SENSITIVE_REGION_PMS_CONSTRAIN_2,
    /// SENSITIVE_REGION_PMS_CONSTRAIN_3_REG
    REGION_PMS_CONSTRAIN_3: *volatile SENSITIVE_REGION_PMS_CONSTRAIN_3,
    /// SENSITIVE_REGION_PMS_CONSTRAIN_4_REG
    REGION_PMS_CONSTRAIN_4: *volatile SENSITIVE_REGION_PMS_CONSTRAIN_4,
    /// SENSITIVE_REGION_PMS_CONSTRAIN_5_REG
    REGION_PMS_CONSTRAIN_5: *volatile SENSITIVE_REGION_PMS_CONSTRAIN_5,
    /// SENSITIVE_REGION_PMS_CONSTRAIN_6_REG
    REGION_PMS_CONSTRAIN_6: *volatile SENSITIVE_REGION_PMS_CONSTRAIN_6,
    /// SENSITIVE_REGION_PMS_CONSTRAIN_7_REG
    REGION_PMS_CONSTRAIN_7: *volatile SENSITIVE_REGION_PMS_CONSTRAIN_7,
    /// SENSITIVE_REGION_PMS_CONSTRAIN_8_REG
    REGION_PMS_CONSTRAIN_8: *volatile SENSITIVE_REGION_PMS_CONSTRAIN_8,
    /// SENSITIVE_REGION_PMS_CONSTRAIN_9_REG
    REGION_PMS_CONSTRAIN_9: *volatile SENSITIVE_REGION_PMS_CONSTRAIN_9,
    /// SENSITIVE_REGION_PMS_CONSTRAIN_10_REG
    REGION_PMS_CONSTRAIN_10: *volatile SENSITIVE_REGION_PMS_CONSTRAIN_10,
    /// SENSITIVE_CORE_0_PIF_PMS_MONITOR_0_REG
    CORE_0_PIF_PMS_MONITOR_0: *volatile SENSITIVE_CORE_0_PIF_PMS_MONITOR_0,
    /// SENSITIVE_CORE_0_PIF_PMS_MONITOR_1_REG
    CORE_0_PIF_PMS_MONITOR_1: *volatile SENSITIVE_CORE_0_PIF_PMS_MONITOR_1,
    /// SENSITIVE_CORE_0_PIF_PMS_MONITOR_2_REG
    CORE_0_PIF_PMS_MONITOR_2: *volatile SENSITIVE_CORE_0_PIF_PMS_MONITOR_2,
    /// SENSITIVE_CORE_0_PIF_PMS_MONITOR_3_REG
    CORE_0_PIF_PMS_MONITOR_3: *volatile SENSITIVE_CORE_0_PIF_PMS_MONITOR_3,
    /// SENSITIVE_CORE_0_PIF_PMS_MONITOR_4_REG
    CORE_0_PIF_PMS_MONITOR_4: *volatile SENSITIVE_CORE_0_PIF_PMS_MONITOR_4,
    /// SENSITIVE_CORE_0_PIF_PMS_MONITOR_5_REG
    CORE_0_PIF_PMS_MONITOR_5: *volatile SENSITIVE_CORE_0_PIF_PMS_MONITOR_5,
    /// SENSITIVE_CORE_0_PIF_PMS_MONITOR_6_REG
    CORE_0_PIF_PMS_MONITOR_6: *volatile SENSITIVE_CORE_0_PIF_PMS_MONITOR_6,
    /// SENSITIVE_BACKUP_BUS_PMS_CONSTRAIN_0_REG
    BACKUP_BUS_PMS_CONSTRAIN_0: *volatile SENSITIVE_BACKUP_BUS_PMS_CONSTRAIN_0,
    /// SENSITIVE_BACKUP_BUS_PMS_CONSTRAIN_1_REG
    BACKUP_BUS_PMS_CONSTRAIN_1: *volatile SENSITIVE_BACKUP_BUS_PMS_CONSTRAIN_1,
    /// SENSITIVE_BACKUP_BUS_PMS_CONSTRAIN_2_REG
    BACKUP_BUS_PMS_CONSTRAIN_2: *volatile SENSITIVE_BACKUP_BUS_PMS_CONSTRAIN_2,
    /// SENSITIVE_BACKUP_BUS_PMS_CONSTRAIN_3_REG
    BACKUP_BUS_PMS_CONSTRAIN_3: *volatile SENSITIVE_BACKUP_BUS_PMS_CONSTRAIN_3,
    /// SENSITIVE_BACKUP_BUS_PMS_CONSTRAIN_4_REG
    BACKUP_BUS_PMS_CONSTRAIN_4: *volatile SENSITIVE_BACKUP_BUS_PMS_CONSTRAIN_4,
    /// SENSITIVE_BACKUP_BUS_PMS_MONITOR_0_REG
    BACKUP_BUS_PMS_MONITOR_0: *volatile SENSITIVE_BACKUP_BUS_PMS_MONITOR_0,
    /// SENSITIVE_BACKUP_BUS_PMS_MONITOR_1_REG
    BACKUP_BUS_PMS_MONITOR_1: *volatile SENSITIVE_BACKUP_BUS_PMS_MONITOR_1,
    /// SENSITIVE_BACKUP_BUS_PMS_MONITOR_2_REG
    BACKUP_BUS_PMS_MONITOR_2: *volatile SENSITIVE_BACKUP_BUS_PMS_MONITOR_2,
    /// SENSITIVE_BACKUP_BUS_PMS_MONITOR_3_REG
    BACKUP_BUS_PMS_MONITOR_3: *volatile SENSITIVE_BACKUP_BUS_PMS_MONITOR_3,
    /// SENSITIVE_CLOCK_GATE_REG_REG
    CLOCK_GATE: *volatile SENSITIVE_CLOCK_GATE,
    /// SENSITIVE_DATE_REG
    DATE: *volatile SENSITIVE_DATE,
};
...
const SHA = struct {
    ...
    MODE: *volatile SHA_MODE,
    /// SHA 512/t configuration register 0.
    T_STRING: *volatile SHA_T_STRING,
    /// SHA 512/t configuration register 1.
    T_LENGTH: *volatile SHA_T_LENGTH,
    /// DMA configuration register 0.
    DMA_BLOCK_NUM: *volatile SHA_DMA_BLOCK_NUM,
    /// Typical SHA configuration register 0.
    START: *volatile SHA_START,
    /// Typical SHA configuration register 1.
    CONTINUE: *volatile SHA_CONTINUE,
    /// Busy register.
    BUSY: *volatile SHA_BUSY,
    /// DMA configuration register 1.
    DMA_START: *volatile SHA_DMA_START,
    /// DMA configuration register 2.
    DMA_CONTINUE: *volatile SHA_DMA_CONTINUE,
    /// Interrupt clear register.
    CLEAR_IRQ: *volatile SHA_CLEAR_IRQ,
    /// Interrupt enable register.
    IRQ_ENA: *volatile SHA_IRQ_ENA,
    /// Date register.
    DATE: *volatile SHA_DATE,
    /// Sha H memory which contains intermediate hash or finial hash.
    H_MEM0: *volatile SHA_H_MEMN,
    /// Sha H memory which contains intermediate hash or finial hash.
    H_MEM1: *volatile SHA_H_MEMN,
    /// Sha H memory which contains intermediate hash or finial hash.
    H_MEM2: *volatile SHA_H_MEMN,
    /// Sha H memory which contains intermediate hash or finial hash.
    H_MEM3: *volatile SHA_H_MEMN,
    /// Sha H memory which contains intermediate hash or finial hash.
    H_MEM4: *volatile SHA_H_MEMN,
    /// Sha H memory which contains intermediate hash or finial hash.
    H_MEM5: *volatile SHA_H_MEMN,
    /// Sha H memory which contains intermediate hash or finial hash.
    H_MEM6: *volatile SHA_H_MEMN,
    /// Sha H memory which contains intermediate hash or finial hash.
    H_MEM7: *volatile SHA_H_MEMN,
    /// Sha M memory which contains message.
    M_MEM0: *volatile SHA_M_MEMN,
    /// Sha M memory which contains message.
    M_MEM1: *volatile SHA_M_MEMN,
    /// Sha M memory which contains message.
    M_MEM2: *volatile SHA_M_MEMN,
    /// Sha M memory which contains message.
    M_MEM3: *volatile SHA_M_MEMN,
    /// Sha M memory which contains message.
    M_MEM4: *volatile SHA_M_MEMN,
    /// Sha M memory which contains message.
    M_MEM5: *volatile SHA_M_MEMN,
    /// Sha M memory which contains message.
    M_MEM6: *volatile SHA_M_MEMN,
    /// Sha M memory which contains message.
    M_MEM7: *volatile SHA_M_MEMN,
    /// Sha M memory which contains message.
    M_MEM8: *volatile SHA_M_MEMN,
    /// Sha M memory which contains message.
    M_MEM9: *volatile SHA_M_MEMN,
    /// Sha M memory which contains message.
    M_MEM10: *volatile SHA_M_MEMN,
    /// Sha M memory which contains message.
    M_MEM11: *volatile SHA_M_MEMN,
    /// Sha M memory which contains message.
    M_MEM12: *volatile SHA_M_MEMN,
    /// Sha M memory which contains message.
    M_MEM13: *volatile SHA_M_MEMN,
    /// Sha M memory which contains message.
    M_MEM14: *volatile SHA_M_MEMN,
    /// Sha M memory which contains message.
    M_MEM15: *volatile SHA_M_MEMN,
};
...
const SHA_instance = SHA{
    ...
    .H_MEM1 = @ptrFromInt(0x6003b044),
    .H_MEM2 = @ptrFromInt(0x6003b048),
    .H_MEM3 = @ptrFromInt(0x6003b04c),
    .H_MEM4 = @ptrFromInt(0x6003b050),
    .H_MEM5 = @ptrFromInt(0x6003b054),
    .H_MEM6 = @ptrFromInt(0x6003b058),
    .H_MEM7 = @ptrFromInt(0x6003b05c),
    .M_MEM0 = @ptrFromInt(0x6003b080),
    .M_MEM1 = @ptrFromInt(0x6003b084),
    .M_MEM2 = @ptrFromInt(0x6003b088),
    .M_MEM3 = @ptrFromInt(0x6003b08c),
    .M_MEM4 = @ptrFromInt(0x6003b090),
    .M_MEM5 = @ptrFromInt(0x6003b094),
    .M_MEM6 = @ptrFromInt(0x6003b098),
    .M_MEM7 = @ptrFromInt(0x6003b09c),
    .M_MEM8 = @ptrFromInt(0x6003b0a0),
    .M_MEM9 = @ptrFromInt(0x6003b0a4),
    .M_MEM10 = @ptrFromInt(0x6003b0a8),
    .M_MEM11 = @ptrFromInt(0x6003b0ac),
    .M_MEM12 = @ptrFromInt(0x6003b0b0),
    .M_MEM13 = @ptrFromInt(0x6003b0b4),
    .M_MEM14 = @ptrFromInt(0x6003b0b8),
    .M_MEM15 = @ptrFromInt(0x6003b0bc),
};
...
const SPI0 = struct {
    ...
    CTRL: *volatile SPI0_CTRL,
    /// SPI0 control1 register.
    CTRL1: *volatile SPI0_CTRL1,
    /// SPI0 control2 register.
    CTRL2: *volatile SPI0_CTRL2,
    /// SPI clock division control register.
    CLOCK: *volatile SPI0_CLOCK,
    /// SPI0 user register.
    USER: *volatile SPI0_USER,
    /// SPI0 user1 register.
    USER1: *volatile SPI0_USER1,
    /// SPI0 user2 register.
    USER2: *volatile SPI0_USER2,
    /// SPI0 read control register.
    RD_STATUS: *volatile SPI0_RD_STATUS,
    /// SPI0 misc register
    MISC: *volatile SPI0_MISC,
    /// SPI0 bit mode control register.
    CACHE_FCTRL: *volatile SPI0_CACHE_FCTRL,
    /// SPI0 FSM status register
    FSM: *volatile SPI0_FSM,
    /// SPI0 timing calibration register
    TIMING_CALI: *volatile SPI0_TIMING_CALI,
    /// SPI0 input delay mode control register
    DIN_MODE: *volatile SPI0_DIN_MODE,
    /// SPI0 input delay number control register
    DIN_NUM: *volatile SPI0_DIN_NUM,
    /// SPI0 output delay mode control register
    DOUT_MODE: *volatile SPI0_DOUT_MODE,
    /// SPI0 clk_gate register
    CLOCK_GATE: *volatile SPI0_CLOCK_GATE,
    /// SPI0 module clock select register
    CORE_CLK_SEL: *volatile SPI0_CORE_CLK_SEL,
    /// Version control register
    DATE: *volatile SPI0_DATE,
};
...
const SPI1 = struct {
    ...
    CMD: *volatile SPI1_CMD,
    /// SPI1 address register
    ADDR: *volatile SPI1_ADDR,
    /// SPI1 control register.
    CTRL: *volatile SPI1_CTRL,
    /// SPI1 control1 register.
    CTRL1: *volatile SPI1_CTRL1,
    /// SPI1 control2 register.
    CTRL2: *volatile SPI1_CTRL2,
    /// SPI1 clock division control register.
    CLOCK: *volatile SPI1_CLOCK,
    /// SPI1 user register.
    USER: *volatile SPI1_USER,
    /// SPI1 user1 register.
    USER1: *volatile SPI1_USER1,
    /// SPI1 user2 register.
    USER2: *volatile SPI1_USER2,
    /// SPI1 send data bit length control register.
    MOSI_DLEN: *volatile SPI1_MOSI_DLEN,
    /// SPI1 receive data bit length control register.
    MISO_DLEN: *volatile SPI1_MISO_DLEN,
    /// SPI1 status register.
    RD_STATUS: *volatile SPI1_RD_STATUS,
    /// SPI1 misc register
    MISC: *volatile SPI1_MISC,
    /// SPI1 TX CRC data register.
    TX_CRC: *volatile SPI1_TX_CRC,
    /// SPI1 bit mode control register.
    CACHE_FCTRL: *volatile SPI1_CACHE_FCTRL,
    ...
    W10: *volatile SPI1_W10,
    /// SPI1 memory data buffer11
    W11: *volatile SPI1_W11,
    /// SPI1 memory data buffer12
    W12: *volatile SPI1_W12,
    /// SPI1 memory data buffer13
    W13: *volatile SPI1_W13,
    /// SPI1 memory data buffer14
    W14: *volatile SPI1_W14,
    /// SPI1 memory data buffer15
    W15: *volatile SPI1_W15,
    /// SPI1 wait idle control register
    FLASH_WAITI_CTRL: *volatile SPI1_FLASH_WAITI_CTRL,
    /// SPI1 flash suspend control register
    FLASH_SUS_CTRL: *volatile SPI1_FLASH_SUS_CTRL,
    /// SPI1 flash suspend command register
    FLASH_SUS_CMD: *volatile SPI1_FLASH_SUS_CMD,
    /// SPI1 flash suspend status register
    SUS_STATUS: *volatile SPI1_SUS_STATUS,
    /// SPI1 timing control register
    TIMING_CALI: *volatile SPI1_TIMING_CALI,
    /// SPI1 interrupt enable register
    INT_ENA: *volatile SPI1_INT_ENA,
    /// SPI1 interrupt clear register
    INT_CLR: *volatile SPI1_INT_CLR,
    /// SPI1 interrupt raw register
    INT_RAW: *volatile SPI1_INT_RAW,
    /// SPI1 interrupt status register
    INT_ST: *volatile SPI1_INT_ST,
    /// SPI1 clk_gate register
    CLOCK_GATE: *volatile SPI1_CLOCK_GATE,
    /// Version control register
    DATE: *volatile SPI1_DATE,
};
...
const SPI2 = struct {
    ...
    CMD: *volatile SPI2_CMD,
    /// Address value register
    ADDR: *volatile SPI2_ADDR,
    /// SPI control register
    CTRL: *volatile SPI2_CTRL,
    /// SPI clock control register
    CLOCK: *volatile SPI2_CLOCK,
    /// SPI USER control register
    USER: *volatile SPI2_USER,
    /// SPI USER control register 1
    USER1: *volatile SPI2_USER1,
    /// SPI USER control register 2
    USER2: *volatile SPI2_USER2,
    /// SPI data bit length control register
    MS_DLEN: *volatile SPI2_MS_DLEN,
    /// SPI misc register
    MISC: *volatile SPI2_MISC,
    /// SPI input delay mode configuration
    DIN_MODE: *volatile SPI2_DIN_MODE,
    /// SPI input delay number configuration
    DIN_NUM: *volatile SPI2_DIN_NUM,
    /// SPI output delay mode configuration
    DOUT_MODE: *volatile SPI2_DOUT_MODE,
    /// SPI DMA control register
    DMA_CONF: *volatile SPI2_DMA_CONF,
    /// SPI DMA interrupt enable register
    DMA_INT_ENA: *volatile SPI2_DMA_INT_ENA,
    /// SPI DMA interrupt clear register
    DMA_INT_CLR: *volatile SPI2_DMA_INT_CLR,
    /// SPI DMA interrupt raw register
    DMA_INT_RAW: *volatile SPI2_DMA_INT_RAW,
    /// SPI DMA interrupt status register
    DMA_INT_ST: *volatile SPI2_DMA_INT_ST,
    ...
    W10: *volatile SPI2_W10,
    /// SPI CPU-controlled buffer11
    W11: *volatile SPI2_W11,
    /// SPI CPU-controlled buffer12
    W12: *volatile SPI2_W12,
    /// SPI CPU-controlled buffer13
    W13: *volatile SPI2_W13,
    /// SPI CPU-controlled buffer14
    W14: *volatile SPI2_W14,
    /// SPI CPU-controlled buffer15
    W15: *volatile SPI2_W15,
    /// SPI slave control register
    SLAVE: *volatile SPI2_SLAVE,
    /// SPI slave control register 1
    SLAVE1: *volatile SPI2_SLAVE1,
    /// SPI module clock and register clock control
    CLK_GATE: *volatile SPI2_CLK_GATE,
    /// Version control
    DATE: *volatile SPI2_DATE,
};
...
const SYSTEM = struct {
    ...
    CPU_PERI_CLK_EN: *volatile SYSTEM_CPU_PERI_CLK_EN,
    /// cpu_peripheral reset register
    CPU_PERI_RST_EN: *volatile SYSTEM_CPU_PERI_RST_EN,
    /// cpu clock config register
    CPU_PER_CONF: *volatile SYSTEM_CPU_PER_CONF,
    /// memory power down mask register
    MEM_PD_MASK: *volatile SYSTEM_MEM_PD_MASK,
    /// peripheral clock gating register
    PERIP_CLK_EN0: *volatile SYSTEM_PERIP_CLK_EN0,
    /// peripheral clock gating register
    PERIP_CLK_EN1: *volatile SYSTEM_PERIP_CLK_EN1,
    /// reserved
    PERIP_RST_EN0: *volatile SYSTEM_PERIP_RST_EN0,
    /// peripheral reset register
    PERIP_RST_EN1: *volatile SYSTEM_PERIP_RST_EN1,
    /// clock config register
    BT_LPCK_DIV_INT: *volatile SYSTEM_BT_LPCK_DIV_INT,
    /// clock config register
    BT_LPCK_DIV_FRAC: *volatile SYSTEM_BT_LPCK_DIV_FRAC,
    /// interrupt generate register
    CPU_INTR_FROM_CPU_0: *volatile SYSTEM_CPU_INTR_FROM_CPU_0,
    /// interrupt generate register
    CPU_INTR_FROM_CPU_1: *volatile SYSTEM_CPU_INTR_FROM_CPU_1,
    /// interrupt generate register
    CPU_INTR_FROM_CPU_2: *volatile SYSTEM_CPU_INTR_FROM_CPU_2,
    /// interrupt generate register
    CPU_INTR_FROM_CPU_3: *volatile SYSTEM_CPU_INTR_FROM_CPU_3,
    /// rsa memory power control register
    RSA_PD_CTRL: *volatile SYSTEM_RSA_PD_CTRL,
    /// EDMA clock and reset register
    EDMA_CTRL: *volatile SYSTEM_EDMA_CTRL,
    /// cache control register
    CACHE_CONTROL: *volatile SYSTEM_CACHE_CONTROL,
    /// SYSTEM_EXTERNAL_DEVICE_ENCRYPT_DECRYPT_CONTROL_REG
    EXTERNAL_DEVICE_ENCRYPT_DECRYPT_CONTROL: *volatile SYSTEM_EXTERNAL_DEVICE_ENCRYPT_DECRYPT_CONTROL,
    /// fast memory config register
    RTC_FASTMEM_CONFIG: *volatile SYSTEM_RTC_FASTMEM_CONFIG,
    /// reserved
    RTC_FASTMEM_CRC: *volatile SYSTEM_RTC_FASTMEM_CRC,
    /// eco register
    REDUNDANT_ECO_CTRL: *volatile SYSTEM_REDUNDANT_ECO_CTRL,
    /// clock gating register
    CLOCK_GATE: *volatile SYSTEM_CLOCK_GATE,
    /// system clock config register
    SYSCLK_CONF: *volatile SYSTEM_SYSCLK_CONF,
    /// mem pvt register
    MEM_PVT: *volatile SYSTEM_MEM_PVT,
    /// mem pvt register
    COMB_PVT_LVT_CONF: *volatile SYSTEM_COMB_PVT_LVT_CONF,
    /// mem pvt register
    COMB_PVT_NVT_CONF: *volatile SYSTEM_COMB_PVT_NVT_CONF,
    /// mem pvt register
    COMB_PVT_HVT_CONF: *volatile SYSTEM_COMB_PVT_HVT_CONF,
    /// mem pvt register
    COMB_PVT_ERR_LVT_SITE0: *volatile SYSTEM_COMB_PVT_ERR_LVT_SITE0,
    /// mem pvt register
    COMB_PVT_ERR_NVT_SITE0: *volatile SYSTEM_COMB_PVT_ERR_NVT_SITE0,
    /// mem pvt register
    COMB_PVT_ERR_HVT_SITE0: *volatile SYSTEM_COMB_PVT_ERR_HVT_SITE0,
    /// mem pvt register
    COMB_PVT_ERR_LVT_SITE1: *volatile SYSTEM_COMB_PVT_ERR_LVT_SITE1,
    /// mem pvt register
    COMB_PVT_ERR_NVT_SITE1: *volatile SYSTEM_COMB_PVT_ERR_NVT_SITE1,
    /// mem pvt register
    COMB_PVT_ERR_HVT_SITE1: *volatile SYSTEM_COMB_PVT_ERR_HVT_SITE1,
    /// mem pvt register
    COMB_PVT_ERR_LVT_SITE2: *volatile SYSTEM_COMB_PVT_ERR_LVT_SITE2,
    /// mem pvt register
    COMB_PVT_ERR_NVT_SITE2: *volatile SYSTEM_COMB_PVT_ERR_NVT_SITE2,
    /// mem pvt register
    COMB_PVT_ERR_HVT_SITE2: *volatile SYSTEM_COMB_PVT_ERR_HVT_SITE2,
    /// mem pvt register
    COMB_PVT_ERR_LVT_SITE3: *volatile SYSTEM_COMB_PVT_ERR_LVT_SITE3,
    /// mem pvt register
    COMB_PVT_ERR_NVT_SITE3: *volatile SYSTEM_COMB_PVT_ERR_NVT_SITE3,
    /// mem pvt register
    COMB_PVT_ERR_HVT_SITE3: *volatile SYSTEM_COMB_PVT_ERR_HVT_SITE3,
    /// Version register
    SYSTEM_REG_DATE: *volatile SYSTEM_SYSTEM_REG_DATE,
};
...
const SYSTIMER = struct {
    /// SYSTIMER_CONF.
    CONF: *volatile SYSTIMER_CONF,
    /// SYSTIMER_UNIT0_OP.
    UNIT0_OP: *volatile SYSTIMER_UNIT0_OP,
    /// SYSTIMER_UNIT1_OP.
    UNIT1_OP: *volatile SYSTIMER_UNIT1_OP,
    /// SYSTIMER_UNIT0_LOAD_HI.
    UNIT0_LOAD_HI: *volatile SYSTIMER_UNIT0_LOAD_HI,
    /// SYSTIMER_UNIT0_LOAD_LO.
    UNIT0_LOAD_LO: *volatile SYSTIMER_UNIT0_LOAD_LO,
    /// SYSTIMER_UNIT1_LOAD_HI.
    UNIT1_LOAD_HI: *volatile SYSTIMER_UNIT1_LOAD_HI,
    /// SYSTIMER_UNIT1_LOAD_LO.
    UNIT1_LOAD_LO: *volatile SYSTIMER_UNIT1_LOAD_LO,
    /// SYSTIMER_TARGET0_HI.
    TARGET0_HI: *volatile SYSTIMER_TARGET0_HI,
    /// SYSTIMER_TARGET0_LO.
    TARGET0_LO: *volatile SYSTIMER_TARGET0_LO,
    /// SYSTIMER_TARGET1_HI.
    TARGET1_HI: *volatile SYSTIMER_TARGET1_HI,
    /// SYSTIMER_TARGET1_LO.
    TARGET1_LO: *volatile SYSTIMER_TARGET1_LO,
    /// SYSTIMER_TARGET2_HI.
    TARGET2_HI: *volatile SYSTIMER_TARGET2_HI,
    /// SYSTIMER_TARGET2_LO.
    TARGET2_LO: *volatile SYSTIMER_TARGET2_LO,
    /// SYSTIMER_TARGET0_CONF.
    TARGET0_CONF: *volatile SYSTIMER_TARGET0_CONF,
    /// SYSTIMER_TARGET1_CONF.
    TARGET1_CONF: *volatile SYSTIMER_TARGET1_CONF,
    /// SYSTIMER_TARGET2_CONF.
    TARGET2_CONF: *volatile SYSTIMER_TARGET2_CONF,
    /// SYSTIMER_UNIT0_VALUE_HI.
    UNIT0_VALUE_HI: *volatile SYSTIMER_UNIT0_VALUE_HI,
    /// SYSTIMER_UNIT0_VALUE_LO.
    UNIT0_VALUE_LO: *volatile SYSTIMER_UNIT0_VALUE_LO,
    /// SYSTIMER_UNIT1_VALUE_HI.
    UNIT1_VALUE_HI: *volatile SYSTIMER_UNIT1_VALUE_HI,
    /// SYSTIMER_UNIT1_VALUE_LO.
    UNIT1_VALUE_LO: *volatile SYSTIMER_UNIT1_VALUE_LO,
    /// SYSTIMER_COMP0_LOAD.
    COMP0_LOAD: *volatile SYSTIMER_COMP0_LOAD,
    /// SYSTIMER_COMP1_LOAD.
    COMP1_LOAD: *volatile SYSTIMER_COMP1_LOAD,
    /// SYSTIMER_COMP2_LOAD.
    COMP2_LOAD: *volatile SYSTIMER_COMP2_LOAD,
    /// SYSTIMER_UNIT0_LOAD.
    UNIT0_LOAD: *volatile SYSTIMER_UNIT0_LOAD,
    /// SYSTIMER_UNIT1_LOAD.
    UNIT1_LOAD: *volatile SYSTIMER_UNIT1_LOAD,
    /// SYSTIMER_INT_ENA.
    INT_ENA: *volatile SYSTIMER_INT_ENA,
    /// SYSTIMER_INT_RAW.
    INT_RAW: *volatile SYSTIMER_INT_RAW,
    /// SYSTIMER_INT_CLR.
    INT_CLR: *volatile SYSTIMER_INT_CLR,
    /// SYSTIMER_INT_ST.
    INT_ST: *volatile SYSTIMER_INT_ST,
    /// SYSTIMER_DATE.
    DATE: *volatile SYSTIMER_DATE,
};
...
const TIMG0 = struct {
    /// TIMG_T0CONFIG_REG.
    T0CONFIG: *volatile TIMG0_T0CONFIG,
    /// TIMG_T0LO_REG.
    T0LO: *volatile TIMG0_T0LO,
    /// TIMG_T0HI_REG.
    T0HI: *volatile TIMG0_T0HI,
    /// TIMG_T0UPDATE_REG.
    T0UPDATE: *volatile TIMG0_T0UPDATE,
    /// TIMG_T0ALARMLO_REG.
    T0ALARMLO: *volatile TIMG0_T0ALARMLO,
    /// TIMG_T0ALARMHI_REG.
    T0ALARMHI: *volatile TIMG0_T0ALARMHI,
    /// TIMG_T0LOADLO_REG.
    T0LOADLO: *volatile TIMG0_T0LOADLO,
    /// TIMG_T0LOADHI_REG.
    T0LOADHI: *volatile TIMG0_T0LOADHI,
    /// TIMG_T0LOAD_REG.
    T0LOAD: *volatile TIMG0_T0LOAD,
    /// TIMG_WDTCONFIG0_REG.
    WDTCONFIG0: *volatile TIMG0_WDTCONFIG0,
    /// TIMG_WDTCONFIG1_REG.
    WDTCONFIG1: *volatile TIMG0_WDTCONFIG1,
    /// TIMG_WDTCONFIG2_REG.
    WDTCONFIG2: *volatile TIMG0_WDTCONFIG2,
    /// TIMG_WDTCONFIG3_REG.
    WDTCONFIG3: *volatile TIMG0_WDTCONFIG3,
    /// TIMG_WDTCONFIG4_REG.
    WDTCONFIG4: *volatile TIMG0_WDTCONFIG4,
    /// TIMG_WDTCONFIG5_REG.
    WDTCONFIG5: *volatile TIMG0_WDTCONFIG5,
    /// TIMG_WDTFEED_REG.
    WDTFEED: *volatile TIMG0_WDTFEED,
    /// TIMG_WDTWPROTECT_REG.
    WDTWPROTECT: *volatile TIMG0_WDTWPROTECT,
    /// TIMG_RTCCALICFG_REG.
    RTCCALICFG: *volatile TIMG0_RTCCALICFG,
    /// TIMG_RTCCALICFG1_REG.
    RTCCALICFG1: *volatile TIMG0_RTCCALICFG1,
    /// INT_ENA_TIMG_REG
    INT_ENA_TIMERS: *volatile TIMG0_INT_ENA_TIMERS,
    /// INT_RAW_TIMG_REG
    INT_RAW_TIMERS: *volatile TIMG0_INT_RAW_TIMERS,
    /// INT_ST_TIMG_REG
    INT_ST_TIMERS: *volatile TIMG0_INT_ST_TIMERS,
    /// INT_CLR_TIMG_REG
    INT_CLR_TIMERS: *volatile TIMG0_INT_CLR_TIMERS,
    /// TIMG_RTCCALICFG2_REG.
    RTCCALICFG2: *volatile TIMG0_RTCCALICFG2,
    /// TIMG_NTIMG_DATE_REG.
    NTIMG_DATE: *volatile TIMG0_NTIMG_DATE,
    /// TIMG_REGCLK_REG.
    REGCLK: *volatile TIMG0_REGCLK,
};
...
const TWAI0 = struct {
    /// Mode Register
    MODE: *volatile TWAI0_MODE,
    /// Command Register
    CMD: *volatile TWAI0_CMD,
    /// Status register
    STATUS: *volatile TWAI0_STATUS,
    /// Interrupt Register
    INT_RAW: *volatile TWAI0_INT_RAW,
    /// Interrupt Enable Register
    INT_ENA: *volatile TWAI0_INT_ENA,
    /// Bus Timing Register 0
    BUS_TIMING_0: *volatile TWAI0_BUS_TIMING_0,
    /// Bus Timing Register 1
    BUS_TIMING_1: *volatile TWAI0_BUS_TIMING_1,
    /// Arbitration Lost Capture Register
    ARB_LOST_CAP: *volatile TWAI0_ARB_LOST_CAP,
    /// Error Code Capture Register
    ERR_CODE_CAP: *volatile TWAI0_ERR_CODE_CAP,
    /// Error Warning Limit Register
    ERR_WARNING_LIMIT: *volatile TWAI0_ERR_WARNING_LIMIT,
    /// Receive Error Counter Register
    RX_ERR_CNT: *volatile TWAI0_RX_ERR_CNT,
    /// Transmit Error Counter Register
    TX_ERR_CNT: *volatile TWAI0_TX_ERR_CNT,
    /// Data register 0
    DATA_0: *volatile TWAI0_DATA_0,
    /// Data register 1
    DATA_1: *volatile TWAI0_DATA_1,
    /// Data register 2
    DATA_2: *volatile TWAI0_DATA_2,
    /// Data register 3
    DATA_3: *volatile TWAI0_DATA_3,
    /// Data register 4
    DATA_4: *volatile TWAI0_DATA_4,
    /// Data register 5
    DATA_5: *volatile TWAI0_DATA_5,
    /// Data register 6
    DATA_6: *volatile TWAI0_DATA_6,
    /// Data register 7
    DATA_7: *volatile TWAI0_DATA_7,
    /// Data register 8
    DATA_8: *volatile TWAI0_DATA_8,
    /// Data register 9
    DATA_9: *volatile TWAI0_DATA_9,
    /// Data register 10
    DATA_10: *volatile TWAI0_DATA_10,
    /// Data register 11
    DATA_11: *volatile TWAI0_DATA_11,
    /// Data register 12
    DATA_12: *volatile TWAI0_DATA_12,
    /// Receive Message Counter Register
    RX_MESSAGE_CNT: *volatile TWAI0_RX_MESSAGE_CNT,
    /// Clock Divider register
    CLOCK_DIVIDER: *volatile TWAI0_CLOCK_DIVIDER,
};
...
const UART0 = struct {
    /// FIFO data register
    FIFO: *volatile UART0_FIFO,
    /// Raw interrupt status
    INT_RAW: *volatile UART0_INT_RAW,
    /// Masked interrupt status
    INT_ST: *volatile UART0_INT_ST,
    /// Interrupt enable bits
    INT_ENA: *volatile UART0_INT_ENA,
    /// Interrupt clear bits
    INT_CLR: *volatile UART0_INT_CLR,
    /// Clock divider configuration
    CLKDIV: *volatile UART0_CLKDIV,
    /// Rx Filter configuration
    RX_FILT: *volatile UART0_RX_FILT,
    /// UART status register
    STATUS: *volatile UART0_STATUS,
    /// a
    CONF0: *volatile UART0_CONF0,
    /// Configuration register 1
    CONF1: *volatile UART0_CONF1,
    /// Autobaud minimum low pulse duration register
    LOWPULSE: *volatile UART0_LOWPULSE,
    /// Autobaud minimum high pulse duration register
    HIGHPULSE: *volatile UART0_HIGHPULSE,
    /// Autobaud edge change count register
    RXD_CNT: *volatile UART0_RXD_CNT,
    /// Software flow-control configuration
    FLOW_CONF: *volatile UART0_FLOW_CONF,
    /// Sleep-mode configuration
    SLEEP_CONF: *volatile UART0_SLEEP_CONF,
    /// Software flow-control character configuration
    SWFC_CONF0: *volatile UART0_SWFC_CONF0,
    /// Software flow-control character configuration
    SWFC_CONF1: *volatile UART0_SWFC_CONF1,
    /// Tx Break character configuration
    TXBRK_CONF: *volatile UART0_TXBRK_CONF,
    /// Frame-end idle configuration
    IDLE_CONF: *volatile UART0_IDLE_CONF,
    /// RS485 mode configuration
    RS485_CONF: *volatile UART0_RS485_CONF,
    /// Pre-sequence timing configuration
    AT_CMD_PRECNT: *volatile UART0_AT_CMD_PRECNT,
    /// Post-sequence timing configuration
    AT_CMD_POSTCNT: *volatile UART0_AT_CMD_POSTCNT,
    /// Timeout configuration
    AT_CMD_GAPTOUT: *volatile UART0_AT_CMD_GAPTOUT,
    /// AT escape sequence detection configuration
    AT_CMD_CHAR: *volatile UART0_AT_CMD_CHAR,
    /// UART threshold and allocation configuration
    MEM_CONF: *volatile UART0_MEM_CONF,
    /// Tx-FIFO write and read offset address.
    MEM_TX_STATUS: *volatile UART0_MEM_TX_STATUS,
    /// Rx-FIFO write and read offset address.
    MEM_RX_STATUS: *volatile UART0_MEM_RX_STATUS,
    /// UART transmit and receive status.
    FSM_STATUS: *volatile UART0_FSM_STATUS,
    /// Autobaud high pulse register
    POSPULSE: *volatile UART0_POSPULSE,
    /// Autobaud low pulse register
    NEGPULSE: *volatile UART0_NEGPULSE,
    /// UART core clock configuration
    CLK_CONF: *volatile UART0_CLK_CONF,
    /// UART Version register
    DATE: *volatile UART0_DATE,
    /// UART ID register
    ID: *volatile UART0_ID,
};
...
const UHCI0 = struct {
    /// a
    CONF0: *volatile UHCI0_CONF0,
    /// a
    INT_RAW: *volatile UHCI0_INT_RAW,
    /// a
    INT_ST: *volatile UHCI0_INT_ST,
    /// a
    INT_ENA: *volatile UHCI0_INT_ENA,
    /// a
    INT_CLR: *volatile UHCI0_INT_CLR,
    /// a
    CONF1: *volatile UHCI0_CONF1,
    /// a
    STATE0: *volatile UHCI0_STATE0,
    /// a
    STATE1: *volatile UHCI0_STATE1,
    /// a
    ESCAPE_CONF: *volatile UHCI0_ESCAPE_CONF,
    /// a
    HUNG_CONF: *volatile UHCI0_HUNG_CONF,
    /// a
    ACK_NUM: *volatile UHCI0_ACK_NUM,
    /// a
    RX_HEAD: *volatile UHCI0_RX_HEAD,
    /// a
    QUICK_SENT: *volatile UHCI0_QUICK_SENT,
    /// a
    REG_Q0_WORD0: *volatile UHCI0_REG_Q0_WORD0,
    /// a
    REG_Q0_WORD1: *volatile UHCI0_REG_Q0_WORD1,
    /// a
    REG_Q1_WORD0: *volatile UHCI0_REG_Q1_WORD0,
    /// a
    REG_Q1_WORD1: *volatile UHCI0_REG_Q1_WORD1,
    /// a
    REG_Q2_WORD0: *volatile UHCI0_REG_Q2_WORD0,
    /// a
    REG_Q2_WORD1: *volatile UHCI0_REG_Q2_WORD1,
    /// a
    REG_Q3_WORD0: *volatile UHCI0_REG_Q3_WORD0,
    /// a
    REG_Q3_WORD1: *volatile UHCI0_REG_Q3_WORD1,
    /// a
    REG_Q4_WORD0: *volatile UHCI0_REG_Q4_WORD0,
    /// a
    REG_Q4_WORD1: *volatile UHCI0_REG_Q4_WORD1,
    /// a
    REG_Q5_WORD0: *volatile UHCI0_REG_Q5_WORD0,
    /// a
    REG_Q5_WORD1: *volatile UHCI0_REG_Q5_WORD1,
    /// a
    REG_Q6_WORD0: *volatile UHCI0_REG_Q6_WORD0,
    /// a
    REG_Q6_WORD1: *volatile UHCI0_REG_Q6_WORD1,
    /// a
    ESC_CONF0: *volatile UHCI0_ESC_CONF0,
    /// a
    ESC_CONF1: *volatile UHCI0_ESC_CONF1,
    /// a
    ESC_CONF2: *volatile UHCI0_ESC_CONF2,
    /// a
    ESC_CONF3: *volatile UHCI0_ESC_CONF3,
    /// a
    PKT_THRES: *volatile UHCI0_PKT_THRES,
    /// a
    DATE: *volatile UHCI0_DATE,
};
...
const USB_DEVICE = struct {
    /// USB_DEVICE_EP1_REG.
    EP1: *volatile USB_DEVICE_EP1,
    /// USB_DEVICE_EP1_CONF_REG.
    EP1_CONF: *volatile USB_DEVICE_EP1_CONF,
    /// USB_DEVICE_INT_RAW_REG.
    INT_RAW: *volatile USB_DEVICE_INT_RAW,
    /// USB_DEVICE_INT_ST_REG.
    INT_ST: *volatile USB_DEVICE_INT_ST,
    /// USB_DEVICE_INT_ENA_REG.
    INT_ENA: *volatile USB_DEVICE_INT_ENA,
    /// USB_DEVICE_INT_CLR_REG.
    INT_CLR: *volatile USB_DEVICE_INT_CLR,
    /// USB_DEVICE_CONF0_REG.
    CONF0: *volatile USB_DEVICE_CONF0,
    /// USB_DEVICE_TEST_REG.
    TEST: *volatile USB_DEVICE_TEST,
    /// USB_DEVICE_JFIFO_ST_REG.
    JFIFO_ST: *volatile USB_DEVICE_JFIFO_ST,
    /// USB_DEVICE_FRAM_NUM_REG.
    FRAM_NUM: *volatile USB_DEVICE_FRAM_NUM,
    /// USB_DEVICE_IN_EP0_ST_REG.
    IN_EP0_ST: *volatile USB_DEVICE_IN_EP0_ST,
    /// USB_DEVICE_IN_EP1_ST_REG.
    IN_EP1_ST: *volatile USB_DEVICE_IN_EP1_ST,
    /// USB_DEVICE_IN_EP2_ST_REG.
    IN_EP2_ST: *volatile USB_DEVICE_IN_EP2_ST,
    /// USB_DEVICE_IN_EP3_ST_REG.
    IN_EP3_ST: *volatile USB_DEVICE_IN_EP3_ST,
    /// USB_DEVICE_OUT_EP0_ST_REG.
    OUT_EP0_ST: *volatile USB_DEVICE_OUT_EP0_ST,
    /// USB_DEVICE_OUT_EP1_ST_REG.
    OUT_EP1_ST: *volatile USB_DEVICE_OUT_EP1_ST,
    /// USB_DEVICE_OUT_EP2_ST_REG.
    OUT_EP2_ST: *volatile USB_DEVICE_OUT_EP2_ST,
    /// USB_DEVICE_MISC_CONF_REG.
    MISC_CONF: *volatile USB_DEVICE_MISC_CONF,
    /// USB_DEVICE_MEM_CONF_REG.
    MEM_CONF: *volatile USB_DEVICE_MEM_CONF,
    /// USB_DEVICE_DATE_REG.
    DATE: *volatile USB_DEVICE_DATE,
};
...
const XTS_AES = struct {
    ...
    PLAIN_MEM0: *volatile XTS_AES_PLAIN_MEMN,
    /// The memory that stores plaintext
    PLAIN_MEM1: *volatile XTS_AES_PLAIN_MEMN,
    /// The memory that stores plaintext
    PLAIN_MEM2: *volatile XTS_AES_PLAIN_MEMN,
    /// The memory that stores plaintext
    PLAIN_MEM3: *volatile XTS_AES_PLAIN_MEMN,
    /// XTS-AES line-size register
    LINESIZE: *volatile XTS_AES_LINESIZE,
    /// XTS-AES destination register
    DESTINATION: *volatile XTS_AES_DESTINATION,
    /// XTS-AES physical address register
    PHYSICAL_ADDRESS: *volatile XTS_AES_PHYSICAL_ADDRESS,
    /// XTS-AES trigger register
    TRIGGER: *volatile XTS_AES_TRIGGER,
    /// XTS-AES release register
    RELEASE: *volatile XTS_AES_RELEASE,
    /// XTS-AES destroy register
    DESTROY: *volatile XTS_AES_DESTROY,
    /// XTS-AES status register
    STATE: *volatile XTS_AES_STATE,
    /// XTS-AES version control register
    DATE: *volatile XTS_AES_DATE,
};

const XTS_AES_instance = XTS_AES{
    .PLAIN_MEM0 = @ptrFromInt(0x600cc000),
    .PLAIN_MEM1 = @ptrFromInt(0x600cc004),
    .PLAIN_MEM2 = @ptrFromInt(0x600cc008),
    .PLAIN_MEM3 = @ptrFromInt(0x600cc00c),
